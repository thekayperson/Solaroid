...
HXLINE( 170)		HX_VARI( int,unicodeOffset) = 0;
HXLINE( 171)		HX_VARI( int,nativeOffset) = 0;
...
HXLINE( 330)		HX_VARI( int,unicodeOffset) = 0;
HXLINE( 331)		HX_VARI( int,nativeOffset) = 0;
HXLINE( 332)		HX_VARI( int,fromOffset) = -1;
HXLINE( 333)		HX_VARI( int,subLength) = 0;
...
HXLINE( 346)					HX_VAR( int,lastOffset);

...
HXLINE(  74)		{
            			...
            			void _hx_run(::cpp::VirtualArray el){
            				...
            				HX_STACK_ARG(el,"el")
HXLINE(  74)
HXLINE(  75)				HX_VARI(  ::Dynamic,inf) = _gthis->posInfos();
HXLINE(  76)				HX_VARI(  ::Dynamic,v) = el->shift();
...
HXLINE( 128)			return ::hx::UShr(v1,v2);
            	...
            	HX_STACK_THIS(this)
HXLINE(  90)
HXLINE(  91)		HX_VARI(  ::hscript::Interp,me) = ::hx::ObjectPtr<OBJ_>(this);
...
HX_DEFINE_DYNAMIC_FUNC0(Interp_obj,initOps,(void))
 ...
 ::Dynamic Interp_obj::assign( ::hscript::Expr e1, ::hscript::Expr e2){
            	...
            	HX_STACK_ARG(e2,"e2")
HXLINE( 131)
HXLINE( 132)		HX_VARI(  ::Dynamic,v) = this->expr(e2);
HXLINE( 133)		switch((int)(e1->_hx_getIndex())){
            			case (int)1: {
HXLINE( 134)				HX_VARI( ::String,id) = e1->_hx_getString(0);
HXDLIN( 134)				{
...
HXLINE( 139)						l->__SetField(HX_("r",72,00,00,00),v,::hx::paccDynamic);
            			...
            			break;
            			case (int)5: {
HXLINE( 140)				HX_VARI(  ::hscript::Expr,e) = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 140)				HX_VARI( ::String,f) = e1->_hx_getString(1);
HXLINE( 141)				v = this->set(this->expr(e),f,v);
            			}
            			break;
            			case (int)16: {
HXLINE( 142)				HX_VARI(  ::hscript::Expr,e) = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 142)				HX_VARI(  ::hscript::Expr,index) = e1->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 142)				{
HXLINE( 143)					HX_VARI(  ::Dynamic,arr) = this->expr(e);
HXLINE( 144)					HX_VARI(  ::Dynamic,index1) = this->expr(index);
...
HXLINE( 158)
HXLINE( 159)		HX_VARI(  ::hscript::Interp,me) = ::hx::ObjectPtr<OBJ_>(this);
...
HX_DEFINE_DYNAMIC_FUNC2(Interp_obj,assignOp,(void))
 ...
 ::Dynamic Interp_obj::evalAssignOp(::String op, ::Dynamic fop, ::hscript::Expr e1, ::hscript::Expr e2){
            	...
            	HX_STACK_ARG(e2,"e2")
HXLINE( 163)
HXLINE( 164)		HX_VAR(  ::Dynamic,v);
HXLINE( 165)		switch((int)(e1->_hx_getIndex())){
            			case (int)1: {
HXLINE( 166)				HX_VARI( ::String,id) = e1->_hx_getString(0);
HXDLIN( 166)				{
...
HXLINE( 172)						l->__SetField(HX_("r",72,00,00,00),v,::hx::paccDynamic);
            			...
            			break;
            			case (int)5: {
HXLINE( 173)				HX_VARI(  ::hscript::Expr,e) = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 173)				HX_VARI( ::String,f) = e1->_hx_getString(1);
HXDLIN( 173)				{
HXLINE( 174)					HX_VARI(  ::Dynamic,obj) = this->expr(e);
...
HXLINE( 176)					v = this->set(obj,f,v);
            			...
            			break;
            			case (int)16: {
HXLINE( 177)				HX_VARI(  ::hscript::Expr,e) = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 177)				HX_VARI(  ::hscript::Expr,index) = e1->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 177)				{
HXLINE( 178)					HX_VARI(  ::Dynamic,arr) = this->expr(e);
HXLINE( 179)					HX_VARI(  ::Dynamic,index1) = this->expr(index);
...
HXDLIN( 199)		switch((int)(e->_hx_getIndex())){
            			case (int)1: {
HXLINE( 200)				HX_VARI( ::String,id) = e->_hx_getString(0);
HXLINE( 201)				HX_VARI(  ::Dynamic,l) = this->locals->get(id);
HXLINE( 202)				HX_VAR(  ::Dynamic,v);
...
HXLINE( 208)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 209)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 209)				HX_VARI( ::String,f) = e->_hx_getString(1);
HXLINE( 210)				HX_VARI(  ::Dynamic,obj) = this->expr(e1);
HXLINE( 211)				HX_VARI(  ::Dynamic,v) = this->get(obj,f);
...
HXLINE( 217)				return v;
            			...
            			break;
            			case (int)16: {
HXLINE( 218)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 218)				HX_VARI(  ::hscript::Expr,index) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 219)				HX_VARI(  ::Dynamic,arr) = this->expr(e1);
HXLINE( 220)				HX_VARI(  ::Dynamic,index1) = this->expr(index);
HXLINE( 221)				if (::Std_obj::isOfType(arr,( ( ::Dynamic)(::hx::ClassOf< ::haxe::IMap >()) ))) {
HXLINE( 222)					HX_VARI( int,v) = ( (int)(::haxe::IMap_obj::get( ::hx::interface_check(arr,0x09c2bd39),index1)) );
...
HXLINE( 233)					HX_VARI( int,v) = ( (int)(arr->__GetItem(( (int)(index1) ))) );
...
HXLINE( 260)					HX_VARI(  ::hscript::_Interp::Stop,e) = _g1;
...
HXLINE( 263)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid continue",d0,6a,b7,3f)));
            						...
            						break;
            						case (int)2: {
HXLINE( 265)							HX_VARI(  ::Dynamic,v) = this->returnValue;
...
HX_DEFINE_DYNAMIC_FUNC1(Interp_obj,exprReturn,return )
 ...
 ::haxe::ds::StringMap Interp_obj::duplicate( ::haxe::ds::StringMap h){
            	...
            	HX_STACK_ARG(h,"h")
HXLINE( 273)
HXLINE( 275)		HX_VARI(  ::haxe::ds::StringMap,h2) =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 279)		{
HXLINE( 279)			HX_VARI(  ::Dynamic,k) = h->keys();
HXDLIN( 279)			while(( (bool)(k->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 279)				HX_VARI( ::String,k1) = ( (::String)(k->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 286)			HX_VARI(  ::Dynamic,d) = this->declared->pop();
...
HX_DEFINE_DYNAMIC_FUNC1(Interp_obj,rethrow,(void))
 ...
 ::Dynamic Interp_obj::resolve(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 305)
HXLINE( 306)		HX_VARI(  ::Dynamic,l) = this->locals->get(id);
HXLINE( 307)		if (::hx::IsNotNull( l )) {
HXLINE( 308)			return  ::Dynamic(l->__Field(HX_("r",72,00,00,00),::hx::paccDynamic));
            		}
HXLINE( 309)		HX_VARI(  ::Dynamic,v) = this->variables->get(id);
...
HXLINE( 320)		switch((int)(e->_hx_getIndex())){
            			case (int)0: {
HXLINE( 321)				HX_VARI(  ::hscript::Const,c) = e->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXLINE( 322)				switch((int)(c->_hx_getIndex())){
            					case (int)0: {
HXLINE( 323)						HX_VARI( int,v) = c->_hx_getInt(0);
HXDLIN( 323)						return v;
            					}
            					break;
            					case (int)1: {
HXLINE( 324)						HX_VARI( Float,f) = c->_hx_getFloat(0);
HXDLIN( 324)						return f;
            					}
            					break;
            					case (int)2: {
HXLINE( 325)						HX_VARI( ::String,s) = c->_hx_getString(0);
HXDLIN( 325)						return s;
            					}
            					break;
            				}
            			...
            			break;
            			case (int)1: {
HXLINE( 330)				HX_VARI( ::String,id) = e->_hx_getString(0);
HXLINE( 331)				return this->resolve(id);
            			}
            			break;
            			case (int)2: {
HXLINE( 332)				 ::hscript::CType _g = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 332)				HX_VARI( ::String,n) = e->_hx_getString(0);
HXDLIN( 332)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 335)				return null();
            			...
            			break;
            			case (int)3: {
HXLINE( 336)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 337)				return this->expr(e1);
            			}
            			break;
            			case (int)4: {
HXLINE( 338)				HX_VARI( ::Array< ::Dynamic>,exprs) = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 339)				HX_VARI( int,old) = this->declared->length;
HXLINE( 340)				HX_VARI(  ::Dynamic,v) = null();
HXLINE( 341)				{
HXLINE( 341)					int _g = 0;
HXDLIN( 341)					while((_g < exprs->length)){
HXLINE( 341)						HX_VARI(  ::hscript::Expr,e) = exprs->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 341)						_g = (_g + 1);
...
HXLINE( 344)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 345)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 345)				HX_VARI( ::String,f) = e->_hx_getString(1);
HXLINE( 346)				return this->get(this->expr(e1),f);
            			}
            			break;
            			case (int)6: {
HXLINE( 347)				HX_VARI( ::String,op) = e->_hx_getString(0);
HXDLIN( 347)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 347)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 348)				HX_VARI(  ::Dynamic,fop) = this->binops->get(op);
...
HXLINE( 350)				return fop(e1,e2);
            			...
            			break;
            			case (int)7: {
HXLINE( 351)				HX_VARI( ::String,op) = e->_hx_getString(0);
HXDLIN( 351)				HX_VARI( bool,prefix) = e->_hx_getBool(1);
HXDLIN( 351)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 368)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            			...
            			break;
            			case (int)8: {
HXLINE( 370)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 370)				HX_VARI( ::Array< ::Dynamic>,params) = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 371)				HX_VARI( ::cpp::VirtualArray,args) = ::cpp::VirtualArray_obj::__new();
HXLINE( 372)				{
HXLINE( 372)					int _g = 0;
HXDLIN( 372)					while((_g < params->length)){
HXLINE( 372)						HX_VARI(  ::hscript::Expr,p) = params->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 372)						_g = (_g + 1);
HXLINE( 373)						args->push(this->expr(p));
            					}
            				}
HXLINE( 375)				if ((e1->_hx_getIndex() == 5)) {
HXLINE( 376)					HX_VARI(  ::hscript::Expr,e) = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 376)					HX_VARI( ::String,f) = e1->_hx_getString(1);
HXLINE( 377)					HX_VARI(  ::Dynamic,obj) = this->expr(e);
...
HXLINE( 381)					return this->call(null(),this->expr(e1),args);
            			...
            			break;
            			case (int)9: {
HXLINE( 383)				HX_VARI(  ::hscript::Expr,econd) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 383)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 383)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 384)						return this->expr(e2);
            			...
            			break;
            			case (int)10: {
HXLINE( 385)				HX_VARI(  ::hscript::Expr,econd) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 385)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 386)				this->whileLoop(econd,e1);
HXLINE( 387)				return null();
            			}
            			break;
            			case (int)11: {
HXLINE( 391)				HX_VARI( ::String,v) = e->_hx_getString(0);
HXDLIN( 391)				HX_VARI(  ::hscript::Expr,it) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 391)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 413)							HX_VARI( ::String,str) = (((HX_("Invalid number of parameters. Got ",cb,2b,d9,b1) + args->get_length()) + HX_(", required ",ed,0c,66,93)) + minParams->__get(0));
...
HXLINE( 418)						HX_VARI( ::cpp::VirtualArray,args2) = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 419)						HX_VARI( int,extraParams) = (args->get_length() - minParams->__get(0));
HXLINE( 420)						HX_VARI( int,pos) = 0;
HXLINE( 421)						{
HXLINE( 421)							int _g = 0;
HXDLIN( 421)							while((_g < params->length)){
HXLINE( 421)								HX_VARI(  ::Dynamic,p) = params->__get(_g);
HXDLIN( 421)								_g = (_g + 1);
...
HXLINE( 432)					HX_VARI(  ::haxe::ds::StringMap,old) = me->locals;
HXDLIN( 432)					HX_VARI( int,depth) = me->depth;
HXLINE( 433)					me->depth++;
...
HXLINE( 437)					HX_VARI(  ::Dynamic,r) = null();
...
HXDLIN( 441)								HX_VARI(  ::Dynamic,e) = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXDLIN( 401)				HX_VARI( ::Array< ::Dynamic>,params) = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 401)				HX_VARI(  ::hscript::Expr,fexpr) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 401)				HX_VARI( ::String,name) = e->_hx_getString(2);
HXLINE( 402)				HX_VARI(  ::haxe::ds::StringMap,capturedLocals) = this->duplicate(this->locals);
HXLINE( 403)				HX_VARI(  ::hscript::Interp,me) = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 404)				HX_VARI( bool,hasOpt) = false;
HXDLIN( 404)				HX_VARI( ::Array< int >,minParams) = ::Array_obj< int >::fromData( _hx_array_data_9af07c8f_65,1);
HXLINE( 405)				{
HXLINE( 405)					int _g1 = 0;
HXDLIN( 405)					while((_g1 < params->length)){
HXLINE( 405)						HX_VARI(  ::Dynamic,p) = params->__get(_g1);
...
HXLINE( 410)				HX_VARI(  ::Dynamic,f) =  ::Dynamic(new _hx_Closure_0(name,fexpr,_gthis,minParams,me,params,capturedLocals));
HXLINE( 456)				HX_VARI(  ::Dynamic,f1) = ::Reflect_obj::makeVarArgs(f);
...
HXLINE( 464)						HX_VARI(  ::Dynamic,ref) =  ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 469)				return f1;
            			...
            			break;
            			case (int)15: {
HXLINE( 398)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 400)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::_Interp::Stop_obj::SReturn_dyn()));
            			...
            			break;
            			case (int)16: {
HXLINE( 512)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 512)				HX_VARI(  ::hscript::Expr,index) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 513)				HX_VARI(  ::Dynamic,arr) = this->expr(e1);
HXLINE( 514)				HX_VARI(  ::Dynamic,index1) = this->expr(index);
...
HXLINE( 519)					return arr->__GetItem(( (int)(index1) ));
            			...
            			break;
            			case (int)17: {
HXLINE( 470)				HX_VARI( ::Array< ::Dynamic>,arr) = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE( 472)					HX_VARI( bool,isAllString) = true;
HXLINE( 473)					HX_VARI( bool,isAllInt) = true;
HXLINE( 474)					HX_VARI( bool,isAllObject) = true;
HXLINE( 475)					HX_VARI( bool,isAllEnum) = true;
HXLINE( 476)					HX_VARI( ::cpp::VirtualArray,keys) = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 477)					HX_VARI( ::cpp::VirtualArray,values) = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 478)					{
HXLINE( 478)						int _g = 0;
HXDLIN( 478)						while((_g < arr->length)){
HXLINE( 478)							HX_VARI(  ::hscript::Expr,e) = arr->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 478)							_g = (_g + 1);
HXLINE( 479)							if ((e->_hx_getIndex() == 6)) {
HXLINE( 480)								if ((e->_hx_getString(0) == HX_("=>",61,35,00,00))) {
HXLINE( 480)									HX_VARI(  ::hscript::Expr,eKey) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 480)									HX_VARI(  ::hscript::Expr,eValue) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 480)									{
HXLINE( 481)										HX_VARI(  ::Dynamic,key) = this->expr(eKey);
HXLINE( 482)										HX_VARI(  ::Dynamic,value) = this->expr(eValue);
...
HXDLIN( 500)							HX_VARI( int,n) = (_g1 - 1);
...
HXLINE( 506)					HX_VARI( ::cpp::VirtualArray,a) = ::cpp::VirtualArray_obj::__new();
HXLINE( 507)					{
HXLINE( 507)						int _g = 0;
HXDLIN( 507)						while((_g < arr->length)){
HXLINE( 507)							HX_VARI(  ::hscript::Expr,e) = arr->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 507)							_g = (_g + 1);
...
HXLINE( 510)					return a;
            			...
            			break;
            			case (int)18: {
HXLINE( 521)				HX_VARI( ::String,cl) = e->_hx_getString(0);
HXDLIN( 521)				HX_VARI( ::Array< ::Dynamic>,params) = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 522)				HX_VARI( ::cpp::VirtualArray,a) = ::cpp::VirtualArray_obj::__new();
HXLINE( 523)				{
HXLINE( 523)					int _g = 0;
HXDLIN( 523)					while((_g < params->length)){
HXLINE( 523)						HX_VARI(  ::hscript::Expr,e) = params->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 523)						_g = (_g + 1);
...
HXLINE( 525)				return this->cnew(cl,a);
            			...
            			break;
            			case (int)19: {
HXLINE( 526)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 528)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 528)				HX_VARI( ::String,n) = e->_hx_getString(1);
HXDLIN( 528)				HX_VARI(  ::hscript::Expr,ecatch) = e->_hx_getObject(3).StaticCast<  ::hscript::Expr >();
HXLINE( 529)				HX_VARI( int,old) = this->declared->length;
HXLINE( 530)				HX_VARI( bool,oldTry) = this->inTry;
HXLINE( 531)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 532)					this->inTry = true;
HXLINE( 533)					HX_VARI(  ::Dynamic,v) = this->expr(e1);
...
HXLINE( 547)							HX_VARI(  ::Dynamic,v) = this->expr(ecatch);
...
HXLINE( 549)							return v;
            			...
            			break;
            			case (int)21: {
HXLINE( 551)				HX_VARI( ::Array< ::Dynamic>,fl) = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 552)				HX_VARI(  ::Dynamic,o) =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE( 553)				{
HXLINE( 553)					int _g = 0;
HXDLIN( 553)					while((_g < fl->length)){
HXLINE( 553)						HX_VARI(  ::Dynamic,f) = fl->__get(_g);
HXDLIN( 553)						_g = (_g + 1);
...
HXLINE( 555)				return o;
            			...
            			break;
            			case (int)22: {
HXLINE( 556)				HX_VARI(  ::hscript::Expr,econd) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 556)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 556)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 557)					return this->expr(e2);
            			...
            			break;
            			case (int)23: {
HXLINE( 558)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 558)				HX_VARI( ::Array< ::Dynamic>,cases) = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 558)				HX_VARI(  ::hscript::Expr,def) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 559)				HX_VARI(  ::Dynamic,val) = this->expr(e1);
HXLINE( 560)				HX_VARI( bool,match) = false;
HXLINE( 561)				{
HXLINE( 561)					int _g = 0;
HXDLIN( 561)					while((_g < cases->length)){
HXLINE( 561)						HX_VARI(  ::Dynamic,c) = cases->__get(_g);
HXDLIN( 561)						_g = (_g + 1);
HXLINE( 562)						{
...
HXLINE( 562)								HX_VARI(  ::hscript::Expr,v) = _g2->__get(_g1).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 388)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 575)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 576)				return this->expr(e1);
            			}
            			break;
            			case (int)26: {
HXLINE( 577)				 ::hscript::CType _g = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 577)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
void Interp_obj::doWhileLoop( ::hscript::Expr econd, ::hscript::Expr e){
            	...
            	HX_STACK_ARG(e,"e")
HXLINE( 583)
HXLINE( 584)		HX_VARI( int,old) = this->declared->length;
...
HXLINE( 588)						HX_VARI(  ::hscript::_Interp::Stop,err) = _g1;
...
void Interp_obj::whileLoop( ::hscript::Expr econd, ::hscript::Expr e){
            	...
            	HX_STACK_ARG(e,"e")
HXLINE( 600)
HXLINE( 601)		HX_VARI( int,old) = this->declared->length;
...
HXLINE( 605)						HX_VARI(  ::hscript::_Interp::Stop,err) = _g1;
...
void Interp_obj::forLoop(::String n, ::hscript::Expr it, ::hscript::Expr e){
            	...
            	HX_STACK_ARG(e,"e")
HXLINE( 626)
HXLINE( 627)		HX_VARI( int,old) = this->declared->length;
HXLINE( 628)		::Array< ::Dynamic> _hx_tmp = this->declared;
HXDLIN( 628)		_hx_tmp->push( ::Dynamic(::hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("n",6e,00,00,00),n)
            			->setFixed(1,HX_("old",a7,98,54,00),this->locals->get(n))));
HXLINE( 629)		HX_VARI(  ::Dynamic,it1) = this->makeIterator(this->expr(it));
...
HXLINE( 634)						HX_VARI(  ::hscript::_Interp::Stop,err) = _g1;
...
HX_DEFINE_DYNAMIC_FUNC3(Interp_obj,call,return )
 ...
 ::Dynamic Interp_obj::cnew(::String cl,::cpp::VirtualArray args){
            	...
            	HX_STACK_ARG(args,"args")
HXLINE( 687)
HXLINE( 688)		HX_VARI( ::hx::Class,c) = ::Type_obj::resolveClass(cl);

...
HXLINE( 141)						HX_VARI( ::String,x) = _g2->__get(_g1);
...
HXLINE( 145)		{
HXLINE( 145)			{
HXLINE( 145)				HX_VARI( ::String,x) = HX_("!",21,00,00,00);
HXLINE( 146)				{
...
HXLINE( 145)			{
HXLINE( 145)				HX_VARI( ::String,x1) = HX_("++",a0,25,00,00);
HXLINE( 146)				{
...
HXLINE( 145)			{
HXLINE( 145)				HX_VARI( ::String,x2) = HX_("--",60,27,00,00);
HXLINE( 146)				{
...
HXLINE( 145)			{
HXLINE( 145)				HX_VARI( ::String,x3) = HX_("-",2d,00,00,00);
HXLINE( 146)				{
...
HXLINE( 145)			{
HXLINE( 145)				HX_VARI( ::String,x4) = HX_("~",7e,00,00,00);
HXLINE( 146)				{
...
HXDLIN( 182)				HX_VARI( int,i) = (_g2 - 1);
...
HXLINE( 190)		HX_VARI( ::Array< ::Dynamic>,a) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 191)		while(true){
HXLINE( 192)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
void Parser_obj::ensure( ::hscript::Token tk){
            	...
            	HX_STACK_ARG(tk,"tk")
HXLINE( 215)
HXLINE( 216)		HX_VARI(  ::hscript::Token,t) = this->token();
...
void Parser_obj::ensureToken( ::hscript::Token tk){
            	...
            	HX_STACK_ARG(tk,"tk")
HXLINE( 220)
HXLINE( 221)		HX_VARI(  ::hscript::Token,t) = this->token();
...
bool Parser_obj::maybe( ::hscript::Token tk){
            	...
            	HX_STACK_ARG(tk,"tk")
HXLINE( 225)
HXLINE( 226)		HX_VARI(  ::hscript::Token,t) = this->token();
...
::String Parser_obj::getIdent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 233)
HXLINE( 234)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 236)				HX_VARI( ::String,id) = tk->_hx_getString(0);
...
HXDLIN( 283)				HX_VARI(  ::hscript::CType,t) = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 283)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 285)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 285)				return this->isBlock(e1);
            			}
            			break;
            			case (int)7: {
HXLINE( 286)				::String _g = e->_hx_getString(0);
HXDLIN( 286)				HX_VARI( bool,prefix) = e->_hx_getBool(1);
HXDLIN( 286)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 284)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 284)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 287)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 289)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 282)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 282)				return this->isBlock(e1);
            			}
            			break;
            			case (int)15: {
HXLINE( 290)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 291)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(3).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 288)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 292)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 297)
HXLINE( 298)		HX_VARI(  ::hscript::Expr,e) = this->parseExpr();
HXLINE( 299)		exprs->push(e);
HXLINE( 301)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,parseFullExpr,(void))
 ...
 ::hscript::Expr Parser_obj::parseObject( ::Dynamic p1){
            	...
            	HX_STACK_ARG(p1,"p1")
HXLINE( 317)
HXLINE( 319)		HX_VARI( ::Array< ::Dynamic>,fl) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 320)		while(true){
HXLINE( 321)			HX_VARI(  ::hscript::Token,tk) = this->token();
HXLINE( 322)			HX_VARI( ::String,id) = null();
...
HXLINE( 323)				switch((int)(tk->_hx_getIndex())){
            					case (int)1: {
HXLINE( 325)						HX_VARI(  ::hscript::Const,c) = tk->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXDLIN( 325)						{
HXLINE( 326)							if (!(this->allowJSON)) {
HXLINE( 327)								this->unexpected(tk);
            							}
HXLINE( 328)							if ((c->_hx_getIndex() == 2)) {
HXLINE( 329)								HX_VARI( ::String,s) = c->_hx_getString(0);
HXDLIN( 329)								id = s;
            							}
            							else {
HXLINE( 330)								this->unexpected(tk);
            					...
            					break;
            					case (int)2: {
HXLINE( 324)						HX_VARI( ::String,i) = tk->_hx_getString(0);
HXDLIN( 324)						id = i;
            					}
            					break;
            					case (int)7: {
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,parseObject,return )
 ...
 ::hscript::Expr Parser_obj::parseExpr(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 352)
HXLINE( 353)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 357)			switch((int)(tk->_hx_getIndex())){
            				case (int)1: {
HXLINE( 363)					HX_VARI(  ::hscript::Const,c) = tk->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXLINE( 364)					return this->parseExprNext(::hscript::Expr_obj::EConst(c));
            				}
            				break;
            				case (int)2: {
HXLINE( 358)					HX_VARI( ::String,id) = tk->_hx_getString(0);
HXLINE( 359)					HX_VARI(  ::hscript::Expr,e) = this->parseStructure(id);
...
HXLINE( 362)					return this->parseExprNext(e);
            				...
            				break;
            				case (int)3: {
HXLINE( 435)					HX_VARI( ::String,op) = tk->_hx_getString(0);
HXLINE( 436)					if (this->unops->exists(op)) {
HXLINE( 437)						HX_VARI( int,start) = 0;
HXLINE( 438)						HX_VARI(  ::hscript::Expr,e) = this->parseExpr();
...
HXDLIN( 443)								switch((int)(_g->_hx_getIndex())){
            									case (int)0: {
HXLINE( 441)										HX_VARI( int,i) = _g->_hx_getInt(0);
HXLINE( 442)										return ::hscript::Expr_obj::EConst(::hscript::Const_obj::CInt(-(i)));
            									}
            									break;
            									case (int)1: {
HXLINE( 443)										HX_VARI( Float,f) = _g->_hx_getFloat(0);
...
HXLINE( 449)					return this->unexpected(tk);
            				...
            				break;
            				case (int)4: {
HXLINE( 366)					HX_VARI(  ::hscript::Expr,e) = this->parseExpr();
...
HXLINE( 386)									HX_VARI( ::String,v) = e->_hx_getString(0);
HXDLIN( 386)									return this->parseLambda(::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(::hx::Anon_obj::Create(1)
            							...
            							break;
            							case (int)14: {
HXLINE( 372)								HX_VARI(  ::hscript::CType,t) = this->parseType();
...
HXLINE( 379)												HX_VARI( ::String,v) = e->_hx_getString(0);
...
HXLINE( 394)						switch((int)(tk->_hx_getIndex())){
            							case (int)1: {
HXLINE( 406)								HX_VARI(  ::hscript::Const,c) = tk->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXLINE( 407)								if (this->allowJSON) {
HXLINE( 408)									if ((c->_hx_getIndex() == 2)) {
HXLINE( 409)										::String _g = c->_hx_getString(0);
HXDLIN( 409)										{
HXLINE( 410)											HX_VARI(  ::hscript::Token,tk2) = this->token();
HXLINE( 411)											{
...
HXDLIN( 397)								{
HXLINE( 398)									HX_VARI(  ::hscript::Token,tk2) = this->token();
HXLINE( 399)									{
...
HXLINE( 426)					HX_VARI( ::Array< ::Dynamic>,a) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 434)					return ::hscript::Expr_obj::EBlock(a);
            				...
            				break;
            				case (int)11: {
HXLINE( 451)					HX_VARI( ::Array< ::Dynamic>,a) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 463)								HX_VARI( ::String,tmp) = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 464)								HX_VARI(  ::hscript::Expr,e) = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hscript::Expr_obj::EVar(tmp,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp,a->__get(0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp)));
...
HXLINE( 472)					return this->parseExprNext(::hscript::Expr_obj::EArrayDecl(a));
            				...
            				break;
            				case (int)15: {
HXLINE( 473)					HX_VARI( ::String,id) = tk->_hx_getString(0);
HXDLIN( 473)					if (this->allowMetadata) {
HXLINE( 474)						HX_VARI( ::Array< ::Dynamic>,args) = this->parseMetaArgs();
...
HXLINE( 483)			HX_VARI( ::String,id) = this->getIdent();
HXLINE( 484)			HX_VAR(  ::hscript::CType,t);
...
HXLINE( 485)			args->push( ::Dynamic(::hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("t",74,00,00,00),t)
            				->setFixed(1,HX_("name",4b,72,ff,48),id)));
HXLINE( 486)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 497)		HX_VARI(  ::hscript::Expr,eret) = this->parseExpr();
...
::Array< ::Dynamic> Parser_obj::parseMetaArgs(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 501)
HXLINE( 502)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 507)		HX_VARI( ::Array< ::Dynamic>,args) = ::Array_obj< ::Dynamic>::__new(0);
...
HXLINE( 517)						HX_VARI(  ::hscript::Token,tk) = _g;
...
HXLINE( 527)		HX_VAR(  ::hscript::Expr,edef);
HXDLIN( 527)		switch((int)(e->_hx_getIndex())){
            			case (int)3: {
HXLINE( 538)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 536)					HX_VARI(  ::hscript::Expr,e) = _g->__get(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 527)					edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)9: {
HXLINE( 534)				HX_VARI(  ::hscript::Expr,cond) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 534)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 534)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 527)					edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)10: {
HXLINE( 530)				HX_VARI(  ::hscript::Expr,cond) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 530)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 527)				edef = ::hscript::Expr_obj::EWhile(cond,this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)11: {
HXLINE( 528)				HX_VARI( ::String,v) = e->_hx_getString(0);
HXDLIN( 528)				HX_VARI(  ::hscript::Expr,it) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 528)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 527)				edef = ::hscript::Expr_obj::EFor(v,it,this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)24: {
HXLINE( 532)				HX_VARI(  ::hscript::Expr,cond) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 532)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXLINE( 549)		switch((int)(e->_hx_getIndex())){
            			case (int)6: {
HXLINE( 550)				HX_VARI( ::String,bop) = e->_hx_getString(0);
HXDLIN( 550)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 550)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 550)				return ::hscript::Expr_obj::EBinop(bop,this->makeUnop(op,e1),e2);
            			}
            			break;
            			case (int)22: {
HXLINE( 551)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 551)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 551)				HX_VARI(  ::hscript::Expr,e3) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 559)		switch((int)(e->_hx_getIndex())){
            			case (int)6: {
HXLINE( 560)				HX_VARI( ::String,op2) = e->_hx_getString(0);
HXDLIN( 560)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 560)				HX_VARI(  ::hscript::Expr,e3) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 564)					return ::hscript::Expr_obj::EBinop(op,e1,e);
            			...
            			break;
            			case (int)22: {
HXLINE( 565)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 565)				HX_VARI(  ::hscript::Expr,e3) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 565)				HX_VARI(  ::hscript::Expr,e4) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 618)			HX_VARI(  ::hscript::Expr,e) = this->parseExpr();
HXLINE( 619)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 625)			HX_VARI(  ::hscript::Expr,econd) = this->parseExpr();
...
HXLINE( 629)			HX_VARI( ::String,vname) = this->getIdent();
HXLINE( 630)			{
...
HXLINE( 631)			HX_VARI(  ::hscript::Expr,eiter) = this->parseExpr();
HXLINE( 632)			{
...
HXLINE( 633)			HX_VARI(  ::hscript::Expr,e) = this->parseExpr();
HXLINE( 634)			return ::hscript::Expr_obj::EFor(vname,eiter,e);
HXLINE( 627)			goto _hx_goto_45;
            		}
            		if (  (_hx_switch_0==HX_("function",18,ab,52,14)) ){
HXLINE( 642)			HX_VARI(  ::hscript::Token,tk) = this->token();
HXLINE( 643)			HX_VARI( ::String,name) = null();
...
HXLINE( 645)					HX_VARI( ::String,id) = tk->_hx_getString(0);
HXDLIN( 645)					name = id;
            				}
            				else {
HXLINE( 646)					 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
...
HXLINE( 648)			HX_VARI(  ::Dynamic,inf) = this->parseFunctionDecl();
...
HXLINE( 582)			HX_VARI(  ::hscript::Expr,cond) = this->parseExpr();
HXLINE( 583)			{
...
HXLINE( 584)			HX_VARI(  ::hscript::Expr,e1) = this->parseExpr();
HXLINE( 585)			HX_VARI(  ::hscript::Expr,e2) = null();
HXLINE( 586)			HX_VARI( bool,semic) = false;
HXLINE( 587)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 656)			HX_VARI( ::Array< ::String >,a) = ::Array_obj< ::String >::__new();
HXLINE( 657)			a->push(this->getIdent());
HXLINE( 658)			while(true){
HXLINE( 659)				HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 667)							goto _hx_goto_46;
            			...
            			_hx_goto_46:;
HXLINE( 670)			HX_VARI( ::Array< ::Dynamic>,args) = this->parseExprList(::hscript::Token_obj::TPClose_dyn());
...
HXLINE( 651)			HX_VARI(  ::hscript::Token,tk) = this->token();
HXLINE( 652)			{
...
HXLINE( 653)			HX_VAR(  ::hscript::Expr,e);
...
HXLINE( 690)			HX_VARI(  ::hscript::Expr,e) = this->parseExpr();
HXLINE( 691)			HX_VARI(  ::hscript::Expr,def) = null();
HXDLIN( 691)			HX_VARI( ::Array< ::Dynamic>,cases) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 692)			{
...
HXLINE( 694)				HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 697)								HX_VARI(  ::Dynamic,c) =  ::Dynamic(::hx::Anon_obj::Create(2)
...
HXLINE( 700)									HX_VARI(  ::hscript::Expr,e) = this->parseExpr();
...
HXLINE( 710)												goto _hx_goto_49;
            								...
            								_hx_goto_49:;
HXLINE( 713)								HX_VARI( ::Array< ::Dynamic>,exprs) = ::Array_obj< ::Dynamic>::__new(0);
...
HXLINE( 735)								HX_VARI( ::Array< ::Dynamic>,exprs) = ::Array_obj< ::Dynamic>::__new(0);
...
HXLINE( 679)			HX_VARI( ::String,vname) = this->getIdent();
HXLINE( 680)			{
...
HXLINE( 681)			HX_VARI(  ::hscript::CType,t3) = null();
...
HXLINE( 687)			HX_VARI(  ::hscript::Expr,ec) = this->parseExpr();
HXLINE( 688)			return ::hscript::Expr_obj::ETry(e,vname,t3,ec);
HXLINE( 675)			goto _hx_goto_45;
            		}
            		if (  (_hx_switch_0==HX_("var",e7,de,59,00)) ){
HXLINE( 600)			HX_VARI( ::String,ident) = this->getIdent();
HXLINE( 601)			HX_VARI(  ::hscript::Token,tk) = this->token();
HXLINE( 602)			HX_VARI(  ::hscript::CType,t) = null();
...
HXLINE( 607)			HX_VARI(  ::hscript::Expr,e) = null();
...
HXLINE( 614)			HX_VARI(  ::hscript::Expr,econd) = this->parseExpr();
HXLINE( 615)			HX_VARI(  ::hscript::Expr,e) = this->parseExpr();
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,parseStructure,return )
 ...
 ::hscript::Expr Parser_obj::parseExprNext( ::hscript::Expr e1){
            	...
            	HX_STACK_ARG(e1,"e1")
HXLINE( 767)
HXLINE( 768)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 769)			switch((int)(tk->_hx_getIndex())){
            				case (int)3: {
HXLINE( 770)					HX_VARI( ::String,op) = tk->_hx_getString(0);
HXLINE( 772)					if ((op == HX_("->",71,27,00,00))) {
HXLINE( 774)						switch((int)(e1->_hx_getIndex())){
            							case (int)1: {
HXLINE( 775)								HX_VARI( ::String,i) = e1->_hx_getString(0);
HXLINE( 776)								HX_VARI(  ::hscript::Expr,eret) = this->parseExpr();
...
HXLINE( 775)									HX_VARI( ::String,i) = _hx_tmp->_hx_getString(0);
HXLINE( 776)									HX_VARI(  ::hscript::Expr,eret) = this->parseExpr();
HXLINE( 777)									return ::hscript::Expr_obj::EFunction(::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(::hx::Anon_obj::Create(1)
            										->setFixed(0,HX_("name",4b,72,ff,48),i))),::hscript::Expr_obj::EReturn(eret),null(),null());
            								}
...
HXLINE( 778)									HX_VARI( ::String,i) = _hx_tmp->_hx_getString(0);
HXDLIN( 778)									HX_VARI(  ::hscript::CType,t) = e1->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXLINE( 779)									HX_VARI(  ::hscript::Expr,eret) = this->parseExpr();
...
HXLINE( 798)					return this->parseExprNext(::hscript::Expr_obj::ECall(e1,this->parseExprList(::hscript::Token_obj::TPClose_dyn())));
            				...
            				break;
            				case (int)8: {
HXLINE( 795)					HX_VARI( ::String,field) = this->getIdent();
HXLINE( 796)					return this->parseExprNext(::hscript::Expr_obj::EField(e1,field));
            				}
            				break;
            				case (int)11: {
HXLINE( 800)					HX_VARI(  ::hscript::Expr,e2) = this->parseExpr();
HXLINE( 801)					{
...
HXLINE( 802)					return this->parseExprNext(::hscript::Expr_obj::EArray(e1,e2));
            				...
            				break;
            				case (int)13: {
HXLINE( 804)					HX_VARI(  ::hscript::Expr,e2) = this->parseExpr();
HXLINE( 805)					{
...
HXLINE( 806)					HX_VARI(  ::hscript::Expr,e3) = this->parseExpr();
...
::Array< ::Dynamic> Parser_obj::parseFunctionArgs(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 814)
HXLINE( 815)		HX_VARI( ::Array< ::Dynamic>,args) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 816)		HX_VARI(  ::hscript::Token,tk) = this->token();
HXLINE( 817)		if (::hx::IsPointerNotEq( tk,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 818)			HX_VARI( bool,done) = false;
HXLINE( 819)			while(!(done)){
HXLINE( 820)				HX_VARI( ::String,name) = null();
HXDLIN( 820)				HX_VARI( bool,opt) = false;
...
HXLINE( 828)						HX_VARI( ::String,id) = tk->_hx_getString(0);
HXDLIN( 828)						name = id;
            					}
            					else {
HXLINE( 830)						this->unexpected(tk);
...
HXLINE( 833)				HX_VARI(  ::Dynamic,arg) =  ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 858)		HX_VARI( ::Array< ::Dynamic>,args) = this->parseFunctionArgs();
HXLINE( 859)		HX_VARI(  ::hscript::CType,ret) = null();
HXLINE( 860)		if (this->allowTypes) {
HXLINE( 861)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
::Array< ::String > Parser_obj::parsePath(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 870)
HXLINE( 871)		HX_VARI( ::Array< ::String >,path) = ::Array_obj< ::String >::__new(1)->init(0,this->getIdent());
HXLINE( 872)		while(true){
HXLINE( 873)			HX_VARI(  ::hscript::Token,t) = this->token();
...
HXLINE( 884)		HX_VARI(  ::hscript::Token,t) = this->token();
...
HXLINE( 885)			switch((int)(t->_hx_getIndex())){
            				case (int)2: {
HXLINE( 886)					HX_VARI( ::String,v) = t->_hx_getString(0);
HXLINE( 887)					{
...
HXLINE( 888)					HX_VARI( ::Array< ::String >,path) = this->parsePath();
HXLINE( 889)					HX_VARI( ::Array< ::Dynamic>,params) = null();
...
HXLINE( 892)							HX_VARI( ::String,op) = t->_hx_getString(0);
...
HXLINE( 898)										switch((int)(t->_hx_getIndex())){
            											case (int)3: {
HXLINE( 900)												HX_VARI( ::String,op) = t->_hx_getString(0);
HXDLIN( 900)												{
...
HXLINE( 931)								HX_VARI(  ::hscript::Token,t) = _g;
...
HXLINE( 922)					HX_VARI(  ::hscript::Token,a) = this->token();
HXDLIN( 922)					HX_VARI(  ::hscript::Token,b) = this->token();
HXLINE( 925)					{
...
HXLINE( 928)					HX_VARI(  ::Dynamic,withReturn) =  ::Dynamic(new _hx_Closure_0(_gthis));
HXLINE( 937)					if (::hx::IsNull( a )) {
HXLINE( 953)						HX_VARI(  ::hscript::CType,t) = this->parseType();
HXLINE( 954)						 ::hscript::Token _g = this->token();
HXDLIN( 954)						if (::hx::IsNull( _g )) {
HXLINE( 966)							HX_VARI(  ::hscript::Token,t) = _g;
...
HXLINE( 965)									return this->parseTypeNext(::hscript::CType_obj::CTParent(t));
            								...
            								break;
            								case (int)9: {
HXLINE( 956)									HX_VARI( ::Array< ::Dynamic>,args) = ::Array_obj< ::Dynamic>::__new(1)->init(0,t);
...
HXLINE( 940)												HX_VARI(  ::Dynamic,arg) = _g2->__get(_g1);
...
HXLINE( 943)														HX_VARI(  ::hscript::Expr,v) = _g3;
...
HXLINE( 940)										HX_VARI( ::Array< ::Dynamic>,args) = _g;
...
HXDLIN( 966)											return this->unexpected(t);
            				...
            				break;
            				case (int)6: {
HXLINE( 970)					HX_VARI( ::Array< ::Dynamic>,fields) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 971)					HX_VARI( ::Array< ::Dynamic>,meta) = null();
...
HXLINE( 977)										HX_VARI( ::String,name) = this->getIdent();
HXLINE( 978)										{
...
HXLINE( 982)										HX_VARI( ::String,name) = _g;
HXDLIN( 982)										{
HXLINE( 983)											{
...
HXLINE( 975)									goto _hx_goto_68;
            								...
            								break;
            								case (int)15: {
HXLINE( 991)									HX_VARI( ::String,name) = t->_hx_getString(0);
HXDLIN( 991)									{
...
HX_DEFINE_DYNAMIC_FUNC0(Parser_obj,parseType,return )
 ...
 ::hscript::CType Parser_obj::parseTypeNext( ::hscript::CType t){
            	...
            	HX_STACK_ARG(t,"t")
HXLINE(1005)
HXLINE(1006)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE(1008)				HX_VARI( ::String,op) = tk->_hx_getString(0);
...
HXLINE(1017)		HX_VARI(  ::hscript::CType,t2) = this->parseType();
HXLINE(1018)		if ((t2->_hx_getIndex() == 1)) {
HXLINE(1019)			 ::hscript::CType _g = t2->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN(1019)			HX_VARI( ::Array< ::Dynamic>,args) = t2->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE(1027)
HXLINE(1028)		HX_VARI( ::Array< ::Dynamic>,args) = ::Array_obj< ::Dynamic>::__new();
HXLINE(1029)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE(1055)		HX_VARI( ::Array< ::Dynamic>,decls) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1056)		while(true){
HXLINE(1057)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
::Array< ::Dynamic> Parser_obj::parseMetadata(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1065)
HXLINE(1066)		HX_VARI( ::Array< ::Dynamic>,meta) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1067)		while(true){
HXLINE(1068)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE(1070)					HX_VARI( ::String,name) = tk->_hx_getString(0);
...
HX_DEFINE_DYNAMIC_FUNC0(Parser_obj,parseParams,return )
 ...
 ::hscript::ModuleDecl Parser_obj::parseModuleDecl(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1086)
HXLINE(1087)		HX_VARI( ::Array< ::Dynamic>,meta) = this->parseMetadata();
HXLINE(1088)		HX_VARI( ::String,ident) = this->getIdent();
HXLINE(1089)		HX_VARI( bool,isPrivate) = false;
HXDLIN(1089)		HX_VARI( bool,isExtern) = false;
...
HXLINE(1128)			HX_VARI( ::String,name) = this->getIdent();
HXLINE(1129)			HX_VARI(  ::Dynamic,params) = this->parseParams();
HXLINE(1130)			HX_VARI(  ::hscript::CType,extend) = null();
HXLINE(1131)			HX_VARI( ::Array< ::Dynamic>,implement) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1133)			while(true){
HXLINE(1134)				HX_VARI(  ::hscript::Token,t) = this->token();
...
HXLINE(1142)						goto _hx_goto_82;
            			...
            			_hx_goto_82:;
HXLINE(1146)			HX_VARI( ::Array< ::Dynamic>,fields) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1147)			{
...
HXLINE(1107)			HX_VARI( ::Array< ::String >,path) = ::Array_obj< ::String >::__new(1)->init(0,this->getIdent());
HXLINE(1108)			HX_VARI( bool,star) = false;
HXLINE(1109)			while(true){
HXLINE(1110)				HX_VARI(  ::hscript::Token,t) = this->token();
...
HXLINE(1116)					switch((int)(t->_hx_getIndex())){
            						case (int)2: {
HXLINE(1117)							HX_VARI( ::String,id) = t->_hx_getString(0);
...
HXLINE(1103)			HX_VARI( ::Array< ::String >,path) = this->parsePath();
HXLINE(1104)			{
...
HXLINE(1162)			HX_VARI( ::String,name) = this->getIdent();
HXLINE(1163)			HX_VARI(  ::Dynamic,params) = this->parseParams();
HXLINE(1164)			{
...
HXLINE(1165)			HX_VARI(  ::hscript::CType,t1) = this->parseType();
...
HX_DEFINE_DYNAMIC_FUNC0(Parser_obj,parseModuleDecl,return )
 ...
 ::Dynamic Parser_obj::parseField(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1179)
HXLINE(1180)		HX_VARI( ::Array< ::Dynamic>,meta) = this->parseMetadata();
HXLINE(1181)		HX_VARI( ::Array< ::Dynamic>,access) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1182)		while(true){
HXLINE(1183)			HX_VARI( ::String,id) = this->getIdent();
HXLINE(1184)			::String _hx_switch_0 = id;
            			if (  (_hx_switch_0==HX_("function",18,ab,52,14)) ){
HXLINE(1198)				HX_VARI( ::String,name) = this->getIdent();
HXLINE(1199)				HX_VARI(  ::Dynamic,inf) = this->parseFunctionDecl();
...
HXDLIN(1194)				goto _hx_goto_88;
            			...
            			if (  (_hx_switch_0==HX_("var",e7,de,59,00)) ){
HXLINE(1211)				HX_VARI( ::String,name) = this->getIdent();
HXLINE(1212)				HX_VARI( ::String,get) = null();
HXDLIN(1212)				HX_VARI( ::String,set) = null();
...
HXLINE(1219)				HX_VAR(  ::hscript::CType,type);
...
HXLINE(1220)				HX_VAR(  ::hscript::Expr,expr);
...
HXLINE(1257)
HXLINE(1258)		HX_VARI( int,c) = 0;
HXLINE(1259)		HX_VARI(  ::StringBuf,b) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE(1260)		HX_VARI( bool,esc) = false;
HXLINE(1261)		HX_VARI( int,old) = this->line;
HXLINE(1262)		HX_VARI( ::String,s) = this->input;
HXLINE(1266)		while(true){
HXLINE(1267)			HX_VARI( int,c) = this->input.cca(this->readPos++);
HXLINE(1268)			if ((c == 0)) {
...
HXLINE(1283)						HX_VARI( int,k) = 0;
HXLINE(1284)						{
HXLINE(1284)							int _g = 0;
HXDLIN(1284)							while((_g < 4)){
HXLINE(1284)								_g = (_g + 1);
HXDLIN(1284)								HX_VARI( int,i) = (_g - 1);
HXLINE(1285)								k = (k << 4);
HXLINE(1286)								HX_VARI_NAME( int,_hx_char,"char") = this->input.cca(this->readPos++);
...
HXLINE(1338)		HX_VAR_NAME( int,_hx_char,"char");
...
HXLINE(1507)						HX_VARI( ::String,id) = ::String::fromCharCode(_hx_char);
...
HXLINE(1470)							return ::hscript::Token_obj::TOp(HX_("...",ee,0f,23,00));
            						...
            						break;
            						case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1453)							HX_VARI( int,n) = (_hx_char - 48);
HXLINE(1454)							HX_VARI( int,exp) = 1;
...
HXLINE(1473)							return ::hscript::Token_obj::TDot_dyn();
            				...
            				break;
            				case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1362)					HX_VARI( Float,n) = (( (Float)((_hx_char - 48)) ) * ((Float)1.0));
HXLINE(1363)					HX_VARI( Float,exp) = ((Float)0.);
...
HXLINE(1392)										HX_VARI( int,i) = ::Std_obj::_hx_int(n);
...
HXLINE(1371)								HX_VARI(  ::hscript::Token,tk) = this->token();
HXLINE(1372)								HX_VARI(  ::Dynamic,pow) = null();
...
HXLINE(1374)												HX_VARI( int,e) = _g->_hx_getInt(0);
HXDLIN(1374)												pow = e;
            											}
            											else {
HXLINE(1382)												 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
...
HXLINE(1378)															HX_VARI( int,e) = _g->_hx_getInt(0);
HXDLIN(1378)															pow = -(e);
            														}
            														else {
HXLINE(1379)															 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
...
HXLINE(1441)								HX_VARI( int,i) = ::Std_obj::_hx_int(n);
...
HXLINE(1493)						HX_VARI( ::String,id) = ::String::fromCharCode(_hx_char);
...
HXLINE(1520)						HX_VARI( ::String,op) = ::String::fromCharCode(_hx_char);
HXLINE(1521)						HX_VARI( int,prev) = -1;
...
HXLINE(1536)						HX_VARI( ::String,id) = ::String::fromCharCode(_hx_char);
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,preprocValue,return )
 ...
 ::hscript::Expr Parser_obj::parsePreproCond(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1560)
HXLINE(1561)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE(1562)			switch((int)(tk->_hx_getIndex())){
            				case (int)2: {
HXLINE(1566)					HX_VARI( ::String,id) = tk->_hx_getString(0);
...
HXDLIN(1576)		switch((int)(e->_hx_getIndex())){
            			case (int)1: {
HXLINE(1577)				HX_VARI( ::String,id) = e->_hx_getString(0);
HXLINE(1578)				return ::hx::IsNotNull( this->preprocValue(id) );
            			}
            			break;
            			case (int)3: {
HXLINE(1581)				HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE(1583)					HX_VARI(  ::hscript::Expr,e1) = _g;
HXDLIN(1583)					HX_VARI(  ::hscript::Expr,e2) = _g1;
...
HXLINE(1585)					HX_VARI(  ::hscript::Expr,e1) = _g;
HXDLIN(1585)					HX_VARI(  ::hscript::Expr,e2) = _g1;
...
HXLINE(1579)					HX_VARI(  ::hscript::Expr,e1) = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE(1618)			goto _hx_goto_107;
            		...
            		if (  (_hx_switch_0==HX_("if",dd,5b,00,00)) ){
HXLINE(1596)			HX_VARI(  ::hscript::Expr,e) = this->parsePreproCond();
...
void Parser_obj::skipTokens(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1626)
HXLINE(1627)		HX_VARI( int,spos) = (this->preprocStack->length - 1);
HXLINE(1628)		HX_VARI(  ::Dynamic,obj) = this->preprocStack->__get(spos);
HXLINE(1629)		HX_VARI( int,pos) = this->readPos;
HXLINE(1630)		while(true){
HXLINE(1631)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE(1641)
HXLINE(1642)		HX_VARI(  ::Dynamic,c) = op.charCodeAt(1);
HXLINE(1643)		HX_VARI( ::String,s) = this->input;
...
HXLINE(1653)			HX_VARI( int,old) = this->line;
...
HXDLIN(1684)		switch((int)(c->_hx_getIndex())){
            			case (int)0: {
HXLINE(1685)				HX_VARI( int,v) = c->_hx_getInt(0);
HXDLIN(1685)				return ::Std_obj::string(v);
            			}
            			break;
            			case (int)1: {
HXLINE(1686)				HX_VARI( Float,f) = c->_hx_getFloat(0);
HXDLIN(1686)				return ::Std_obj::string(f);
            			}
            			break;
            			case (int)2: {
HXLINE(1687)				HX_VARI( ::String,s) = c->_hx_getString(0);
...
HXLINE(1696)				return HX_("<eof>",3e,ee,21,cf);
            			...
            			break;
            			case (int)1: {
HXLINE(1697)				HX_VARI(  ::hscript::Const,c) = t->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXDLIN(1697)				return this->constString(c);
            			}
            			break;
            			case (int)2: {
HXLINE(1698)				HX_VARI( ::String,s) = t->_hx_getString(0);
HXDLIN(1698)				return s;
            			}
            			break;
            			case (int)3: {
HXLINE(1699)				HX_VARI( ::String,s) = t->_hx_getString(0);
...
HXLINE(1710)				return HX_(":",3a,00,00,00);
            			...
            			break;
            			case (int)15: {
HXLINE(1711)				HX_VARI( ::String,id) = t->_hx_getString(0);
HXDLIN(1711)				return (HX_("@",40,00,00,00) + id);
            			}
            			break;
            			case (int)16: {
HXLINE(1712)				HX_VARI( ::String,id) = t->_hx_getString(0);

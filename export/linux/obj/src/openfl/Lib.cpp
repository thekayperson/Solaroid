...
HXLINE(  82)			HX_VARI(  ::haxe::Timer,timer) = ( ( ::haxe::Timer)(::openfl::Lib_obj::_hx___timers->get(id)) );
...
HXLINE(  98)			HX_VARI(  ::haxe::Timer,timer) = ( ( ::haxe::Timer)(::openfl::Lib_obj::_hx___timers->get(id)) );
...
HXLINE( 153)		HX_VAR( ::hx::Class,ref);
...
HXLINE( 193)		HX_VAR( ::hx::Class,ref);
...
HXLINE( 195)		HX_VARI( ::hx::Class,parentRef) = ::Type_obj::getSuperClass(ref);
...
HXLINE( 396)		HX_VARI( ::String,uri) = request->url;
HXLINE( 398)		if (::hx::IsPointerEq( ::Type_obj::_hx_typeof(request->data),::ValueType_obj::TObject_dyn() )) {
HXLINE( 400)			HX_VARI( ::String,query) = HX_("",00,00,00,00);
HXLINE( 401)			HX_VARI( ::Array< ::String >,fields) = ::Reflect_obj::fields(request->data);
HXLINE( 403)			{
HXLINE( 403)				int _g = 0;
HXDLIN( 403)				while((_g < fields->length)){
HXLINE( 403)					HX_VARI( ::String,field) = fields->__get(_g);
HXDLIN( 403)					_g = (_g + 1);
...
HXLINE( 424)
HXLINE( 425)		HX_VARI( ::String,api) = ( (::String)(((posInfo->__Field(HX_("className",a3,92,3d,dc),::hx::paccDynamic) + HX_(".",2e,00,00,00)) + posInfo->__Field(HX_("methodName",cc,19,0f,12),::hx::paccDynamic))) );
...
void Lib_obj::sendToURL( ::openfl::net::URLRequest request){
            	...
            	HX_STACK_ARG(request,"request")
HXLINE( 491)
HXLINE( 492)		HX_VARI(  ::openfl::net::URLLoader,urlLoader) =  ::openfl::net::URLLoader_obj::__alloc( HX_CTX ,null());
...
HXLINE( 520)
HXLINE( 521)		HX_VARI( int,id) = ++::openfl::Lib_obj::_hx___lastTimerID;
HXLINE( 522)		HX_VARI(  ::haxe::Timer,timer) =  ::haxe::Timer_obj::__alloc( HX_CTX ,( (Float)(delay) ));
...
int Lib_obj::setTimeout( ::Dynamic closure,int delay,::cpp::VirtualArray args){
            	...
            	HX_STACK_ARG(args,"args")
HXLINE( 554)
HXLINE( 555)		HX_VARI( int,id) = ++::openfl::Lib_obj::_hx___lastTimerID;
HXLINE( 556)		{
            			HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,closure,::cpp::VirtualArray,args) HXARGC(0)
            			void _hx_run(){

...
HXLINE( 300)				HX_VARI(  ::openfl::events::Event,event) =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null());
HXLINE( 301)				_gthis->dispatchEvent(event);
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 289)			HX_VARI(  ::lime::net::_HTTPRequest_openfl_utils_ByteArray,httpRequest) =  ::lime::net::_HTTPRequest_openfl_utils_ByteArray_obj::__alloc( HX_CTX ,null());
...
HXLINE( 317)				HX_VARI(  ::openfl::events::Event,event) =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null());
HXLINE( 318)				_gthis->dispatchEvent(event);
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 306)			HX_VARI(  ::lime::net::_HTTPRequest_String,httpRequest) =  ::lime::net::_HTTPRequest_String_obj::__alloc( HX_CTX ,null());
...
void URLLoader_obj::_hx___dispatchStatus(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 325)
HXLINE( 326)		HX_VARI(  ::openfl::events::HTTPStatusEvent,event) =  ::openfl::events::HTTPStatusEvent_obj::__alloc( HX_CTX ,HX_("httpStatus",da,4c,74,0a),false,false,this->_hx___httpRequest->__Field(HX_("responseStatus",93,60,a4,78),::hx::paccDynamic),null());
HXLINE( 327)		event->responseURL = ( (::String)(this->_hx___httpRequest->__Field(HX_("uri",6c,2b,59,00),::hx::paccDynamic)) );
HXLINE( 329)		HX_VARI( ::Array< ::Dynamic>,headers) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 334)				HX_VARI(  ::lime::net::HTTPRequestHeader,header) = _g1->__get(_g).StaticCast<  ::lime::net::HTTPRequestHeader >();
HXDLIN( 334)				_g = (_g + 1);
...
HXLINE( 357)				HX_VARI( ::Array< ::String >,fields) = ::Reflect_obj::fields(request->data);
HXLINE( 359)				{
HXLINE( 359)					int _g = 0;
HXDLIN( 359)					while((_g < fields->length)){
HXLINE( 359)						HX_VARI( ::String,field) = fields->__get(_g);
HXDLIN( 359)						_g = (_g + 1);
HXLINE( 361)						{
...
HXLINE( 378)				HX_VARI(  ::openfl::net::URLRequestHeader,header) = _g1->__get(_g).StaticCast<  ::openfl::net::URLRequestHeader >();
HXDLIN( 378)				_g = (_g + 1);
...
HXLINE( 389)		HX_VARI( ::String,userAgent) = request->userAgent;
...
HXLINE( 404)			HX_VARI(  ::openfl::events::SecurityErrorEvent,event) =  ::openfl::events::SecurityErrorEvent_obj::__alloc( HX_CTX ,HX_("securityError",e8,28,7c,a2),null(),null(),null(),null());
HXLINE( 405)			event->text = ::Std_obj::string(error);
HXLINE( 406)			this->dispatchEvent(event);
            		}
            		else {
HXLINE( 410)			HX_VARI(  ::openfl::events::IOErrorEvent,event) =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),null(),null(),null(),null());
...
HXLINE( 417)
HXLINE( 418)		HX_VARI(  ::openfl::events::ProgressEvent,event) =  ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,HX_("progress",ad,f7,2a,86),null(),null(),null(),null());

...
HXLINE(  88)			HX_VARI(  ::openfl::display::BitmapData,bitmapData) = ::openfl::utils::IAssetCache_obj::getBitmapData(::openfl::utils::Assets_obj::cache,id);
HXLINE(  90)			if (::openfl::utils::Assets_obj::isValidBitmapData(bitmapData)) {
HXLINE(  92)				return bitmapData;
            			}
            		}
HXLINE(  96)		HX_VARI(  ::lime::graphics::Image,image) = ::lime::utils::Assets_obj::getImage(id,false);
HXLINE(  98)		if (::hx::IsNotNull( image )) {
HXLINE( 103)			HX_VARI(  ::openfl::display::BitmapData,bitmapData) = ::openfl::display::BitmapData_obj::fromImage(image,null());
...
HXLINE( 148)		HX_VARI(  ::lime::text::Font,limeFont) = ::lime::utils::Assets_obj::getFont(id,false);
HXLINE( 150)		if (::hx::IsNotNull( limeFont )) {
HXLINE( 155)			HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Assets_obj,getLibrary,return )
 ...
 ::openfl::display::MovieClip Assets_obj::getMovieClip(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 187)
HXLINE( 189)		HX_VARI( ::String,libraryName) = id.substring(0,id.indexOf(HX_(":",3a,00,00,00),null()));
HXLINE( 190)		HX_VARI( ::String,symbolName) = id.substr((id.indexOf(HX_(":",3a,00,00,00),null()) + 1),null());
HXLINE( 191)		HX_VARI(  ::lime::utils::AssetLibrary,limeLibrary) = ::openfl::utils::Assets_obj::getLibrary(libraryName);
HXLINE( 193)		if (::hx::IsNotNull( limeLibrary )) {
HXLINE( 195)			if (::Std_obj::isOfType(limeLibrary,::hx::ClassOf< ::openfl::utils::AssetLibrary >())) {
HXLINE( 197)				HX_VARI(  ::openfl::utils::AssetLibrary,library) = ( ( ::openfl::utils::AssetLibrary)(limeLibrary) );
...
HXLINE( 258)			HX_VARI(  ::openfl::media::Sound,sound) = ::openfl::utils::IAssetCache_obj::getSound(::openfl::utils::Assets_obj::cache,id);
HXLINE( 260)			if (::openfl::utils::Assets_obj::isValidSound(sound)) {
HXLINE( 262)				return sound;
            			}
            		}
HXLINE( 266)		HX_VARI(  ::lime::media::AudioBuffer,buffer) = ::lime::utils::Assets_obj::getAudioBuffer(id,false);
HXLINE( 268)		if (::hx::IsNotNull( buffer )) {
HXLINE( 273)			HX_VARI(  ::openfl::media::Sound,sound) = ::openfl::media::Sound_obj::fromAudioBuffer(buffer);
...
HXLINE( 345)		HX_VARI( ::String,libraryName) = id.substring(0,id.indexOf(HX_(":",3a,00,00,00),null()));
HXLINE( 346)		HX_VARI( ::String,symbolName) = id.substr((id.indexOf(HX_(":",3a,00,00,00),null()) + 1),null());
HXLINE( 347)		HX_VARI(  ::lime::utils::AssetLibrary,library) = ::openfl::utils::Assets_obj::getLibrary(libraryName);
...
HXLINE( 435)				HX_VARI(  ::openfl::display::BitmapData,bitmapData) = ::openfl::display::BitmapData_obj::fromImage(image,null());
...
HXLINE( 447)				promise->error(((HX_("[Assets] Could not load Image \"",f0,0b,f7,ed) + id) + HX_("\"",22,00,00,00)));
            	...
            	HX_STACK_ARG(useCache,"useCache")
HXLINE( 411)
HXDLIN( 411)		HX_VARI( ::Array< ::Dynamic>,useCache1) = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 412)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 412)			useCache1[0] = true;
            		}
HXLINE( 415)		HX_VARI(  ::lime::app::Promise_openfl_display_BitmapData,promise) =  ::lime::app::Promise_openfl_display_BitmapData_obj::__alloc( HX_CTX );
...
HXLINE( 419)			HX_VARI(  ::openfl::display::BitmapData,bitmapData) = ::openfl::utils::IAssetCache_obj::getBitmapData(::openfl::utils::Assets_obj::cache,id);
...
HXLINE( 471)			promise->error(msg);
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 464)
HXLINE( 466)		HX_VARI(  ::lime::app::Promise_openfl_utils_ByteArray,promise) =  ::lime::app::Promise_openfl_utils_ByteArray_obj::__alloc( HX_CTX );
HXLINE( 467)		HX_VARI(  ::lime::app::Future,future) = ::lime::utils::Assets_obj::loadBytes(id);
...
HXLINE( 501)
HXLINE( 505)			HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
...
HXLINE( 514)			promise->complete(font);
            	...
            	HX_STACK_ARG(useCache,"useCache")
HXLINE( 487)
HXDLIN( 487)		HX_VARI( ::Array< ::Dynamic>,useCache1) = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 488)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 488)			useCache1[0] = true;
            		}
HXLINE( 491)		HX_VARI(  ::lime::app::Promise_openfl_text_Font,promise) =  ::lime::app::Promise_openfl_text_Font_obj::__alloc( HX_CTX );
...
HXLINE( 534)
HXLINE( 535)			HX_VARI(  ::openfl::utils::AssetLibrary,_library) = null();
...
HXLINE( 581)				HX_VARI(  ::openfl::media::Sound,sound) = ::openfl::media::Sound_obj::fromAudioBuffer(buffer);
...
HXLINE( 593)				promise->error(((HX_("[Assets] Could not load Sound \"",64,be,27,e3) + id) + HX_("\"",22,00,00,00)));
            	...
            	HX_STACK_ARG(useCache,"useCache")
HXLINE( 566)
HXDLIN( 566)		HX_VARI( ::Array< ::Dynamic>,useCache1) = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 567)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 567)			useCache1[0] = true;
            		}
HXLINE( 571)		HX_VARI(  ::lime::app::Promise_openfl_media_Sound,promise) =  ::lime::app::Promise_openfl_media_Sound_obj::__alloc( HX_CTX );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Assets_obj,loadMusic,return )
 ...
 ::lime::app::Future Assets_obj::loadMovieClip(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 616)
HXLINE( 618)		HX_VARI(  ::lime::app::Promise_openfl_display_MovieClip,promise) =  ::lime::app::Promise_openfl_display_MovieClip_obj::__alloc( HX_CTX );
HXLINE( 620)		HX_VARI( ::String,libraryName) = id.substring(0,id.indexOf(HX_(":",3a,00,00,00),null()));
HXLINE( 621)		HX_VARI( ::String,symbolName) = id.substr((id.indexOf(HX_(":",3a,00,00,00),null()) + 1),null());
HXLINE( 622)		HX_VARI(  ::lime::utils::AssetLibrary,limeLibrary) = ::openfl::utils::Assets_obj::getLibrary(libraryName);
HXLINE( 624)		if (::hx::IsNotNull( limeLibrary )) {
HXLINE( 626)			if (::Std_obj::isOfType(limeLibrary,::hx::ClassOf< ::openfl::utils::AssetLibrary >())) {
HXLINE( 628)				HX_VARI(  ::openfl::utils::AssetLibrary,library) = ( ( ::openfl::utils::AssetLibrary)(limeLibrary) );
...
HXLINE( 672)				HX_VARI(  ::openfl::media::Sound,sound) = ::openfl::media::Sound_obj::fromAudioBuffer(buffer);
...
HXLINE( 684)				promise->error(((HX_("[Assets] Could not load Sound \"",64,be,27,e3) + id) + HX_("\"",22,00,00,00)));
            	...
            	HX_STACK_ARG(useCache,"useCache")
HXLINE( 658)
HXDLIN( 658)		HX_VARI( ::Array< ::Dynamic>,useCache1) = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 659)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 659)			useCache1[0] = true;
            		}
HXLINE( 662)		HX_VARI(  ::lime::app::Promise_openfl_media_Sound,promise) =  ::lime::app::Promise_openfl_media_Sound_obj::__alloc( HX_CTX );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Assets_obj,loadSound,return )
 ...
 ::lime::app::Future Assets_obj::loadText(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 703)
HXLINE( 705)		HX_VARI(  ::lime::app::Future,future) = ::lime::utils::Assets_obj::loadText(id);
...
::hx::Class Assets_obj::resolveEnum(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 735)
HXLINE( 736)		HX_VARI( ::hx::Class,value) = ::Type_obj::resolveEnum(name);

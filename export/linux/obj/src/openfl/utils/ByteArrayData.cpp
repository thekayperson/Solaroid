...
HXLINE(1353)				return ::haxe::Unserializer_obj::run(data);
            			...
            			break;
            			case (int)12: {
HXLINE(1356)				HX_VARI( ::String,data) = this->readUTF();
...
void ByteArrayData_obj::writeDouble(Float value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE(1606)
HXLINE(1607)		HX_VARI(  cpp::Int64Struct,int64) = ::haxe::io::FPHelper_obj::doubleToI64(value);
...
HXDLIN(1686)				HX_VARI( ::String,value) = ::haxe::format::JsonPrinter_obj::print(object,replacer,space);

...
HXLINE(  92)					HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  94)					if (::StringTools_obj::startsWith(key1,prefix)) {
HXLINE(  96)						this->removeBitmapData(key1);
            					}
            				}
            			}
HXLINE( 100)			HX_VARI(  ::Dynamic,keys1) = this->font->keys();
HXLINE( 102)			{
HXLINE( 102)				HX_VARI(  ::Dynamic,key1) = keys1;
HXDLIN( 102)				while(( (bool)(key1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 102)					HX_VARI( ::String,key) = ( (::String)(key1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 104)					if (::StringTools_obj::startsWith(key,prefix)) {
HXLINE( 106)						this->removeFont(key);
            					}
            				}
            			}
HXLINE( 110)			HX_VARI(  ::Dynamic,keys2) = this->sound->keys();
HXLINE( 112)			{
HXLINE( 112)				HX_VARI(  ::Dynamic,key2) = keys2;
HXDLIN( 112)				while(( (bool)(key2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 112)					HX_VARI( ::String,key) = ( (::String)(key2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );

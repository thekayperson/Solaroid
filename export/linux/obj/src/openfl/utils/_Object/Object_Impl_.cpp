...
HXLINE(   5)
HXDLIN(   5)		HX_VARI(  ::Dynamic,this1) =  ::Dynamic(::hx::Anon_obj::Create(0));
...
HXLINE(  16)
HXLINE(  17)		HX_VARI( ::hx::Class,c) = ::Type_obj::getClass(this1);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Object_Impl__obj,isPrototypeOf,return )
 ...
 ::Dynamic Object_Impl__obj::iterator( ::Dynamic this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE(  30)
HXLINE(  31)		HX_VARI( ::Array< ::String >,fields) = ::Reflect_obj::fields(this1);

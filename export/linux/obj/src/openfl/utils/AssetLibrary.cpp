...
HXLINE(  63)
HXLINE(  65)		HX_VARI(  ::lime::utils::AssetLibrary,library) = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
...
HXLINE(  75)				HX_VARI(  ::openfl::utils::AssetLibrary,_library) =  ::openfl::utils::AssetLibrary_obj::__alloc( HX_CTX );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(AssetLibrary_obj,loadFromFile,return )
 ...
 ::lime::app::Future AssetLibrary_obj::loadFromManifest( ::lime::utils::AssetManifest manifest){
            	...
            	HX_STACK_ARG(manifest,"manifest")
HXLINE( 315)
HXLINE( 317)		HX_VARI(  ::openfl::utils::AssetLibrary,library) = ::openfl::utils::AssetLibrary_obj::fromManifest(manifest);

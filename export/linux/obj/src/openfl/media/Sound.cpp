...
HXDLIN( 483)			HX_VARI(  ::openfl::utils::ByteArrayData,copy) = this1;
...
HXDLIN( 582)			HX_VARI(  ::openfl::utils::ByteArrayData,copy) = this1;
...
HXDLIN( 682)					HX_VARI( int,samples) = _hx_int64_low(x);

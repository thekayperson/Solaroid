...
HXDLIN( 164)		HX_VARI(  ::openfl::events::RenderEvent,event5) =  ::openfl::events::RenderEvent_obj::__alloc( HX_CTX ,event,event1,event2,event3,event4,this->allowSmoothing);

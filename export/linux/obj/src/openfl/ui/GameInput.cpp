...
HXDLIN( 138)			HX_VARI(  ::openfl::ui::GameInputDevice,device1) =  ::openfl::ui::GameInputDevice_obj::__alloc( HX_CTX ,device,( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_get_device_name(gamepad->id)) )) ));
...
HXDLIN( 158)				HX_VARI(  ::openfl::ui::GameInputControl,control1) =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,device,(HX_("AXIS_",9e,28,6e,a7) + control),( (Float)(-1) ),( (Float)(1) ),null());
HXLINE( 159)				device->_hx___axis->set(axis,control1);
HXLINE( 160)				device->_hx___controls->push(control1);
            			}
HXLINE( 163)			HX_VARI(  ::openfl::ui::GameInputControl,control) = ( ( ::openfl::ui::GameInputControl)(device->_hx___axis->get(axis)) );
...
HXDLIN( 180)				HX_VARI(  ::openfl::ui::GameInputControl,control1) =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,device,(HX_("BUTTON_",2d,26,49,4a) + control),( (Float)(0) ),( (Float)(1) ),null());
HXLINE( 181)				device->_hx___button->set(button,control1);
HXLINE( 182)				device->_hx___controls->push(control1);
            			}
HXLINE( 185)			HX_VARI(  ::openfl::ui::GameInputControl,control) = ( ( ::openfl::ui::GameInputControl)(device->_hx___button->get(button)) );
...
HXDLIN( 202)				HX_VARI(  ::openfl::ui::GameInputControl,control1) =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,device,(HX_("BUTTON_",2d,26,49,4a) + control),( (Float)(0) ),( (Float)(1) ),null());
HXLINE( 203)				device->_hx___button->set(button,control1);
HXLINE( 204)				device->_hx___controls->push(control1);
            			}
HXLINE( 207)			HX_VARI(  ::openfl::ui::GameInputControl,control) = ( ( ::openfl::ui::GameInputControl)(device->_hx___button->get(button)) );

...
HXLINE(1642)					_g = (_g + 1);
HXDLIN(1642)					HX_VARI( int,i) = (_g - 1);
...
HXLINE(1668)			HX_VARI(  ::openfl::_Vector::ObjectVector,other) = ( ( ::openfl::_Vector::ObjectVector)(a) );
...
HXLINE(1698)				_g = (_g + 1);
HXDLIN(1698)				HX_VARI( int,i) = (_g - 1);

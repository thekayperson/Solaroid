...
HXLINE( 147)		HX_VARI( int,size) = (this->_hx___size >> miplevel);
HXLINE( 148)		if ((size == 0)) {
HXLINE( 148)			return;
            		}
HXLINE( 150)		HX_VARI(  ::lime::graphics::Image,image) = this->_hx___getImage(source);
...
HXLINE( 241)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 243)		HX_VARI( int,size) = (this->_hx___size >> miplevel);
HXLINE( 244)		if ((size == 0)) {
HXLINE( 244)			return;
            		}
HXLINE( 246)		HX_VARI( int,target) = this->_hx___sideToTarget(side);
...
HXLINE( 256)
HXLINE( 257)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 274)				HX_VARI( int,code) = gl->checkFramebufferStatus(gl->FRAMEBUFFER);
...
HXLINE( 290)			HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
int CubeTexture_obj::_hx___sideToTarget(int side){
            	...
            	HX_STACK_ARG(side,"side")
HXLINE( 324)
HXLINE( 325)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 352)
HXLINE( 353)			HX_VAR(  ::Dynamic,format);
HXDLIN( 353)			if (alpha) {
...
HXLINE( 357)			HX_VARI( int,target) = _gthis->_hx___sideToTarget(side);
...
HXLINE( 364)				HX_VARI( int,size) = ::Std_obj::_hx_int((( (Float)(blockLength) ) / ( (Float)(2) )));
...
HXLINE( 369)				HX_VARI(  ::openfl::display3D::textures::CubeTexture,alphaTexture) =  ::openfl::display3D::textures::CubeTexture_obj::__alloc( HX_CTX ,_gthis->_hx___context,_gthis->_hx___size,3,_gthis->_hx___optimizeForRenderToTexture,_gthis->_hx___streamingLevels);
...
HXLINE( 341)		HX_VARI(  ::openfl::display3D::_internal::ATFReader,reader) =  ::openfl::display3D::_internal::ATFReader_obj::__alloc( HX_CTX ,data,byteArrayOffset);
HXLINE( 342)		HX_VARI( bool,alpha) = reader->readHeader(this->_hx___size,this->_hx___size,true);
...
HXLINE( 348)		HX_VARI( ::Array< bool >,hasTexture) = ::Array_obj< bool >::fromData( _hx_array_data_3a151a09_12,1);
...
HXDLIN( 390)				HX_VARI(  ::lime::utils::ArrayBufferView,data) = this1;
HXLINE( 391)				{
...
HXDLIN( 390)				HX_VARI(  ::lime::utils::ArrayBufferView,data1) = this2;
HXLINE( 391)				{
...
HXDLIN( 390)				HX_VARI(  ::lime::utils::ArrayBufferView,data2) = this3;
HXLINE( 391)				{
...
HXDLIN( 390)				HX_VARI(  ::lime::utils::ArrayBufferView,data3) = this4;
HXLINE( 391)				{
...
HXDLIN( 390)				HX_VARI(  ::lime::utils::ArrayBufferView,data4) = this5;
HXLINE( 391)				{
...
HXDLIN( 390)				HX_VARI(  ::lime::utils::ArrayBufferView,data5) = this6;
HXLINE( 391)				{

...
HXLINE( 620)		HX_VARI(  ::openfl::display3D::_internal::_AGALConverter::RegisterMapEntry,entry) =  ::openfl::display3D::_internal::_AGALConverter::RegisterMapEntry_obj::__alloc( HX_CTX );

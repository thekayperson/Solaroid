...
HXLINE(  95)			HX_VARI(  cpp::Int64Struct,source1) = ::openfl::display3D::_internal::AGALConverter_obj::readUInt64(agal);
HXLINE(  96)			HX_VARI(  cpp::Int64Struct,source2) = ::openfl::display3D::_internal::AGALConverter_obj::readUInt64(agal);
...
HXLINE( 296)						map->addSR(sr2,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn(),2);
            				...
            				break;
            				case (int)24: {
HXLINE( 307)					HX_VARI(  ::openfl::display3D::_internal::_AGALConverter::RegisterUsage,existingUsage) = map->getRegisterUsage(sr2);
...
HXLINE( 342)					HX_VARI(  ::openfl::display3D::_internal::_AGALConverter::RegisterUsage,existingUsage) = map->getRegisterUsage(sr2);
...
HXLINE( 479)			HX_VARI( ::String,version) = ( (::String)(::lime::graphics::opengl::GL_obj::context->getParameter(7938)) );

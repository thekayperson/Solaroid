...
HXLINE(  36)		HX_VARI( ::Array< ::String >,segments) = value.split(HX_("<",3c,00,00,00));
...
HXLINE(  47)			HX_VARI(  ::openfl::text::_internal::TextFormatRange,range) = textFormatRanges->get(0).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
...
HXLINE(  59)			HX_VAR(  ::Dynamic,segment);
HXLINE(  61)			HX_VARI( ::Array< ::Dynamic>,formatStack) = ::Array_obj< ::Dynamic>::__new(1)->init(0,textFormat->clone());
HXLINE(  62)			HX_VARI( ::Array< ::String >,tagStack) = ::Array_obj< ::String >::__new(0);
HXLINE(  63)			HX_VAR( ::String,sub);
HXLINE(  64)			HX_VARI( bool,noLineBreak) = false;
HXLINE(  66)			{
HXLINE(  66)				int _g = 0;
HXDLIN(  66)				while((_g < segments->length)){
HXLINE(  66)					HX_VARI( ::String,segment) = segments->__get(_g);
HXDLIN(  66)					_g = (_g + 1);
HXLINE(  68)					if ((segment == HX_("",00,00,00,00))) {
HXLINE(  68)						continue;
            					}
HXLINE(  70)					HX_VARI( bool,isClosingTag) = (segment.substr(0,1) == HX_("/",2f,00,00,00));
HXLINE(  71)					HX_VARI( int,tagEndIndex) = segment.indexOf(HX_(">",3e,00,00,00),null());
HXLINE(  72)					HX_VARI( int,start) = (tagEndIndex + 1);
HXLINE(  73)					HX_VARI( int,spaceIndex) = segment.indexOf(HX_(" ",20,00,00,00),null());
...
HXDLIN(  74)					HX_VARI( ::String,tagName3) = segment.substring(tagName,tagName1);
HXLINE(  76)					HX_VAR(  ::openfl::text::TextFormat,format);
...
HXLINE( 143)									HX_VARI( ::String,sizeAttr) = ::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexSize);
HXLINE( 144)									HX_VARI(  ::Dynamic,firstChar) = sizeAttr.charCodeAt(0);
...
HXLINE( 148)										HX_VAR(  ::openfl::text::TextFormat,parentFormat);
...
HXLINE( 126)									HX_VARI( ::String,align) = ::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexAlign).toLowerCase();
...
HXLINE( 194)									HX_VARI( ::Array< ::String >,values) = ::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexTabStops).split(HX_(" ",20,00,00,00));
HXLINE( 195)									HX_VARI( ::Array< ::Dynamic>,tabStops) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 197)									{
HXLINE( 197)										int _g = 0;
HXDLIN( 197)										while((_g < values->length)){
HXLINE( 197)											HX_VARI( ::String,stop) = values->__get(_g);
HXDLIN( 197)											_g = (_g + 1);

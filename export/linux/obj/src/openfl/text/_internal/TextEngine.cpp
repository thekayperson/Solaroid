...
HXLINE( 152)
HXLINE( 153)		HX_VARI(  ::EReg,declinedRange) =  ::EReg_obj::__alloc( HX_CTX ,HX_("\\^(.-.|.)",ee,f5,da,ba),HX_("gu",2e,5a,00,00));
HXLINE( 154)		HX_VARI( ::Array< ::String >,declined) = ::Array_obj< ::String >::fromData( _hx_array_data_7e808804_3,1);
HXLINE( 156)		HX_VARI( ::String,accepted) = declinedRange->map(restrict, ::Dynamic(new _hx_Closure_0(declined)));
HXLINE( 162)		HX_VARI( ::Array< ::String >,testRegexpParts) = ::Array_obj< ::String >::__new(0);
...
HXLINE( 245)		HX_VARI( Float,x) = this->width;
HXDLIN( 245)		HX_VARI( Float,y) = this->width;
HXLINE( 247)		{
HXLINE( 247)			HX_VARI(  ::Dynamic,group) = this->layoutGroups->iterator();
HXDLIN( 247)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 247)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group1) = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 574)		HX_VARI( int,index) = -1;
HXLINE( 576)		HX_VARI( int,cr) = -1;
HXDLIN( 576)		HX_VARI( int,lf) = -1;
...
HXLINE( 591)
HXLINE( 592)		{
HXLINE( 592)			HX_VARI(  ::Dynamic,lineBreak) = this->lineBreaks->iterator();
HXDLIN( 592)			while(( (bool)(lineBreak->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 592)				HX_VARI( int,lineBreak1) = ( (int)(lineBreak->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 608)		HX_VARI( Float,currentLineAscent) = ((Float)0.0);
HXLINE( 609)		HX_VARI( Float,currentLineDescent) = ((Float)0.0);
HXLINE( 610)		HX_VARI(  ::Dynamic,currentLineLeading) = null();
HXLINE( 611)		HX_VARI( Float,currentLineHeight) = ((Float)0.0);
HXLINE( 612)		HX_VARI( Float,currentLineWidth) = ((Float)0.0);
HXLINE( 613)		HX_VARI( Float,currentTextHeight) = ((Float)0.0);
...
HXLINE( 620)		{
HXLINE( 620)			HX_VARI(  ::Dynamic,group) = this->layoutGroups->iterator();
HXDLIN( 620)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 620)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group1) = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 669)			HX_VARI(  ::openfl::text::TextFormat,currentFormat) = this->textField->_hx___textFormat;
HXLINE( 670)			HX_VAR( Float,ascent);
HXDLIN( 670)			HX_VAR( Float,descent);
HXLINE( 672)			HX_VARI(  ::openfl::text::Font,font) = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
...
HXLINE( 670)			HX_VARI(  ::Dynamic,leading) = currentFormat->leading;
HXDLIN( 670)			HX_VARI( Float,heightValue) = ((ascent + descent) + leading);
...
HXDLIN( 723)			HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group) = ( ( ::openfl::_Vector::ObjectVector)(this1) )->get((this->layoutGroups->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXLINE( 766)		HX_VARI( int,rangeIndex) = -1;
HXLINE( 767)		HX_VARI(  ::openfl::text::_internal::TextFormatRange,formatRange) = null();
HXLINE( 768)		HX_VARI(  ::lime::text::Font,font) = null();
HXLINE( 770)		HX_VARI(  ::openfl::text::TextFormat,currentFormat) = ::openfl::text::TextField_obj::_hx___defaultTextFormat->clone();
HXLINE( 773)		HX_VARI( int,leading) = 0;
HXLINE( 774)		HX_VARI( Float,ascent) = ((Float)0.0);
HXDLIN( 774)		HX_VARI( Float,maxAscent) = ((Float)0.0);
HXLINE( 775)		HX_VARI( Float,descent) = ((Float)0.0);
HXLINE( 778)		HX_VARI(  ::Dynamic,align) = 3;
HXLINE( 779)		HX_VARI( int,blockIndent) = 0;
HXLINE( 780)		HX_VARI( bool,bullet) = false;
HXLINE( 781)		HX_VARI( int,indent) = 0;
HXLINE( 782)		HX_VARI( int,leftMargin) = 0;
HXLINE( 783)		HX_VARI( int,rightMargin) = 0;
HXLINE( 784)		HX_VARI( bool,firstLineOfParagraph) = true;
HXLINE( 786)		HX_VARI(  ::Dynamic,tabStops) = null();
HXLINE( 788)		HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,layoutGroup) = null();
HXDLIN( 788)		HX_VARI( ::Array< ::Dynamic>,positions) = null();
HXLINE( 789)		HX_VARI( Float,widthValue) = ((Float)0.0);
HXDLIN( 789)		HX_VARI( int,heightValue) = 0;
HXDLIN( 789)		HX_VARI( int,maxHeightValue) = 0;
HXLINE( 790)		HX_VARI( int,previousSpaceIndex) = -2;
HXLINE( 791)		HX_VARI( int,previousBreakIndex) = -1;
HXLINE( 792)		HX_VARI( int,spaceIndex) = this->text.indexOf(HX_(" ",20,00,00,00),null());
HXLINE( 793)		HX_VARI( int,breakCount) = 0;
HXLINE( 794)		HX_VAR( int,breakIndex);
...
HXLINE( 796)		HX_VARI( Float,offsetX) = ((Float)0.0);
HXLINE( 797)		HX_VARI( Float,offsetY) = ((Float)0.0);
HXLINE( 798)		HX_VARI( int,textIndex) = 0;
HXLINE( 799)		HX_VARI( int,lineIndex) = 0;
...
HXLINE(1316)		HX_VAR( bool,wrap);
HXLINE(1317)		HX_VARI( int,maxLoops) = (this->text.length + 1);
...
HXLINE(1376)						HX_VARI( int,endIndex) = -1;
...
HXLINE(1406)								HX_VARI( Float,spaceWidth) = positions->shift().StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
...
HXLINE(1416)								HX_VARI( Float,spaceWidth) = positions->pop().StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
...
HXLINE(1432)									HX_VARI(  ::openfl::text::_internal::GlyphPosition,lastPosition) = positions->__get((positions->length - 1)).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXLINE(1433)									HX_VARI( Float,spaceWidth) = lastPosition->advance->x;
...
HXLINE(1447)								HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,previous) = layoutGroup;
...
HXLINE(1458)							HX_VARI( int,i) = (this->layoutGroups->get_length() - 1);
HXLINE(1459)							HX_VARI( int,offsetCount) = 0;
...
HXDLIN(1486)								HX_VARI( Float,bumpX) = ( ( ::openfl::_Vector::ObjectVector)(this1) )->get((this->layoutGroups->get_length() - offsetCount)).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >()->offsetX;
HXLINE(1488)								{
...
HXLINE(1488)										_g = (_g + 1);
HXDLIN(1488)										HX_VARI( int,i) = (_g - 1);
...
HXLINE(1525)									HX_VAR( int,tempRangeEnd);
...
HXLINE(1563)						HX_VARI( int,nextSpaceIndex) = this->text.indexOf(HX_(" ",20,00,00,00),textIndex);
...
void TextEngine_obj::setTextAlignment(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1653)
HXLINE(1654)		HX_VARI( int,lineIndex) = -1;
HXLINE(1655)		HX_VARI( Float,offsetX) = ((Float)0.0);
HXLINE(1656)		HX_VARI( Float,totalWidth) = (this->width - ( (Float)(4) ));
HXLINE(1657)		HX_VAR(  ::openfl::text::_internal::TextLayoutGroup,group);
HXDLIN(1657)		HX_VAR( int,lineLength);
HXLINE(1658)		HX_VARI( bool,lineMeasurementsDirty) = false;
HXLINE(1660)		{
HXLINE(1660)			int _g = 0;
HXDLIN(1660)			int _g1 = this->layoutGroups->get_length();
HXDLIN(1660)			while((_g < _g1)){
HXLINE(1660)				_g = (_g + 1);
HXDLIN(1660)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(1696)									_g = (_g + 1);
HXDLIN(1696)									HX_VARI( int,j) = (_g - 1);
...
HXLINE(1715)								HX_VARI(  ::Dynamic,endChar) = this->text.charCodeAt(group->endIndex);
...
HXLINE(1814)			HX_VARI( int,ret) = this->lineHeights->get_length();
HXLINE(1816)			HX_VAR( Float,tempHeight);
...
HXLINE(1818)					_g = (_g + 1);
HXDLIN(1818)					HX_VARI( int,i) = (_g - 1);
...
HXLINE(1845)			HX_VARI( int,i) = (this->numLines - 1);
HXDLIN(1845)			HX_VARI( Float,tempHeight) = ((Float)0.0);
HXLINE(1846)			HX_VARI( int,j) = i;
...
HXLINE(1895)		HX_VARI( int,max) = this->get_maxScrollV();
...
HXLINE( 182)				HX_VARI(  ::openfl::text::Font,registeredFont) = _g1->__get(_g).StaticCast<  ::openfl::text::Font >();
HXDLIN( 182)				_g = (_g + 1);
...
HXLINE( 201)		HX_VARI(  ::openfl::text::Font,font) = ::openfl::text::Font_obj::fromFile(name);
...
HXLINE( 214)
HXLINE( 215)		HX_VARI( ::String,fontName) = format->font;
HXLINE( 216)		HX_VARI(  ::Dynamic,bold) = format->bold;
HXLINE( 217)		HX_VARI(  ::Dynamic,italic) = format->italic;
HXLINE( 219)		if (::hx::IsNull( fontName )) {
HXLINE( 219)			fontName = HX_("_serif",be,66,15,76);
            		}
HXLINE( 220)		HX_VARI( ::String,fontNamePrefix) = ::StringTools_obj::replace(::StringTools_obj::replace(fontName,HX_(" Normal",67,be,ac,97),HX_("",00,00,00,00)),HX_(" Regular",1c,be,27,76),HX_("",00,00,00,00));
...
Float TextEngine_obj::getFormatHeight( ::openfl::text::TextFormat format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 264)
HXLINE( 265)		HX_VAR( Float,ascent);
HXDLIN( 265)		HX_VAR( Float,descent);
HXLINE( 271)		HX_VARI(  ::openfl::text::Font,font) = ::openfl::text::_internal::TextEngine_obj::getFontInstance(format);
...
HXLINE( 265)		HX_VARI( int,leading) = ( (int)(format->leading) );
...
::String TextEngine_obj::getFont( ::openfl::text::TextFormat format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 300)
HXLINE( 301)		HX_VARI( ::String,fontName) = format->font;
HXLINE( 302)		HX_VARI(  ::Dynamic,bold) = format->bold;
HXLINE( 303)		HX_VARI(  ::Dynamic,italic) = format->italic;
HXLINE( 305)		if (::hx::IsNull( fontName )) {
HXLINE( 305)			fontName = HX_("_serif",be,66,15,76);
            		}
HXLINE( 306)		HX_VARI( ::String,fontNamePrefix) = ::StringTools_obj::replace(::StringTools_obj::replace(fontName,HX_(" Normal",67,be,ac,97),HX_("",00,00,00,00)),HX_(" Regular",1c,be,27,76),HX_("",00,00,00,00));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(TextEngine_obj,getFont,return )
 ...
 ::openfl::text::Font TextEngine_obj::getFontInstance( ::openfl::text::TextFormat format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 357)
HXLINE( 361)		HX_VARI(  ::openfl::text::Font,instance) = null();
HXLINE( 362)		HX_VARI( ::Array< ::String >,fontList) = null();
...
HXLINE( 374)			HX_VARI( ::String,systemFontDirectory) = ::lime::_hx_system::System_obj::get_fontsDirectory();
...
HXLINE( 476)					HX_VARI( ::String,font) = fontList->__get(_g);
HXDLIN( 476)					_g = (_g + 1);
...
HXLINE( 492)		HX_VARI( ::String,systemFontDirectory) = ::lime::_hx_system::System_obj::get_fontsDirectory();
...
HXLINE( 536)				HX_VARI( ::String,font) = fontList->__get(_g);
HXDLIN( 536)				_g = (_g + 1);

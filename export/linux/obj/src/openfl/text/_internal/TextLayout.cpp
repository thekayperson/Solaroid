...
HXLINE( 155)			HX_VARI( ::Array< ::Dynamic>,_info) = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphInfo(this->_hx___hbBuffer);
HXLINE( 156)			HX_VARI( ::Array< ::Dynamic>,_positions) = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphPositions(this->_hx___hbBuffer);
...
HXLINE( 160)				HX_VAR(  ::lime::text::harfbuzz::HBGlyphInfo,info);
HXDLIN( 160)				HX_VAR(  ::lime::text::harfbuzz::HBGlyphPosition,position);
HXLINE( 161)				HX_VARI( int,lastCluster) = -1;
HXLINE( 163)				HX_VARI( int,length) = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(_info->length) ),( (Float)(_positions->length) )));
HXLINE( 165)				{
HXLINE( 165)					int _g = 0;
...
HXDLIN( 170)								HX_VARI( int,j) = (_g1 - 1);
...
::Array< int > TextLayout_obj::get_glyphs(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 225)
HXLINE( 226)		HX_VARI( ::Array< int >,glyphs) = ::Array_obj< int >::__new(0);
HXLINE( 228)		{
HXLINE( 228)			int _g = 0;
HXDLIN( 228)			::Array< ::Dynamic> _g1 = this->get_positions();
HXDLIN( 228)			while((_g < _g1->length)){
HXLINE( 228)				HX_VARI(  ::openfl::text::_internal::GlyphPosition,position) = _g1->__get(_g).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN( 228)				_g = (_g + 1);

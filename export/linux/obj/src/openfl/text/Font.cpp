...
HXLINE(  91)
HXLINE(  92)		HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
...
HXLINE( 112)
HXLINE( 113)		HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
...
HXLINE( 150)
HXLINE( 151)			HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
 ...
 ::lime::app::Future Font_obj::loadFromFile(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::text::Font limeFont){
            			...
            			HX_STACK_ARG(limeFont,"limeFont")
HXLINE( 174)
HXLINE( 175)			HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
 ...
 ::lime::app::Future Font_obj::loadFromName(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::text::Font limeFont){
            			...
            			HX_STACK_ARG(limeFont,"limeFont")
HXLINE( 200)
HXLINE( 201)			HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
...
void Font_obj::registerFont( ::Dynamic font){
            	...
            	HX_STACK_ARG(font,"font")
HXLINE( 216)
HXLINE( 217)		HX_VARI(  ::openfl::text::Font,instance) = null();

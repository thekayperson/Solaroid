...
HXLINE( 887)		HX_VARI(  ::openfl::geom::Rectangle,rect) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
...
HXLINE( 917)				_g = (_g + 1);
HXDLIN( 917)				HX_VARI( int,i) = (_g - 1);
HXLINE( 919)				y = (y + this->_hx___textEngine->lineHeights->get(i));
            			}
            		}
HXLINE( 922)		{
HXLINE( 922)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN( 922)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 922)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group1) = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 928)						HX_VARI( Float,advance) = ((Float)0.0);
HXLINE( 930)						{
HXLINE( 930)							int _g = 0;
HXDLIN( 930)							int _g1 = group1->positions->length;
HXDLIN( 930)							while((_g < _g1)){
HXLINE( 930)								_g = (_g + 1);
HXDLIN( 930)								HX_VARI( int,i) = (_g - 1);
...
HXLINE(1012)				_g = (_g + 1);
HXDLIN(1012)				HX_VARI( int,i) = (_g - 1);
HXLINE(1014)				y = (y + this->_hx___textEngine->lineHeights->get(i));
            			}
            		}
HXLINE(1017)		{
HXLINE(1017)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1017)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1017)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group1) = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1044)		{
HXLINE(1044)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1044)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1044)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group1) = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1068)		HX_VARI( int,startIndex) = -1;
HXLINE(1069)		HX_VARI( int,endIndex) = -1;
HXLINE(1071)		{
HXLINE(1071)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1071)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1071)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group1) = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1099)		HX_VARI( Float,ascender) = this->_hx___textEngine->lineAscents->get(lineIndex);
HXLINE(1100)		HX_VARI( Float,descender) = this->_hx___textEngine->lineDescents->get(lineIndex);
HXLINE(1101)		HX_VARI( Float,leading) = this->_hx___textEngine->lineLeadings->get(lineIndex);
HXLINE(1102)		HX_VARI( Float,lineHeight) = this->_hx___textEngine->lineHeights->get(lineIndex);
HXLINE(1103)		HX_VARI( Float,lineWidth) = this->_hx___textEngine->lineWidths->get(lineIndex);
HXLINE(1107)		HX_VAR( Float,margin);
...
HXLINE(1132)		{
HXLINE(1132)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1132)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1132)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group1) = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1158)		HX_VARI( int,startIndex) = -1;
HXLINE(1159)		HX_VARI( int,endIndex) = -1;
HXLINE(1161)		{
HXLINE(1161)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1161)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1161)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group1) = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1195)		HX_VARI( int,startIndex) = this->getFirstCharInParagraph(charIndex);
HXLINE(1197)		if ((charIndex >= this->get_text().length)) {
HXLINE(1197)			return ((this->get_text().length - startIndex) + 1);
            		}
HXLINE(1199)		HX_VARI( int,endIndex) = (this->_hx___textEngine->getLineBreakIndex(charIndex) + 1);
...
HXLINE(1231)
HXLINE(1232)		HX_VARI(  ::openfl::text::TextFormat,format) = null();
...
HXLINE(1242)		{
HXLINE(1242)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->textFormatRanges->iterator();
HXDLIN(1242)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1242)				HX_VARI(  ::openfl::text::_internal::TextFormatRange,group1) = ( ( ::openfl::text::_internal::TextFormatRange)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
void TextField_obj::setTextFormat( ::openfl::text::TextFormat format,::hx::Null< int >  __o_beginIndex,::hx::Null< int >  __o_endIndex){
            	...
            	HX_STACK_ARG(endIndex,"endIndex")
HXLINE(1423)
HXLINE(1424)		HX_VARI( int,max) = this->get_text().length;
HXLINE(1425)		HX_VAR(  ::openfl::text::_internal::TextFormatRange,range);
...
HXLINE(1468)			HX_VARI( int,index) = 0;
HXLINE(1469)			HX_VAR(  ::openfl::text::_internal::TextFormatRange,newRange);
...
void TextField_obj::_hx___caretBeginningOfNextLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1605)
HXLINE(1606)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
void TextField_obj::_hx___caretBeginningOfPreviousLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1619)
HXLINE(1620)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
HXLINE(1622)		if ((lineIndex > 0)) {
HXLINE(1624)			HX_VARI( int,index) = this->getLineOffset(this->getLineIndexOfChar(this->_hx___caretIndex));
...
void TextField_obj::_hx___caretEndOfLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1638)
HXLINE(1639)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
void TextField_obj::_hx___caretNextLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1660)
HXLINE(1661)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
HXLINE(1706)			HX_VARI(  ::openfl::events::MouseEvent,event1) = ( ( ::openfl::events::MouseEvent)(event) );
HXLINE(1707)			Float group = this->get_mouseX();
HXDLIN(1707)			HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group1) = this->_hx___getGroup(group,this->get_mouseY(),true);
HXLINE(1709)			if (::hx::IsNotNull( group1 )) {
HXLINE(1711)				HX_VARI( ::String,url) = group1->format->url;
...
HXLINE(1767)		HX_VARI(  ::openfl::geom::Rectangle,bounds) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE(1786)		{
HXLINE(1786)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1786)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1786)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group1) = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXDLIN(1800)						HX_VAR( Float,lastPosition);
...
HXLINE(1817)		HX_VARI(  ::Dynamic,x) = null();
HXDLIN(1817)		HX_VARI(  ::Dynamic,y) = null();
HXLINE(1819)		{
HXLINE(1819)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1819)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1819)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group1) = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1825)							_g = (_g + 1);
HXDLIN(1825)							HX_VARI( int,i) = (_g - 1);
...
HXLINE(1837)							_g = (_g + 1);
HXDLIN(1837)							HX_VARI( int,i) = (_g - 1);
...
HXDLIN(1851)		HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group1) = this->_hx___getGroup(group,this->get_mouseY(),true);
...
HXLINE(1871)				_g = (_g + 1);
HXDLIN(1871)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(1878)		HX_VARI( bool,firstGroup) = true;
HXLINE(1879)		HX_VAR(  ::openfl::text::_internal::TextLayoutGroup,group);
HXDLIN(1879)		HX_VAR(  ::openfl::text::_internal::TextLayoutGroup,nextGroup);
HXLINE(1881)		{
...
HXDLIN(1881)				HX_VARI( int,i) = (_g2 - 1);
...
int TextField_obj::_hx___getPosition(Float x,Float y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE(1915)
HXLINE(1916)		HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group) = this->_hx___getGroup(x,y,null());
HXLINE(1918)		if (::hx::IsNull( group )) {
HXLINE(1920)			return this->_hx___text.length;
            		}
HXLINE(1923)		HX_VARI( Float,advance) = ((Float)0.0);
HXLINE(1925)		{
HXLINE(1925)			int _g = 0;
HXDLIN(1925)			int _g1 = group->positions->length;
HXDLIN(1925)			while((_g < _g1)){
HXLINE(1925)				_g = (_g + 1);
HXDLIN(1925)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(1991)		HX_VAR( int,startIndex);
...
HXLINE(1992)		HX_VAR( int,endIndex);
...
HXLINE(2000)			HX_VARI( int,cache) = endIndex;
...
HXLINE(2019)				HX_VARI( int,removeLength) = (endIndex - beginIndex);
HXLINE(2020)				HX_VARI( int,maxLength) = ((this->_hx___textEngine->maxChars - this->_hx___text.length) + removeLength);
...
HXLINE(2035)		HX_VARI( int,offset) = (newText.length - (endIndex - beginIndex));
HXLINE(2037)		HX_VARI( int,i) = 0;
HXLINE(2038)		HX_VAR(  ::openfl::text::_internal::TextFormatRange,range);
...
HXLINE(2158)		HX_VARI( bool,enableInput) = true;
...
void TextField_obj::_hx___stopTextInput(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2183)
HXLINE(2184)		HX_VARI( bool,disableInput) = true;
...
HXLINE(2196)			HX_VARI( Float,cacheWidth) = this->_hx___textEngine->width;
...
HXLINE(2234)		HX_VARI( int,tempScrollH) = this->get_scrollH();
...
HXLINE(2245)			HX_VARI(  ::openfl::geom::Rectangle,caret) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(2246)			HX_VARI( bool,written) = false;
...
HXLINE(2275)			HX_VARI( int,lineLength) = this->getLineLength(this->getLineIndexOfChar(this->_hx___caretIndex));
...
HXLINE(2308)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
HXLINE(2322)				HX_VARI( int,i) = lineIndex;
HXDLIN(2322)				HX_VARI( Float,tempHeight) = ((Float)0.0);
...
HXLINE(2397)			HX_VARI( int,length) = this->get_text().length;
HXLINE(2398)			HX_VARI( ::String,mask) = HX_("",00,00,00,00);
HXLINE(2400)			{
...
HXLINE(2891)		HX_VARI( ::String,utfValue) = value;
HXLINE(2892)		HX_VARI(  ::openfl::text::_internal::TextFormatRange,range) = this->_hx___textEngine->textFormatRanges->get(0).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
...
HXLINE(2918)		{
HXLINE(2918)			HX_VARI(  ::Dynamic,range) = this->_hx___textEngine->textFormatRanges->iterator();
HXDLIN(2918)			while(( (bool)(range->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(2918)				HX_VARI(  ::openfl::text::_internal::TextFormatRange,range1) = ( ( ::openfl::text::_internal::TextFormatRange)(range->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXDLIN(3039)			HX_VARI( int,position2) = this->_hx___getPosition(position1,this->get_mouseY());
HXLINE(3041)			if ((position2 != this->_hx___caretIndex)) {
HXLINE(3043)				this->_hx___caretIndex = position2;
HXLINE(3045)				HX_VARI( bool,setDirty) = true;
...
HXDLIN(3080)			HX_VARI( int,upPos2) = this->_hx___getPosition(upPos1,this->get_mouseY());
HXLINE(3081)			HX_VARI( int,leftPos) = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(this->_hx___selectionIndex) ),( (Float)(upPos2) )));
HXLINE(3082)			HX_VARI( int,rightPos) = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(this->_hx___selectionIndex) ),( (Float)(upPos2) )));
...
HXLINE(3206)			HX_VARI( ::Array< ::String >,delimiters) = ::Array_obj< ::String >::fromData( _hx_array_data_efd5a8ca_154,13);
HXLINE(3208)			HX_VARI( ::String,txtStr) = this->_hx___text;
HXLINE(3209)			HX_VARI( int,leftPos) = -1;
HXLINE(3210)			HX_VARI( int,rightPos) = txtStr.length;
HXLINE(3211)			HX_VARI( int,pos) = 0;
HXLINE(3212)			HX_VARI( int,startPos) = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(this->_hx___caretIndex) ),( (Float)(1) )));
...
HXLINE(3215)						HX_VARI( ::String,c) = delimiters->__get(_g);
HXDLIN(3215)						_g = (_g + 1);
...
HXLINE(3228)					HX_VARI( bool,setDirty) = true;
...
HXLINE(3446)						HX_VARI(  ::openfl::events::TextEvent,te) =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,::lime::_hx_system::Clipboard_obj::get_text());
...
HXLINE(3257)					HX_VARI(  ::openfl::events::TextEvent,te) =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,HX_("\n",0a,00,00,00));

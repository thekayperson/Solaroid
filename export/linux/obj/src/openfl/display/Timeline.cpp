...
HXLINE(  50)		HX_VARI( int,frame) = (index + 1);
...
HXLINE(  79)					HX_VARI(  ::openfl::display::Scene,scene) = _g1->__get(_g).StaticCast<  ::openfl::display::Scene >();
HXDLIN(  79)					_g = (_g + 1);
...
HXLINE(  96)					HX_VARI(  ::openfl::display::FrameScript,script) = _g1->__get(_g).StaticCast<  ::openfl::display::FrameScript >();
HXDLIN(  96)					_g = (_g + 1);
...
HXLINE( 110)			HX_VARI( int,nextFrame) = this->_hx___getNextFrame(deltaTime);
...
HXLINE( 147)				_g = (_g + 1);
HXDLIN( 147)				HX_VARI( int,frame) = (_g - 1);
...
HXLINE( 157)					HX_VARI(  ::Dynamic,script) = this->_hx___frameScripts->get(frame);
...
int Timeline_obj::_hx___getNextFrame(int deltaTime){
            	...
            	HX_STACK_ARG(deltaTime,"deltaTime")
HXLINE( 176)
HXLINE( 177)		HX_VARI( int,nextFrame) = 0;
...
HXLINE( 268)				HX_VARI( ::String,label) = ( (::String)(frame) );
HXLINE( 270)				{
HXLINE( 270)					int _g = 0;
HXDLIN( 270)					::Array< ::Dynamic> _g1 = this->_hx___currentLabels;
HXDLIN( 270)					while((_g < _g1->length)){
HXLINE( 270)						HX_VARI(  ::openfl::display::FrameLabel,frameLabel) = _g1->__get(_g).StaticCast<  ::openfl::display::FrameLabel >();
HXDLIN( 270)						_g = (_g + 1);
...
HXLINE( 293)				HX_VARI(  ::openfl::display::FrameLabel,label) = _g1->__get(_g).StaticCast<  ::openfl::display::FrameLabel >();
HXDLIN( 293)				_g = (_g + 1);

...
HXLINE(1147)			HX_VARI( ::Array< ::Dynamic>,dispatchers) = ( (::Array< ::Dynamic>)(::openfl::display::DisplayObject_obj::_hx___broadcastEvents->get(event->type)) );
HXLINE(1149)			{
HXLINE(1149)				int _g = 0;
HXDLIN(1149)				while((_g < dispatchers->length)){
HXLINE(1149)					HX_VARI(  ::openfl::display::DisplayObject,dispatcher) = dispatchers->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(1149)					_g = (_g + 1);
...
void Stage_obj::_hx___createRenderer(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1174)
HXLINE(1186)		HX_VARI( int,windowWidth) = ::Std_obj::_hx_int((( (Float)(this->window->_hx___width) ) * this->window->_hx___scale));
HXLINE(1187)		HX_VARI( int,windowHeight) = ::Std_obj::_hx_int((( (Float)(this->window->_hx___height) ) * this->window->_hx___scale));
...
HXLINE(1261)
HXLINE(1267)		HX_VAR(  ::openfl::display::DisplayObject,target);
HXLINE(1268)		HX_VARI( int,length) = stack->length;
...
HXLINE(1281)					_g = (_g + 1);
HXDLIN(1281)					HX_VARI( int,i) = (_g - 1);
...
HXLINE(1303)				HX_VARI( int,i) = (length - 2);
...
HXLINE(1347)
HXLINE(1348)		HX_VARI(  ::openfl::display::DisplayObjectContainer,parent) = this->_hx___dragObject->parent;
...
HXLINE(1354)		HX_VARI( Float,x) = (mouse->x + this->_hx___dragOffsetX);
HXLINE(1355)		HX_VARI( Float,y) = (mouse->y + this->_hx___dragOffsetY);
...
void Stage_obj::_hx___handleError( ::Dynamic e){
            	...
            	HX_STACK_ARG(e,"e")
HXLINE(1404)
HXLINE(1405)		HX_VARI(  ::openfl::events::UncaughtErrorEvent,event) =  ::openfl::events::UncaughtErrorEvent_obj::__alloc( HX_CTX ,HX_("uncaughtError",f3,98,8b,8b),true,true,e);
HXLINE(1407)		try {
...
HXLINE(1466)		HX_VARI( ::Array< ::Dynamic>,stack) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE(1479)			HX_VAR( int,keyLocation);
...
HXLINE(1480)			HX_VAR( int,keyCode1);
...
HXLINE(1481)			HX_VARI( int,charCode) = ::openfl::ui::Keyboard_obj::_hx___getCharCode(keyCode1,::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier));
...
HXLINE(1485)				HX_VARI(  ::openfl::display::Sprite,sprite) = ::hx::TCast<  ::openfl::display::Sprite >::cast(this->_hx___focus);
...
HXLINE(1488)					HX_VARI(  ::openfl::geom::Point,localPoint) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
HXLINE(1489)					HX_VARI(  ::openfl::geom::Point,targetPoint) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
...
HXDLIN(1496)					HX_VARI(  ::openfl::events::MouseEvent,clickEvent2) = ::openfl::events::MouseEvent_obj::_hx___create(HX_("click",48,7c,5e,48),0,clickEvent,clickEvent1,sprite->_hx___globalToLocal(targetPoint,localPoint),sprite,null());
...
HXLINE(1512)			HX_VARI(  ::openfl::events::KeyboardEvent,event4) =  ::openfl::events::KeyboardEvent_obj::__alloc( HX_CTX ,type,true,true,charCode,keyCode1,keyLocation,event,event1,event2,event3,::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier));
...
HXLINE(1534)					HX_VARI( ::Array< ::Dynamic>,tabStack) = ::Array_obj< ::Dynamic>::__new();
HXLINE(1536)					this->_hx___tabTest(tabStack);
HXLINE(1538)					HX_VARI( int,nextIndex) = -1;
HXLINE(1539)					HX_VARI(  ::openfl::display::InteractiveObject,nextObject) = null();
HXLINE(1540)					HX_VAR( int,nextOffset);
...
HXLINE(1568)							HX_VARI(  ::openfl::display::InteractiveObject,current) = this->get_focus();
HXLINE(1569)							HX_VARI( int,index) = tabStack->indexOf(current,null());
...
HXLINE(1575)								HX_VARI(  ::openfl::display::DisplayObjectContainer,currentParent) = current->parent;
...
HXLINE(1578)									HX_VARI( int,currentIndex) = currentParent->getChildIndex(current);
HXLINE(1579)									if ((currentIndex == -1)) {
HXLINE(1581)										current = currentParent;
HXLINE(1582)										continue;
            									}
HXLINE(1584)									HX_VARI( int,i) = (currentIndex + nextOffset);
...
HXLINE(1587)										HX_VARI(  ::openfl::display::DisplayObject,sibling) = currentParent->getChildAt(i);
HXLINE(1588)										if (::Std_obj::isOfType(sibling,::hx::ClassOf< ::openfl::display::InteractiveObject >())) {
HXLINE(1590)											HX_VARI(  ::openfl::display::InteractiveObject,interactiveSibling) = ::hx::TCast<  ::openfl::display::InteractiveObject >::cast(sibling);
...
HXLINE(1625)					HX_VAR( bool,cancelTab);
...
HXLINE(1648)					HX_VARI(  ::openfl::events::FocusEvent,focusEvent) = null();
...
HXLINE(1826)			HX_VARI(  ::openfl::events::Event,event) = null();
...
HXLINE(1848)		HX_VAR( ::String,type);
...
HXLINE(1887)		HX_VAR( ::String,type);
...
HXLINE(1931)		HX_VARI(  ::openfl::events::Event,event) = null();
...
HXLINE(1959)		HX_VAR( bool,shouldRender);
...
HXLINE(1990)				{
HXLINE(1990)					HX_VARI(  ::Dynamic,stage3D) = this->stage3Ds->iterator();
HXDLIN(1990)					while(( (bool)(stage3D->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1990)						HX_VARI(  ::openfl::display::Stage3D,stage3D1) = ( ( ::openfl::display::Stage3D)(stage3D->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(2056)		{
HXLINE(2056)			HX_VARI(  ::Dynamic,stage3D) = this->stage3Ds->iterator();
HXDLIN(2056)			while(( (bool)(stage3D->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(2056)				HX_VARI(  ::openfl::display::Stage3D,stage3D1) = ( ( ::openfl::display::Stage3D)(stage3D->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(2066)		{
HXLINE(2066)			HX_VARI(  ::Dynamic,stage3D) = this->stage3Ds->iterator();
HXDLIN(2066)			while(( (bool)(stage3D->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(2066)				HX_VARI(  ::openfl::display::Stage3D,stage3D1) = ( ( ::openfl::display::Stage3D)(stage3D->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(2081)		HX_VARI( ::Array< ::Dynamic>,stack) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE(2092)		HX_VARI(  ::openfl::events::TextEvent,event) =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,text);
...
HXLINE(2110)
HXLINE(2112)		HX_VARI( bool,isPrimaryTouchPoint) = ::hx::IsInstanceEq( this->_hx___primaryTouch,touch );
...
void Stage_obj::_hx___onLimeTouchEnd( ::lime::ui::Touch touch){
            	...
            	HX_STACK_ARG(touch,"touch")
HXLINE(2127)
HXLINE(2128)		HX_VARI( bool,isPrimaryTouchPoint) = ::hx::IsInstanceEq( this->_hx___primaryTouch,touch );
...
HXLINE(2170)		HX_VARI(  ::openfl::events::Event,event) = null();
...
HXLINE(2226)		HX_VARI(  ::openfl::events::Event,event) = null();
...
HXLINE(2251)		HX_VARI(  ::openfl::events::Event,event) = null();
...
HXLINE(2265)		HX_VARI(  ::openfl::display::InteractiveObject,currentFocus) = this->get_focus();
...
HXLINE(2295)		HX_VARI(  ::openfl::events::Event,event) = null();
...
HXLINE(2363)		HX_VARI(  ::openfl::geom::Point,targetPoint) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
...
HXLINE(2370)		HX_VARI( ::Array< ::Dynamic>,stack) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(2371)		HX_VARI(  ::openfl::display::InteractiveObject,target) = null();
...
HXLINE(2385)		HX_VARI( ::String,clickType) = null();
...
HXLINE(2394)					HX_VARI(  ::openfl::events::FocusEvent,focusEvent) =  ::openfl::events::FocusEvent_obj::__alloc( HX_CTX ,HX_("mouseFocusChange",43,f1,81,96),true,true,target,false,0);
...
HXLINE(2433)					HX_VARI(  ::openfl::events::MouseEvent,event) = null();
...
HXLINE(2459)			goto _hx_goto_92;
            		...
            		_hx_goto_92:;
HXLINE(2470)		HX_VARI(  ::openfl::geom::Point,localPoint) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
HXLINE(2471)		HX_VARI(  ::openfl::events::MouseEvent,event) = null();
...
HXLINE(2501)				HX_VARI( int,currentTime) = ::openfl::Lib_obj::getTimer();
...
HXLINE(2527)			HX_VARI( ::String,cursor) = null();
...
HXLINE(2535)					HX_VARI(  ::openfl::display::DisplayObject,target) = stack->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(2535)					_g = (_g + 1);
...
HXLINE(2553)		HX_VAR(  ::openfl::events::MouseEvent,event3);
...
HXLINE(2575)		HX_VAR(  ::openfl::display::DisplayObject,item);
HXDLIN(2575)		HX_VARI( int,i) = 0;
...
HXLINE(2603)				HX_VARI(  ::openfl::display::DisplayObject,item) = stack->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(2603)				_g = (_g + 1);
...
HXLINE(2657)			HX_VARI(  ::openfl::display::DisplayObject,dropTarget) = null();
HXLINE(2659)			if (::hx::IsInstanceEq( this->_hx___mouseOverTarget,this->_hx___dragObject )) {
HXLINE(2661)				HX_VARI( bool,cacheMouseEnabled) = this->_hx___dragObject->mouseEnabled;
HXLINE(2662)				HX_VARI( bool,cacheMouseChildren) = this->_hx___dragObject->mouseChildren;
HXLINE(2664)				this->_hx___dragObject->mouseEnabled = false;
HXLINE(2665)				this->_hx___dragObject->mouseChildren = false;
HXLINE(2667)				HX_VARI( ::Array< ::Dynamic>,stack) = ::Array_obj< ::Dynamic>::__new(0);
...
void Stage_obj::_hx___onMouseWheel(Float deltaX,Float deltaY, ::lime::ui::MouseWheelMode deltaMode){
            	...
            	HX_STACK_ARG(deltaMode,"deltaMode")
HXLINE(2691)
HXLINE(2692)		HX_VARI( Float,x) = this->_hx___mouseX;
HXLINE(2693)		HX_VARI( Float,y) = this->_hx___mouseY;
HXLINE(2695)		HX_VARI( ::Array< ::Dynamic>,stack) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(2696)		HX_VARI(  ::openfl::display::InteractiveObject,target) = null();
...
HXLINE(2709)		HX_VARI(  ::openfl::geom::Point,targetPoint) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
...
HXLINE(2712)		HX_VARI( int,delta) = ::Std_obj::_hx_int(deltaY);
HXLINE(2714)		Float event = this->_hx___mouseX;
HXDLIN(2714)		Float event1 = this->_hx___mouseY;
HXDLIN(2714)		HX_VARI(  ::openfl::events::MouseEvent,event2) = ::openfl::events::MouseEvent_obj::_hx___create(HX_("mouseWheel",36,28,87,e7),0,event,event1,target->_hx___globalToLocal(targetPoint,targetPoint),target,delta);
...
HXLINE(2725)
HXLINE(2726)		HX_VARI(  ::openfl::geom::Point,targetPoint) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
...
HXLINE(2730)		HX_VARI( Float,touchX) = targetPoint->x;
HXLINE(2731)		HX_VARI( Float,touchY) = targetPoint->y;
HXLINE(2733)		HX_VARI( ::Array< ::Dynamic>,stack) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(2734)		HX_VARI(  ::openfl::display::InteractiveObject,target) = null();
...
HXLINE(2748)		HX_VARI( int,touchId) = touch->id;
HXLINE(2749)		HX_VARI(  ::openfl::utils::_internal::TouchData,touchData) = null();
...
HXLINE(2763)		HX_VARI( ::String,touchType) = null();
HXLINE(2764)		HX_VARI( bool,releaseTouchData) = false;
...
HXLINE(2771)			goto _hx_goto_98;
            		...
            		_hx_goto_98:;
HXLINE(2783)		HX_VARI(  ::openfl::geom::Point,localPoint) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
HXLINE(2784)		HX_VARI(  ::openfl::events::TouchEvent,touchEvent) = ::openfl::events::TouchEvent_obj::_hx___create(type,null(),touchX,touchY,target->_hx___globalToLocal(targetPoint,localPoint),target);
...
HXLINE(2801)		HX_VARI(  ::openfl::display::InteractiveObject,touchOverTarget) = touchData->touchOverTarget;
...
HXLINE(2814)		HX_VARI( ::Array< ::Dynamic>,touchOutStack) = touchData->rollOutStack;
HXLINE(2815)		HX_VAR(  ::openfl::display::DisplayObject,item);
HXDLIN(2815)		HX_VARI( int,i) = 0;
...
HXLINE(2838)				HX_VARI(  ::openfl::display::DisplayObject,item) = stack->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(2838)				_g = (_g + 1);
...
HXLINE(2896)		{
HXLINE(2896)			HX_VARI(  ::Dynamic,gamepad) = ::lime::ui::Gamepad_obj::devices->iterator();
HXDLIN(2896)			while(( (bool)(gamepad->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(2896)				HX_VARI(  ::lime::ui::Gamepad,gamepad1) = ( ( ::lime::ui::Gamepad)(gamepad->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
void Stage_obj::_hx___resize(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2910)
HXLINE(2911)		HX_VARI( int,cacheWidth) = this->stageWidth;
HXLINE(2912)		HX_VARI( int,cacheHeight) = this->stageHeight;
HXLINE(2914)		HX_VARI( int,windowWidth) = ::Std_obj::_hx_int((( (Float)(this->window->_hx___width) ) * this->window->_hx___scale));
HXLINE(2915)		HX_VARI( int,windowHeight) = ::Std_obj::_hx_int((( (Float)(this->window->_hx___height) ) * this->window->_hx___scale));
...
HXLINE(2929)			HX_VARI( Float,displayScaleX) = (( (Float)(windowWidth) ) / ( (Float)(this->stageWidth) ));
HXLINE(2930)			HX_VARI( Float,displayScaleY) = (( (Float)(windowHeight) ) / ( (Float)(this->stageHeight) ));
...
HXLINE(2949)				HX_VARI( Float,scaleX) = (( (Float)(windowWidth) ) / ( (Float)(this->stageWidth) ));
HXLINE(2950)				HX_VARI( Float,scaleY) = (( (Float)(windowHeight) ) / ( (Float)(this->stageHeight) ));
HXLINE(2951)				HX_VARI( Float,targetScale) = ::Math_obj::min(scaleX,scaleY);
HXLINE(2953)				HX_VARI( int,offsetX) = ::Math_obj::round(((( (Float)(windowWidth) ) - (( (Float)(this->stageWidth) ) * targetScale)) / ( (Float)(2) )));
HXLINE(2954)				HX_VARI( int,offsetY) = ::Math_obj::round(((( (Float)(windowHeight) ) - (( (Float)(this->stageHeight) ) * targetScale)) / ( (Float)(2) )));
...
HXLINE(2968)		{
HXLINE(2968)			HX_VARI(  ::Dynamic,stage3D) = this->stage3Ds->iterator();
HXDLIN(2968)			while(( (bool)(stage3D->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(2968)				HX_VARI(  ::openfl::display::Stage3D,stage3D1) = ( ( ::openfl::display::Stage3D)(stage3D->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(2983)			HX_VARI(  ::openfl::events::Event,event) = null();
...
HXLINE(3017)			HX_VARI( Float,right) = bounds->get_right();
HXLINE(3018)			HX_VARI( Float,bottom) = bounds->get_bottom();
...
HXLINE(3036)				HX_VARI(  ::openfl::geom::Point,mouse) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
HXLINE(3037)				Float _hx_tmp = this->get_mouseX();
HXDLIN(3037)				mouse->setTo(_hx_tmp,this->get_mouseY());
HXLINE(3038)				HX_VARI(  ::openfl::display::DisplayObjectContainer,parent) = this->_hx___dragObject->parent;
...
HXLINE(3148)			HX_VARI( int,r) = ::hx::UShr((( (int)(value) ) & 16711680),16);
HXLINE(3149)			HX_VARI( int,g) = ::hx::UShr((( (int)(value) ) & 65280),8);
HXLINE(3150)			HX_VARI( int,b) = (( (int)(value) ) & 255);
...
HXLINE(3207)			HX_VARI(  ::openfl::display::InteractiveObject,oldFocus) = this->_hx___focus;
HXLINE(3208)			this->_hx___focus = value;
HXLINE(3209)			this->_hx___cacheFocus = value;
HXLINE(3211)			if (::hx::IsNotNull( oldFocus )) {
HXLINE(3213)				HX_VARI(  ::openfl::events::FocusEvent,event) =  ::openfl::events::FocusEvent_obj::__alloc( HX_CTX ,HX_("focusOut",96,6f,5e,11),true,false,value,false,0);
HXLINE(3214)				HX_VARI( ::Array< ::Dynamic>,stack) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE(3222)				HX_VARI(  ::openfl::events::FocusEvent,event) =  ::openfl::events::FocusEvent_obj::__alloc( HX_CTX ,HX_("focusIn",dd,45,83,41),true,false,oldFocus,false,0);
HXLINE(3223)				HX_VARI( ::Array< ::Dynamic>,stack) = ::Array_obj< ::Dynamic>::__new();

...
Float DisplayObject_obj::get_height(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1955)
HXLINE(1956)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(1957)		this->_hx___getLocalBounds(rect);
HXLINE(1958)		HX_VARI( Float,height) = rect->height;
...
HXLINE(1966)		HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
Float DisplayObject_obj::get_mouseX(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2038)
HXLINE(2039)		HX_VAR( Float,mouseX);
...
HXLINE(2040)		HX_VAR( Float,mouseY);
...
Float DisplayObject_obj::get_mouseY(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2046)
HXLINE(2047)		HX_VAR( Float,mouseX);
...
HXLINE(2048)		HX_VAR( Float,mouseY);
...
HXLINE(2083)			HX_VARI( Float,radians) = (this->_hx___rotation * (::Math_obj::PI / ( (Float)(180) )));
...
HXLINE(2146)				HX_VARI( Float,a) = (this->_hx___rotationCosine * value);
HXLINE(2147)				HX_VARI( Float,b) = (this->_hx___rotationSine * value);
...
HXLINE(2180)				HX_VARI( Float,c) = (-(this->_hx___rotationSine) * value);
HXLINE(2181)				HX_VARI( Float,d) = (this->_hx___rotationCosine * value);
...
Float DisplayObject_obj::get_width(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2290)
HXLINE(2291)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(2292)		this->_hx___getLocalBounds(rect);
HXLINE(2293)		HX_VARI( Float,width) = rect->width;
...
HXLINE(2301)		HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();

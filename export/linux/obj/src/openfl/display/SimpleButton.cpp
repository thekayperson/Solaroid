...
HXLINE( 187)			HX_VARI(  ::Dynamic,method) = ::openfl::display::SimpleButton_obj::_hx___constructor;
...
HXLINE( 198)		HX_VARI(  ::openfl::geom::Matrix,childWorldTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 200)		{
...
HXLINE( 219)		HX_VARI(  ::openfl::geom::Matrix,childWorldTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 221)		{
...
HXLINE( 235)
HXLINE( 236)		HX_VARI( bool,hitTest) = false;
...
bool SimpleButton_obj::_hx___hitTestMask(Float x,Float y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE( 284)
HXLINE( 285)		HX_VARI( bool,hitTest) = false;

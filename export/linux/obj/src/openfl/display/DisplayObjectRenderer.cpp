...
HXLINE( 104)
HXLINE( 105)		HX_VARI(  ::openfl::display::DisplayObjectRenderer,renderer) = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 119)				HX_VARI(  ::openfl::display::OpenGLRenderer,renderer1) = ( ( ::openfl::display::OpenGLRenderer)(renderer) );
...
HXLINE( 154)				HX_VARI(  ::openfl::display::OpenGLRenderer,renderer1) = ( ( ::openfl::display::OpenGLRenderer)(renderer) );
...
HXLINE( 178)						HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 178)						_g = (_g + 1);
...
HXLINE( 213)		HX_VARI(  ::openfl::display::DisplayObjectRenderer,renderer) = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 215)		switch((int)(displayObject->_hx___drawableType)){
            			case (int)2: {
HXLINE( 218)				HX_VARI(  ::openfl::display::Bitmap,bitmap) = ( ( ::openfl::display::Bitmap)(displayObject) );
...
HXLINE( 222)					force = false;
            			...
            			break;
            			case (int)7: {
HXLINE( 225)				HX_VARI(  ::openfl::text::TextField,textField) = ( ( ::openfl::text::TextField)(displayObject) );
...
HXLINE( 229)					force = true;
            			...
            			break;
            			case (int)9: {
HXLINE( 232)				HX_VARI(  ::openfl::display::Tilemap,tilemap) = ( ( ::openfl::display::Tilemap)(displayObject) );
...
HXLINE( 244)		HX_VARI(  ::openfl::geom::ColorTransform,colorTransform) = ::openfl::geom::ColorTransform_obj::_hx___pool->get().StaticCast<  ::openfl::geom::ColorTransform >();
...
HXLINE( 247)		HX_VARI( bool,updated) = false;
...
HXLINE( 251)			HX_VARI(  ::openfl::geom::Rectangle,rect) = null();
HXLINE( 253)			HX_VAR( bool,needRender);
...
HXLINE( 256)			HX_VAR( bool,softwareDirty);
...
HXLINE( 259)			HX_VAR( bool,hardwareDirty);
...
HXLINE( 261)			HX_VARI( ::String,renderType) = renderer->_hx___type;
...
HXLINE( 283)			HX_VAR( bool,updateTransform);
...
HXLINE( 284)			HX_VARI( bool,hasFilters) = ::hx::IsNotNull( displayObject->_hx___filters );
...
HXLINE( 288)					HX_VARI(  ::openfl::filters::BitmapFilter,filter) = _g1->__get(_g).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 288)					_g = (_g + 1);
...
HXLINE( 303)			HX_VAR(  ::openfl::geom::Matrix,bitmapMatrix);
...
HXLINE( 329)			HX_VARI( int,bitmapWidth) = 0;
HXDLIN( 329)			HX_VARI( int,bitmapHeight) = 0;
HXLINE( 330)			HX_VARI( int,filterWidth) = 0;
HXDLIN( 330)			HX_VARI( int,filterHeight) = 0;
HXLINE( 331)			HX_VARI( Float,offsetX) = ((Float)0.);
HXDLIN( 331)			HX_VARI( Float,offsetY) = ((Float)0.);
...
HXLINE( 373)					HX_VAR( bool,needsFill);
...
HXLINE( 375)					HX_VAR( int,fillColor);
...
HXLINE( 376)					HX_VAR( int,bitmapColor);
...
HXLINE( 377)					HX_VARI( bool,allowFramebuffer) = (renderer->_hx___type == HX_("opengl",6f,64,94,21));
...
HXLINE( 412)						HX_VARI(  ::openfl::text::TextField,textField) = ( ( ::openfl::text::TextField)(displayObject) );
...
HXLINE( 515)					HX_VARI(  ::openfl::display::OpenGLRenderer,parentRenderer) = ( ( ::openfl::display::OpenGLRenderer)(renderer) );
HXLINE( 516)					HX_VARI(  ::openfl::display::OpenGLRenderer,childRenderer) = ( ( ::openfl::display::OpenGLRenderer)(displayObject->_hx___cacheBitmapRenderer) );
HXLINE( 518)					HX_VARI(  ::openfl::display3D::Context3D,context) = childRenderer->_hx___context3D;
HXLINE( 520)					HX_VARI(  ::openfl::display3D::textures::TextureBase,cacheRTT) = context->_hx___state->renderToTexture;
HXLINE( 521)					HX_VARI( bool,cacheRTTDepthStencil) = context->_hx___state->renderToTextureDepthStencil;
HXLINE( 522)					HX_VARI( int,cacheRTTAntiAlias) = context->_hx___state->renderToTextureAntiAlias;
HXLINE( 523)					HX_VARI( int,cacheRTTSurfaceSelector) = context->_hx___state->renderToTextureSurfaceSelector;
HXLINE( 527)					HX_VARI(  ::Dynamic,cacheBlendMode) = parentRenderer->_hx___blendMode;
...
HXLINE( 542)						HX_VARI( bool,needSecondBitmapData) = true;
HXLINE( 543)						HX_VARI( bool,needCopyOfOriginal) = false;
HXLINE( 545)						{
HXLINE( 545)							int _g = 0;
HXDLIN( 545)							::Array< ::Dynamic> _g1 = displayObject->_hx___filters;
HXDLIN( 545)							while((_g < _g1->length)){
HXLINE( 545)								HX_VARI(  ::openfl::filters::BitmapFilter,filter) = _g1->__get(_g).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 545)								_g = (_g + 1);
...
HXLINE( 556)						HX_VARI(  ::openfl::display::BitmapData,bitmap) = displayObject->_hx___cacheBitmapData;
HXLINE( 557)						HX_VARI(  ::openfl::display::BitmapData,bitmap2) = null();
HXLINE( 558)						HX_VARI(  ::openfl::display::BitmapData,bitmap3) = null();
...
HXLINE( 609)						HX_VAR(  ::openfl::display::Shader,shader);
HXDLIN( 609)						HX_VAR(  ::openfl::display::BitmapData,cacheBitmap);
HXLINE( 611)						{
HXLINE( 611)							int _g2 = 0;
HXDLIN( 611)							::Array< ::Dynamic> _g3 = displayObject->_hx___filters;
HXDLIN( 611)							while((_g2 < _g3->length)){
HXLINE( 611)								HX_VARI(  ::openfl::filters::BitmapFilter,filter) = _g3->__get(_g2).StaticCast<  ::openfl::filters::BitmapFilter >();
...
HXLINE( 668)						HX_VARI( bool,needSecondBitmapData) = false;
HXLINE( 669)						HX_VARI( bool,needCopyOfOriginal) = false;
HXLINE( 671)						{
HXLINE( 671)							int _g = 0;
HXDLIN( 671)							::Array< ::Dynamic> _g1 = displayObject->_hx___filters;
HXDLIN( 671)							while((_g < _g1->length)){
HXLINE( 671)								HX_VARI(  ::openfl::filters::BitmapFilter,filter) = _g1->__get(_g).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 671)								_g = (_g + 1);
...
HXLINE( 683)						HX_VARI(  ::openfl::display::BitmapData,bitmap) = displayObject->_hx___cacheBitmapData;
HXLINE( 684)						HX_VARI(  ::openfl::display::BitmapData,bitmap2) = null();
HXLINE( 685)						HX_VARI(  ::openfl::display::BitmapData,bitmap3) = null();
...
HXLINE( 724)						HX_VARI(  ::openfl::geom::Point,destPoint) = displayObject->_hx___tempPoint;
HXLINE( 725)						HX_VAR(  ::openfl::display::BitmapData,cacheBitmap);
HXDLIN( 725)						HX_VAR(  ::openfl::display::BitmapData,lastBitmap);
HXLINE( 727)						{
HXLINE( 727)							int _g2 = 0;
HXDLIN( 727)							::Array< ::Dynamic> _g3 = displayObject->_hx___filters;
HXDLIN( 727)							while((_g2 < _g3->length)){
HXLINE( 727)								HX_VARI(  ::openfl::filters::BitmapFilter,filter) = _g3->__get(_g2).StaticCast<  ::openfl::filters::BitmapFilter >();
...
HXLINE( 790)					HX_VARI(  ::openfl::display::DOMRenderer,domRenderer) = ( ( ::openfl::display::DOMRenderer)(renderer) );
...
HXLINE( 808)			HX_VARI(  ::openfl::text::TextField,textField) = ( ( ::openfl::text::TextField)(displayObject) );

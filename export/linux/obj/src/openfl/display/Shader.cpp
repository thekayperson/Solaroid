...
HXLINE( 277)				HX_VARI(  ::openfl::display::ShaderParameter_Float,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 282)				HX_VARI(  ::openfl::display::ShaderParameter_Int,parameter) = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
HXLINE( 328)			HX_VAR( ::String,message);
...
HXLINE( 338)
HXLINE( 339)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 341)		HX_VARI(  ::lime::graphics::opengl::GLObject,vertexShader) = this->_hx___createGLShader(vertexSource,gl->VERTEX_SHADER);
HXLINE( 342)		HX_VARI(  ::lime::graphics::opengl::GLObject,fragmentShader) = this->_hx___createGLShader(fragmentSource,gl->FRAGMENT_SHADER);
HXLINE( 344)		HX_VARI(  ::lime::graphics::opengl::GLObject,program) = gl->createProgram();
HXLINE( 347)		{
HXLINE( 347)			int _g = 0;
HXDLIN( 347)			::Array< ::Dynamic> _g1 = this->_hx___paramFloat;
HXDLIN( 347)			while((_g < _g1->length)){
HXLINE( 347)				HX_VARI(  ::openfl::display::ShaderParameter_Float,param) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 347)				_g = (_g + 1);
...
HXLINE( 362)			HX_VARI( ::String,message) = HX_("Unable to initialize the shader program",f0,86,8b,39);
...
void Shader_obj::_hx___disableGL(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 379)
HXLINE( 380)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 382)		HX_VARI( int,textureCount) = 0;
HXLINE( 384)		{
HXLINE( 384)			int _g = 0;
HXDLIN( 384)			::Array< ::Dynamic> _g1 = this->_hx___inputBitmapData;
HXDLIN( 384)			while((_g < _g1->length)){
HXLINE( 384)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 384)				_g = (_g + 1);
...
HXLINE( 390)				HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
...
HXLINE( 395)				HX_VARI(  ::openfl::display::ShaderParameter_Float,parameter) = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 400)				HX_VARI(  ::openfl::display::ShaderParameter_Int,parameter) = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
void Shader_obj::_hx___enableGL(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 426)
HXLINE( 427)		HX_VARI( int,textureCount) = 0;
HXLINE( 429)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 431)		{
HXLINE( 431)			int _g = 0;
HXDLIN( 431)			::Array< ::Dynamic> _g1 = this->_hx___inputBitmapData;
HXDLIN( 431)			while((_g < _g1->length)){
HXLINE( 431)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 431)				_g = (_g + 1);
...
HXLINE( 477)			HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 479)			HX_VARI( ::String,prefix1) = ((HX_("#ifdef GL_ES\n\t\t\t\t",7d,b3,ff,2f) + prefix) + HX_("\n\t\t\t\t#endif\n\t\t\t\t",ab,2a,3b,b6));
HXLINE( 490)			HX_VARI( ::String,vertex) = (prefix1 + this->get_glVertexSource());
HXLINE( 491)			HX_VARI( ::String,fragment) = (prefix1 + this->get_glFragmentSource());
HXLINE( 493)			HX_VARI( ::String,id) = (vertex + fragment);
...
HXLINE( 514)						HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 514)						_g = (_g + 1);
...
HXLINE( 526)						HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
...
HXLINE( 538)						HX_VARI(  ::openfl::display::ShaderParameter_Float,parameter) = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 550)						HX_VARI(  ::openfl::display::ShaderParameter_Int,parameter) = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
HXLINE( 566)
HXLINE( 567)		HX_VARI( int,lastMatch) = 0;
HXDLIN( 567)		HX_VAR(  ::Dynamic,position);
HXDLIN( 567)		HX_VAR(  ::EReg,regex);
HXDLIN( 567)		HX_VAR( ::String,name);
HXDLIN( 567)		HX_VAR( ::String,type);
...
HXLINE( 588)			HX_VARI( bool,isUniform) = (storageType == HX_("uniform",34,41,64,b5));
HXLINE( 590)			if (::StringTools_obj::startsWith(type,HX_("sampler",08,c5,c9,83))) {
HXLINE( 592)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) =  ::openfl::display::ShaderInput_openfl_display_BitmapData_obj::__alloc( HX_CTX );
...
HXLINE( 611)					HX_VAR(  ::Dynamic,parameterType);
...
HXLINE( 637)						length = 1;
            					...
            					_hx_goto_26:;
HXLINE( 647)					HX_VAR( int,arrayLength);
...
HXLINE( 658)						HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) =  ::openfl::display::ShaderParameter_Bool_obj::__alloc( HX_CTX );
...
HXLINE( 676)						HX_VARI(  ::openfl::display::ShaderParameter_Int,parameter) =  ::openfl::display::ShaderParameter_Int_obj::__alloc( HX_CTX );
...
HXLINE( 675)						goto _hx_goto_29;
            					...
            					/* default */{
HXLINE( 688)						HX_VARI(  ::openfl::display::ShaderParameter_Float,parameter) =  ::openfl::display::ShaderParameter_Float_obj::__alloc( HX_CTX );
...
void Shader_obj::_hx___updateGL(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 742)
HXLINE( 743)		HX_VARI( int,textureCount) = 0;
HXLINE( 745)		{
HXLINE( 745)			int _g = 0;
HXDLIN( 745)			::Array< ::Dynamic> _g1 = this->_hx___inputBitmapData;
HXDLIN( 745)			while((_g < _g1->length)){
HXLINE( 745)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 745)				_g = (_g + 1);
...
HXLINE( 751)				HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
...
HXLINE( 756)				HX_VARI(  ::openfl::display::ShaderParameter_Float,parameter) = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 761)				HX_VARI(  ::openfl::display::ShaderParameter_Int,parameter) = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
void Shader_obj::_hx___updateGLFromBuffer( ::openfl::display::_internal::ShaderBuffer shaderBuffer,int bufferOffset){
            	...
            	HX_STACK_ARG(bufferOffset,"bufferOffset")
HXLINE( 768)
HXLINE( 769)		HX_VARI( int,textureCount) = 0;
HXLINE( 770)		HX_VAR(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input);
HXDLIN( 770)		HX_VAR(  ::openfl::display::BitmapData,inputData);
HXDLIN( 770)		HX_VAR(  ::Dynamic,inputFilter);
HXDLIN( 770)		HX_VAR(  ::Dynamic,inputMipFilter);
HXDLIN( 770)		HX_VAR(  ::Dynamic,inputWrap);
HXLINE( 772)		{
HXLINE( 772)			int _g = 0;
HXDLIN( 772)			int _g1 = shaderBuffer->inputCount;
HXDLIN( 772)			while((_g < _g1)){
HXLINE( 772)				_g = (_g + 1);
HXDLIN( 772)				HX_VARI( int,i) = (_g - 1);
...
HXLINE( 787)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 808)		HX_VARI( int,boolIndex) = 0;
HXLINE( 809)		HX_VARI( int,floatIndex) = 0;
HXLINE( 810)		HX_VARI( int,intIndex) = 0;
HXLINE( 812)		HX_VARI( int,boolCount) = shaderBuffer->paramBoolCount;
HXLINE( 813)		HX_VARI( int,floatCount) = shaderBuffer->paramFloatCount;
HXLINE( 814)		HX_VARI(  ::lime::utils::ArrayBufferView,paramData) = shaderBuffer->paramData;
HXLINE( 816)		HX_VAR(  ::openfl::display::ShaderParameter_Bool,boolRef);
HXDLIN( 816)		HX_VAR(  ::openfl::display::ShaderParameter_Float,floatRef);
HXDLIN( 816)		HX_VAR(  ::openfl::display::ShaderParameter_Int,intRef);
HXDLIN( 816)		HX_VAR( bool,hasOverride);
HXLINE( 817)		HX_VARI( ::Array< bool >,overrideBoolValue) = null();
HXDLIN( 817)		HX_VARI( ::Array< Float >,overrideFloatValue) = null();
HXDLIN( 817)		HX_VARI( ::Array< int >,overrideIntValue) = null();
HXLINE( 821)		{
HXLINE( 821)			int _g2 = 0;
HXDLIN( 821)			int _g3 = shaderBuffer->paramCount;
HXDLIN( 821)			while((_g2 < _g3)){
HXLINE( 821)				_g2 = (_g2 + 1);
HXDLIN( 821)				HX_VARI( int,i) = (_g2 - 1);

...
HXDLIN( 278)			HX_VARI(  ::lime::graphics::ImageBuffer,buffer1) =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,width,height,null(),null());
...
HXLINE( 634)		HX_VAR(  ::lime::graphics::ImageChannel,sourceChannel1);
...
HXLINE( 643)		HX_VAR(  ::lime::graphics::ImageChannel,destChannel1);
...
HXLINE( 966)			HX_VARI(  ::openfl::display::CairoRenderer,renderer) =  ::openfl::display::CairoRenderer_obj::__alloc( HX_CTX , ::lime::graphics::cairo::Cairo_obj::__alloc( HX_CTX ,this->getSurface()));
...
HXDLIN(1684)					HX_VARI( Float,renderedCenterX1) = (((renderedCenterX / targetObject->get_scaleX()) - renderedLeft) - renderedRight);
HXLINE(1685)					Float renderedCenterY = targetObject->get_height();
HXDLIN(1685)					HX_VARI( Float,renderedCenterY1) = (((renderedCenterY / targetObject->get_scaleY()) - renderedTop) - renderedBottom);
HXLINE(1696)					{
...
HXLINE(1773)						HX_VARI( Float,top) = scale9Grid->y;
HXLINE(1774)						HX_VARI( Float,bottom) = ((( (Float)(this->height) ) - centerY) - top);
HXLINE(1776)						HX_VARI( Float,uvTop) = (top / ( (Float)(this->height) ));
HXLINE(1777)						HX_VARI( Float,uvCenterY) = (centerY / ( (Float)(this->height) ));
HXLINE(1778)						HX_VARI( Float,uvBottom) = (bottom / ( (Float)(this->height) ));
HXLINE(1780)						HX_VARI( Float,renderedTop) = (top / targetObject->get_scaleY());
HXLINE(1781)						HX_VARI( Float,renderedBottom) = (bottom / targetObject->get_scaleY());
HXLINE(1782)						Float renderedCenterY = targetObject->get_height();
HXDLIN(1782)						HX_VARI( Float,renderedCenterY1) = (((renderedCenterY / targetObject->get_scaleY()) - renderedTop) - renderedBottom);
HXLINE(1784)						Float renderedWidth = targetObject->get_width();
HXDLIN(1784)						HX_VARI( Float,renderedWidth1) = (renderedWidth / targetObject->get_scaleX());
HXLINE(1795)						{
...
HXLINE(1830)							HX_VARI( Float,left) = scale9Grid->x;
HXLINE(1831)							HX_VARI( Float,right) = ((( (Float)(this->width) ) - centerX) - left);
HXLINE(1833)							HX_VARI( Float,uvLeft) = (left / ( (Float)(this->width) ));
HXLINE(1834)							HX_VARI( Float,uvCenterX) = (centerX / ( (Float)(this->width) ));
HXLINE(1835)							HX_VARI( Float,uvRight) = (right / ( (Float)(this->width) ));
HXLINE(1837)							HX_VARI( Float,renderedLeft) = (left / targetObject->get_scaleX());
HXLINE(1838)							HX_VARI( Float,renderedRight) = (right / targetObject->get_scaleX());
HXLINE(1839)							Float renderedCenterX = targetObject->get_width();
HXDLIN(1839)							HX_VARI( Float,renderedCenterX1) = (((renderedCenterX / targetObject->get_scaleX()) - renderedLeft) - renderedRight);
HXLINE(1841)							Float renderedHeight = targetObject->get_height();
HXDLIN(1841)							HX_VARI( Float,renderedHeight1) = (renderedHeight / targetObject->get_scaleY());
HXLINE(1848)							{
...
HXLINE(2041)			HX_VARI( int,color1) = color;
...
HXDLIN(2131)		HX_VARI(  ::openfl::utils::ByteArrayData,byteArray1) = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(byteArray->getPixels(rect->_hx___toLimeRectangle(),1));
...
HXDLIN(2254)		HX_VARI( int,length2) = ::Std_obj::_hx_int((length / length1));
...
HXDLIN(2278)					HX_VARI( int,j) = (_g4 - 1);
...
HXDLIN(2278)					HX_VARI( int,j) = (_g6 - 1);
...
HXDLIN(2278)					HX_VARI( int,j) = (_g8 - 1);
...
HXLINE(2351)				HX_VAR( int,x);
HXDLIN(2351)				HX_VAR( int,y);
...
HXLINE(2423)						HX_VARI(  ::openfl::utils::ByteArrayData,pixels) = this->getPixels(secondRectangle);
...
HXDLIN(2424)						HX_VARI( int,length2) = ::Std_obj::_hx_int((length / length1));
HXLINE(2425)						HX_VAR( int,pixel);
HXLINE(2427)						{
HXLINE(2427)							int _g = 0;
HXDLIN(2427)							int _g1 = length2;
HXDLIN(2427)							while((_g < _g1)){
HXLINE(2427)								_g = (_g + 1);
HXDLIN(2427)								HX_VARI( int,i) = (_g - 1);
...
HXLINE(2606)
HXDLIN(2606)		HX_VARI( ::Array< int >,randomSeed1) = ::Array_obj< int >::__new(1)->init(0,randomSeed);
...
HXDLIN(2630)						HX_VARI( int,x) = (_g1 - 1);
...
HXDLIN(2928)		HX_VARI(  ::openfl::utils::ByteArrayData,byteArray) = this1;
...
HXLINE(2931)				HX_VARI( int,color1) = ( (int)(color->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(3122)			HX_VARI( int,color1) = color;

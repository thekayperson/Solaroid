...
HXLINE( 318)				HX_VARI(  ::openfl::display::Tile,tile) = _g1->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 318)				_g = (_g + 1);
...
HXLINE( 323)				HX_VARI(  ::openfl::display::Tile,tile) = _g3->__get(_g2).StaticCast<  ::openfl::display::Tile >();
...
HXLINE( 388)
HXLINE( 389)		HX_VARI(  ::openfl::geom::Rectangle,bounds) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();

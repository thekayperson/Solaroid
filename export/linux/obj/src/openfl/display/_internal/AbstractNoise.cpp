...
HXLINE(  72)			HX_VARI( int,dest) = bitmap->getPixel32(px,(height - py));
HXLINE(  73)			HX_VARI( int,dest_r) = ((dest >> 16) & 255);
HXLINE(  74)			HX_VARI( int,dest_g) = ((dest >> 8) & 255);
HXLINE(  75)			HX_VARI( int,dest_b) = (dest & 255);
HXLINE(  77)			HX_VARI( Float,u) = (( (Float)((height - py)) ) / ( (Float)(stitch_h) ));
HXLINE(  78)			HX_VARI( Float,uu) = (u * u);

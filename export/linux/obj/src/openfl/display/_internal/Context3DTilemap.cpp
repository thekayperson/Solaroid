...
HXLINE( 126)				HX_VARI(  ::openfl::display::Tile,tile) = tiles->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 126)				_g = (_g + 1);
...
HXLINE( 489)				HX_VARI(  ::openfl::display::Tile,tile) = tiles->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 489)				_g = (_g + 1);

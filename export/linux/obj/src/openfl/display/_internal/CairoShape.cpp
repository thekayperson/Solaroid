...
HXLINE(  54)					HX_VARI(  ::openfl::geom::Rectangle,bounds) = graphics->_hx___bounds;
HXLINE(  56)					HX_VARI(  ::openfl::geom::Matrix,renderTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE(  58)					HX_VARI( Float,scaleX) = graphics->_hx___renderTransform->a;
HXLINE(  59)					HX_VARI( Float,scaleY) = graphics->_hx___renderTransform->d;
HXLINE(  60)					HX_VARI( Float,renderScaleX) = transform->a;
HXLINE(  61)					HX_VARI( Float,renderScaleY) = transform->d;
HXLINE(  63)					HX_VARI( int,left) = ::Math_obj::round((scale9Grid->x * scaleX));
HXLINE(  64)					HX_VARI( int,top) = ::Math_obj::round((scale9Grid->y * scaleY));
HXLINE(  65)					Float right = bounds->get_right();
HXDLIN(  65)					HX_VARI( int,right1) = ::Math_obj::round(((right - scale9Grid->get_right()) * scaleX));
HXLINE(  66)					Float bottom = bounds->get_bottom();
HXDLIN(  66)					HX_VARI( int,bottom1) = ::Math_obj::round(((bottom - scale9Grid->get_bottom()) * scaleY));
HXLINE(  67)					HX_VARI( int,centerWidth) = ::Math_obj::round((scale9Grid->width * scaleX));
HXLINE(  68)					HX_VARI( int,centerHeight) = ::Math_obj::round((scale9Grid->height * scaleY));
HXLINE(  70)					HX_VARI( int,renderLeft) = ::Math_obj::round((scale9Grid->x * renderScaleX));
HXLINE(  71)					HX_VARI( int,renderTop) = ::Math_obj::round((scale9Grid->y * renderScaleY));
HXLINE(  72)					Float renderRight = bounds->get_right();
HXDLIN(  72)					HX_VARI( int,renderRight1) = ::Math_obj::round(((renderRight - scale9Grid->get_right()) * renderScaleX));
HXLINE(  73)					Float renderBottom = bounds->get_bottom();
HXDLIN(  73)					HX_VARI( int,renderBottom1) = ::Math_obj::round(((renderBottom - scale9Grid->get_bottom()) * renderScaleY));
HXLINE(  74)					HX_VARI( int,renderCenterWidth) = ((::Math_obj::round((( (Float)(width) ) * renderScaleX)) - renderLeft) - renderRight1);
HXLINE(  75)					HX_VARI( int,renderCenterHeight) = ((::Math_obj::round((( (Float)(height) ) * renderScaleY)) - renderTop) - renderBottom1);
HXLINE(  77)					HX_VARI(  ::Dynamic,pattern) = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(graphics->_hx___cairo->get_target());
HXLINE(  79)					::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,3);
HXLINE(  82)					HX_VARI(  ::Dynamic,drawImage) =  ::Dynamic(new _hx_Closure_0(alpha,renderer,cairo,pattern,transform,renderTransform));
...
HXLINE( 131)							HX_VARI( int,renderWidth) = ((renderLeft + renderCenterWidth) + renderRight1);
...
HXLINE( 139)								HX_VARI( int,renderHeight) = ((renderTop + renderCenterHeight) + renderBottom1);

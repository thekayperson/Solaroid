...
HXDLIN( 112)						HX_VARI( int,px) = (_g1 - 1);
...
HXLINE( 218)		HX_VARI( Float,g12) = (g1 + g11);
...
HXLINE( 222)		HX_VARI( Float,g22) = (g2 + g21);
...
HXLINE( 226)		HX_VARI( Float,g32) = (g3 + g31);
...
HXLINE( 230)		HX_VARI( Float,g42) = (g4 + g41);
...
HXLINE( 234)		HX_VARI( Float,g52) = (g5 + g51);
...
HXLINE( 238)		HX_VARI( Float,g62) = (g6 + g61);
...
HXLINE( 242)		HX_VARI( Float,g72) = (g7 + g71);
...
HXLINE( 246)		HX_VARI( Float,g82) = (g8 + g81);

...
HXLINE(   9)				HX_VARI(  ::openfl::display::DisplayObject,orphan1) = ( ( ::openfl::display::DisplayObject)(orphan->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(  27)					HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  27)					_g = (_g + 1);
...
HXLINE(  37)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  37)				_g = (_g + 1);
...
HXLINE(  47)
HXLINE(  48)		{
HXLINE(  48)			HX_VARI(  ::Dynamic,orphan) = displayObjectContainer->_hx___removedChildren->iterator();
HXDLIN(  48)			while(( (bool)(orphan->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  48)				HX_VARI(  ::openfl::display::DisplayObject,orphan1) = ( ( ::openfl::display::DisplayObject)(orphan->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(  58)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  58)				_g = (_g + 1);

...
HXDLIN(  37)		HX_VARI( bool,useTextBounds1) = !(useTextBounds);
...
HXLINE(  94)		HX_VARI( int,width) = graphics->_hx___width;
HXLINE(  95)		HX_VARI( int,height) = graphics->_hx___height;
HXLINE(  97)		HX_VAR( bool,renderable);
...
HXLINE(  98)		HX_VARI( bool,needsUpscaling) = false;
HXLINE( 100)		if (::hx::IsNotNull( cairo )) {
HXLINE( 103)			HX_VARI(  ::Dynamic,surface) = graphics->_hx___bitmap->getSurface();
...
HXLINE( 130)			HX_VAR( int,bitmapWidth);
...
HXLINE( 131)			HX_VAR( int,bitmapHeight);
...
HXLINE( 143)			HX_VARI(  ::openfl::display::BitmapData,bitmap) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,bitmapWidth,bitmapHeight,true,0);
HXLINE( 144)			HX_VARI(  ::Dynamic,surface) = bitmap->getSurface();
...
HXLINE( 153)			HX_VARI(  ::Dynamic,options) = ::lime::graphics::cairo::_CairoFontOptions::CairoFontOptions_Impl__obj::_new();
...
HXLINE( 193)			HX_VARI( int,color) = textEngine->backgroundColor;
HXLINE( 194)			HX_VARI( Float,r) = (( (Float)(::hx::UShr((color & 16711680),16)) ) / ( (Float)(255) ));
HXLINE( 195)			HX_VARI( Float,g) = (( (Float)(::hx::UShr((color & 65280),8)) ) / ( (Float)(255) ));
HXLINE( 196)			HX_VARI( Float,b) = (( (Float)((color & 255)) ) / ( (Float)(255) ));
HXLINE( 198)			cairo->setSourceRGB(r,g,b);
HXLINE( 199)			cairo->fillPreserve();
            		}
HXLINE( 202)		if (textEngine->border) {
HXLINE( 204)			HX_VARI( int,color) = textEngine->borderColor;
HXLINE( 205)			HX_VARI( Float,r) = (( (Float)(::hx::UShr((color & 16711680),16)) ) / ( (Float)(255) ));
HXLINE( 206)			HX_VARI( Float,g) = (( (Float)(::hx::UShr((color & 65280),8)) ) / ( (Float)(255) ));
HXLINE( 207)			HX_VARI( Float,b) = (( (Float)((color & 255)) ) / ( (Float)(255) ));
...
HXLINE( 219)			HX_VARI( ::String,text) = textEngine->text;
HXLINE( 221)			HX_VARI( int,scrollX) = -(textField->get_scrollH());
HXLINE( 222)			HX_VARI( Float,scrollY) = ((Float)0.0);
HXLINE( 224)			{
HXLINE( 224)				int _g = 0;
HXDLIN( 224)				int _g1 = (textField->get_scrollV() - 1);
HXDLIN( 224)				while((_g < _g1)){
HXLINE( 224)					_g = (_g + 1);
HXDLIN( 224)					HX_VARI( int,i) = (_g - 1);
HXLINE( 226)					scrollY = (scrollY - textEngine->lineHeights->get(i));
            				}
            			}
HXLINE( 229)			HX_VAR(  ::Dynamic,color);
HXDLIN( 229)			HX_VAR( Float,r);
HXDLIN( 229)			HX_VAR( Float,g);
HXDLIN( 229)			HX_VAR( Float,b);
HXDLIN( 229)			HX_VAR(  ::openfl::text::Font,font);
HXDLIN( 229)			HX_VAR( int,size);
HXDLIN( 229)			HX_VAR( Float,advance);
HXLINE( 231)			{
HXLINE( 231)				HX_VARI(  ::Dynamic,group) = textEngine->layoutGroups->iterator();
HXDLIN( 231)				while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 231)					HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group1) = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 275)						HX_VARI( ::Array< ::Dynamic>,glyphs) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 276)						HX_VARI( Float,x) = ((group1->offsetX + scrollX) - bounds->x);
HXLINE( 277)						HX_VARI( Float,y) = (((group1->offsetY + group1->ascent) + scrollY) - bounds->y);
HXLINE( 279)						{
HXLINE( 279)							int _g = 0;
HXDLIN( 279)							::Array< ::Dynamic> _g1 = group1->positions;
HXDLIN( 279)							while((_g < _g1->length)){
HXLINE( 279)								HX_VARI(  ::openfl::text::_internal::GlyphPosition,position) = _g1->__get(_g).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN( 279)								_g = (_g + 1);
...
HXLINE( 306)									HX_VARI( Float,scrollY) = ((Float)0.0);
HXLINE( 308)									{
...
HXDLIN( 308)											HX_VARI( int,i) = (_g2 - 1);
...
HXLINE( 331)									HX_VARI( int,selectionStart) = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(textField->_hx___selectionIndex) ),( (Float)(textField->_hx___caretIndex) )));
HXLINE( 332)									HX_VARI( int,selectionEnd) = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(textField->_hx___selectionIndex) ),( (Float)(textField->_hx___caretIndex) )));
...
HXLINE( 344)									HX_VAR(  ::openfl::geom::Rectangle,end);
HXDLIN( 344)									HX_VARI(  ::openfl::geom::Rectangle,start) = textField->getCharBoundaries(selectionStart);
...
HXLINE( 371)										HX_VARI( ::Array< ::Dynamic>,selectedGylphs) = ::Array_obj< ::Dynamic>::__new(0);
...
HXLINE( 390)							HX_VARI( Float,x) = ((group1->offsetX + scrollX) - bounds->x);
HXLINE( 391)							HX_VARI( Float,y) = (::Math_obj::floor((((group1->offsetY + scrollY) + group1->ascent) - bounds->y)) + ((Float)0.5));
...
HXDLIN( 402)				HX_VARI( Float,scrollX1) = (-(textField->get_scrollH()) + scrollX);
HXLINE( 403)				HX_VARI( Float,scrollY) = ((Float)0.0);
HXLINE( 405)				{
HXLINE( 405)					int _g = 0;
...
HXLINE( 410)				HX_VARI(  ::Dynamic,color) = textField->get_defaultTextFormat()->color;
HXLINE( 411)				HX_VARI( Float,r) = (( (Float)(::hx::UShr((( (int)(color) ) & 16711680),16)) ) / ( (Float)(255) ));
HXLINE( 412)				HX_VARI( Float,g) = (( (Float)(::hx::UShr((( (int)(color) ) & 65280),8)) ) / ( (Float)(255) ));
HXLINE( 413)				HX_VARI( Float,b) = (( (Float)((( (int)(color) ) & 255)) ) / ( (Float)(255) ));

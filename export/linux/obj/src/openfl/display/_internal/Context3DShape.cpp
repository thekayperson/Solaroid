...
HXLINE(  29)		HX_VARI(  ::openfl::display::Graphics,graphics) = shape->_hx___graphics;
...
HXLINE(  41)				HX_VARI(  ::openfl::display3D::Context3D,context) = renderer->_hx___context3D;
HXLINE(  42)				HX_VARI(  ::openfl::geom::Rectangle,scale9Grid) = shape->_hx___worldScale9Grid;
HXLINE(  44)				HX_VARI(  ::openfl::display::Shader,shader) = renderer->_hx___initDisplayShader(shape->_hx___worldShader);
...
HXLINE(  54)				HX_VARI(  ::openfl::display3D::VertexBuffer3D,vertexBuffer) = graphics->_hx___bitmap->getVertexBuffer(context,null(),null());
...
HXLINE(  57)				HX_VARI(  ::openfl::display3D::IndexBuffer3D,indexBuffer) = graphics->_hx___bitmap->getIndexBuffer(context,null());
...
void Context3DShape_obj::renderMask( ::openfl::display::DisplayObject shape, ::openfl::display::OpenGLRenderer renderer){
            	...
            	HX_STACK_ARG(renderer,"renderer")
HXLINE(  73)
HXLINE(  74)		HX_VARI(  ::openfl::display::Graphics,graphics) = shape->_hx___graphics;
...
HXLINE(  84)				HX_VARI(  ::openfl::display3D::Context3D,context) = renderer->_hx___context3D;
HXLINE(  86)				HX_VARI(  ::openfl::display::_internal::Context3DMaskShader,shader) = renderer->_hx___maskShader;
...
HXLINE(  92)				HX_VARI(  ::openfl::display3D::VertexBuffer3D,vertexBuffer) = graphics->_hx___bitmap->getVertexBuffer(context,null(),null());
...
HXLINE(  95)				HX_VARI(  ::openfl::display3D::IndexBuffer3D,indexBuffer) = graphics->_hx___bitmap->getIndexBuffer(context,null());

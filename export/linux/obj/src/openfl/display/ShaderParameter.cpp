...
HXLINE( 172)
HXLINE( 173)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
...
HXLINE( 185)
HXLINE( 187)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
HXLINE( 189)		HX_VAR( ::cpp::VirtualArray,value);
...
HXLINE( 191)		HX_VAR( ::Array< bool >,boolValue);
...
HXLINE( 192)		HX_VAR( ::Array< Float >,floatValue);
...
HXLINE( 193)		HX_VAR( ::Array< int >,intValue);
...
HXLINE( 419)
HXLINE( 421)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
...
HXLINE( 561)				HX_VARI( int,type) = gl->FLOAT;

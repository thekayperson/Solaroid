...
HXLINE( 314)				HX_VARI( Float,alpha) = alphas->__get(_g);
HXDLIN( 314)				_g = (_g + 1);
...
HXLINE( 381)			HX_VARI(  ::openfl::display::_internal::ShaderBuffer,shaderBuffer) = this->_hx___shaderBufferPool->get().StaticCast<  ::openfl::display::_internal::ShaderBuffer >();
...
HXDLIN( 398)				HX_VARI(  ::openfl::display::_internal::ShaderBuffer,shaderBuffer) = val;
...
HXLINE( 487)		HX_VARI( Float,ix1) = anchorX;
HXDLIN( 487)		HX_VARI( Float,ix2) = anchorX;
...
HXLINE( 495)			HX_VARI( Float,u) = (((( (Float)(2) ) * this->_hx___positionX) - (( (Float)(4) ) * controlX1)) + (( (Float)(2) ) * controlX2));
HXLINE( 496)			HX_VARI( Float,v) = (controlX1 - this->_hx___positionX);
HXLINE( 497)			HX_VARI( Float,w) = (((-(this->_hx___positionX) + (( (Float)(3) ) * controlX1)) + anchorX) - (( (Float)(3) ) * controlX2));
HXLINE( 499)			HX_VARI( Float,t1) = ((-(u) + ::Math_obj::sqrt(((u * u) - ((( (Float)(4) ) * v) * w)))) / (( (Float)(2) ) * w));
HXLINE( 500)			HX_VARI( Float,t2) = ((-(u) - ::Math_obj::sqrt(((u * u) - ((( (Float)(4) ) * v) * w)))) / (( (Float)(2) ) * w));
...
HXLINE( 487)		HX_VARI( Float,iy1) = anchorY;
HXDLIN( 487)		HX_VARI( Float,iy2) = anchorY;
...
HXLINE( 519)			HX_VARI( Float,u) = (((( (Float)(2) ) * this->_hx___positionX) - (( (Float)(4) ) * controlY1)) + (( (Float)(2) ) * controlY2));
HXLINE( 520)			HX_VARI( Float,v) = (controlY1 - this->_hx___positionX);
HXLINE( 521)			HX_VARI( Float,w) = (((-(this->_hx___positionX) + (( (Float)(3) ) * controlY1)) + anchorY) - (( (Float)(3) ) * controlY2));
HXLINE( 523)			HX_VARI( Float,t1) = ((-(u) + ::Math_obj::sqrt(((u * u) - ((( (Float)(4) ) * v) * w)))) / (( (Float)(2) ) * w));
HXLINE( 524)			HX_VARI( Float,t2) = ((-(u) - ::Math_obj::sqrt(((u * u) - ((( (Float)(4) ) * v) * w)))) / (( (Float)(2) ) * w));
...
HXLINE( 590)		HX_VAR( Float,ix);
HXDLIN( 590)		HX_VAR( Float,iy);
...
HXLINE( 598)			HX_VARI( Float,tx) = ((this->_hx___positionX - controlX) / ((this->_hx___positionX - (( (Float)(2) ) * controlX)) + anchorX));
...
HXLINE( 608)			HX_VARI( Float,ty) = ((this->_hx___positionY - controlY) / ((this->_hx___positionY - (( (Float)(2) ) * controlY)) + anchorY));
...
HXLINE( 676)
HXLINE( 677)		HX_VAR(  ::openfl::display::GraphicsSolidFill,fill);
HXLINE( 678)		HX_VAR(  ::openfl::display::GraphicsBitmapFill,bitmapFill);
HXLINE( 679)		HX_VAR(  ::openfl::display::GraphicsGradientFill,gradientFill);
HXLINE( 680)		HX_VAR(  ::openfl::display::GraphicsShaderFill,shaderFill);
HXLINE( 681)		HX_VAR(  ::openfl::display::GraphicsStroke,stroke);
HXLINE( 682)		HX_VAR(  ::openfl::display::GraphicsPath,path);
HXLINE( 683)		HX_VAR(  ::openfl::display::GraphicsTrianglePath,trianglePath);
HXLINE( 684)		HX_VAR(  ::openfl::display::GraphicsQuadPath,quadPath);
HXLINE( 686)		{
HXLINE( 686)			HX_VARI(  ::Dynamic,graphics) = graphicsData->iterator();
HXDLIN( 686)			while(( (bool)(graphics->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 686)				HX_VARI( ::Dynamic,graphics1) = graphics->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
...
HXLINE( 712)							HX_VARI(  ::Dynamic,thickness) = stroke->thickness;
...
HXLINE( 807)
HXLINE( 808)		HX_VARI( int,dataIndex) = 0;
HXLINE( 810)		if (::hx::IsEq( winding,1 )) {
HXLINE( 810)			this->_hx___commands->windingNonZero();
            		}
HXLINE( 812)		{
HXLINE( 812)			HX_VARI(  ::Dynamic,command) = commands->iterator();
HXDLIN( 812)			while(( (bool)(command->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 812)				HX_VARI( int,command1) = ( (int)(command->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 883)		HX_VARI( bool,hasIndices) = ::hx::IsNotNull( indices );
HXLINE( 884)		HX_VARI( bool,transformABCD) = false;
HXDLIN( 884)		HX_VARI( bool,transformXY) = false;
HXLINE( 886)		HX_VAR( int,length);
...
HXLINE( 906)		HX_VARI(  ::openfl::geom::Rectangle,tileRect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 907)		HX_VARI(  ::openfl::geom::Matrix,tileTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 909)		HX_VARI( Float,minX) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 910)		HX_VARI( Float,minY) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 911)		HX_VARI( Float,maxX) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 912)		HX_VARI( Float,maxY) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 914)		HX_VAR( int,ri);
HXDLIN( 914)		HX_VAR( int,ti);
HXLINE( 916)		{
HXLINE( 916)			int _g = 0;
HXDLIN( 916)			int _g1 = length;
HXDLIN( 916)			while((_g < _g1)){
HXLINE( 916)				_g = (_g + 1);
HXDLIN( 916)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(1053)		HX_VARI( Float,xw) = (x + width);
HXLINE(1054)		HX_VARI( Float,yh) = (y + height);
HXLINE(1055)		HX_VAR( Float,minSize);
...
HXLINE(1061)		HX_VARI( Float,anchor) = (( (Float)(1) ) - ::Math_obj::sin((( (Float)(45) ) * (::Math_obj::PI / ( (Float)(180) )))));
HXLINE(1062)		HX_VARI( Float,control) = (( (Float)(1) ) - ::Math_obj::tan((((Float)22.5) * (::Math_obj::PI / ( (Float)(180) )))));
HXLINE(1064)		HX_VARI( Float,a) = (bottomRightRadius * anchor);
HXLINE(1065)		HX_VARI( Float,s) = (bottomRightRadius * control);
...
HXLINE(1115)		HX_VARI( int,vertLength) = ::Std_obj::_hx_int((( (Float)(vertices->get_length()) ) / ( (Float)(2) )));
...
HXLINE(1128)					_g = (_g + 1);
HXDLIN(1128)					HX_VARI( int,i) = (_g - 1);
...
HXLINE(1139)		HX_VAR( Float,x);
HXDLIN(1139)		HX_VAR( Float,y);
HXLINE(1140)		HX_VARI( Float,minX) = ::Math_obj::POSITIVE_INFINITY;
HXLINE(1141)		HX_VARI( Float,minY) = ::Math_obj::POSITIVE_INFINITY;
HXLINE(1142)		HX_VARI( Float,maxX) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE(1143)		HX_VARI( Float,maxY) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE(1145)		{
HXLINE(1145)			int _g = 0;
HXDLIN(1145)			int _g1 = vertLength;
HXDLIN(1145)			while((_g < _g1)){
HXLINE(1145)				_g = (_g + 1);
HXDLIN(1145)				HX_VARI( int,i) = (_g - 1);
...
HXDLIN(1608)		HX_VARI(  ::openfl::_Vector::ObjectVector,graphicsData) =  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,length,fixed,array,true);
...
Float Graphics_obj::_hx___calculateBezierCubicPoint(Float t,Float p1,Float p2,Float p3,Float p4){
            	...
            	HX_STACK_ARG(p4,"p4")
HXLINE(1615)
HXLINE(1616)		HX_VARI( Float,iT) = (( (Float)(1) ) - t);
...
Float Graphics_obj::_hx___calculateBezierQuadPoint(Float t,Float p1,Float p2,Float p3){
            	...
            	HX_STACK_ARG(p3,"p3")
HXLINE(1622)
HXLINE(1623)		HX_VARI( Float,iT) = (( (Float)(1) ) - t);
...
HXLINE(1657)		HX_VARI(  ::openfl::geom::Rectangle,bounds) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
void Graphics_obj::_hx___readGraphicsData( ::openfl::_Vector::ObjectVector graphicsData){
            	...
            	HX_STACK_ARG(graphicsData,"graphicsData")
HXLINE(1722)
HXLINE(1723)		HX_VARI(  ::openfl::display::_internal::DrawCommandReader,data) =  ::openfl::display::_internal::DrawCommandReader_obj::__alloc( HX_CTX ,this->_hx___commands);
HXLINE(1724)		HX_VARI(  ::openfl::display::GraphicsPath,path) = null();
HXDLIN(1724)		HX_VAR(  ::openfl::display::GraphicsStroke,stroke);
HXLINE(1726)		{
HXLINE(1726)			int _g = 0;
HXDLIN(1726)			::Array< ::Dynamic> _g1 = this->_hx___commands->types;
HXDLIN(1726)			while((_g < _g1->length)){
HXLINE(1726)				HX_VARI(  ::openfl::display::_internal::DrawCommandType,type) = _g1->__get(_g).StaticCast<  ::openfl::display::_internal::DrawCommandType >();
HXDLIN(1726)				_g = (_g + 1);
...
HXDLIN(1806)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
...
HXDLIN(1810)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
...
HXDLIN(1814)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
...
HXDLIN(1747)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
...
HXDLIN(1751)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
...
HXDLIN(1763)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
...
HXDLIN(1767)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
...
HXDLIN(1771)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
...
HXDLIN(1775)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
...
HXDLIN(1789)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
...
HXDLIN(1781)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
            					}
            					break;
            					case (int)16: {
...
HXDLIN(1796)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
...
HXDLIN(1755)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
...
HXDLIN(1759)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = this1;
...
HXLINE(1835)		HX_VARI(  ::openfl::geom::Matrix,parentTransform) = this->_hx___owner->_hx___renderTransform;
HXLINE(1836)		HX_VARI( Float,scaleX) = ((Float)1.0);
HXDLIN(1836)		HX_VARI( Float,scaleY) = ((Float)1.0);
...
HXLINE(1889)		HX_VARI( Float,width) = (this->_hx___bounds->width * scaleX);
HXLINE(1890)		HX_VARI( Float,height) = (this->_hx___bounds->height * scaleY);
...
HXLINE(1914)		HX_VARI( Float,inverseA) = (( (Float)(1) ) / this->_hx___renderTransform->a);
HXLINE(1915)		HX_VARI( Float,inverseD) = (( (Float)(1) ) / this->_hx___renderTransform->d);
...
HXLINE(1923)		HX_VARI( Float,x) = this->_hx___bounds->x;
HXLINE(1924)		HX_VARI( Float,y) = this->_hx___bounds->y;
HXLINE(1925)		HX_VARI( Float,tx) = (((x * parentTransform->a) + (y * parentTransform->c)) + parentTransform->tx);
HXLINE(1926)		HX_VARI( Float,ty) = (((x * parentTransform->b) + (y * parentTransform->d)) + parentTransform->ty);
...
HXLINE(1940)		HX_VARI( int,newWidth) = ::Math_obj::ceil((width + ((Float)1.0)));
HXLINE(1941)		HX_VARI( int,newHeight) = ::Math_obj::ceil((height + ((Float)1.0)));

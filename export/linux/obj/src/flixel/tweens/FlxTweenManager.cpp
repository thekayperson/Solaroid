...
HXLINE( 826)
HXLINE( 827)		HX_VARI(  ::flixel::tweens::misc::VarTween,tween) =  ::flixel::tweens::misc::VarTween_obj::__alloc( HX_CTX ,Options,::hx::ObjectPtr<OBJ_>(this));
...
HXLINE( 854)
HXLINE( 855)		HX_VARI(  ::flixel::tweens::misc::NumTween,tween) =  ::flixel::tweens::misc::NumTween_obj::__alloc( HX_CTX ,Options,::hx::ObjectPtr<OBJ_>(this));
...
HX_DEFINE_DYNAMIC_FUNC5(FlxTweenManager_obj,num,return )
 ...
 ::flixel::tweens::misc::AngleTween FlxTweenManager_obj::angle( ::flixel::FlxSprite Sprite,Float FromAngle,Float ToAngle,::hx::Null< Float >  __o_Duration, ::Dynamic Options){
            	...
            	HX_STACK_ARG(Options,"Options")
HXLINE( 876)
HXLINE( 877)		HX_VARI(  ::flixel::tweens::misc::AngleTween,tween) =  ::flixel::tweens::misc::AngleTween_obj::__alloc( HX_CTX ,Options,::hx::ObjectPtr<OBJ_>(this));
...
HX_DEFINE_DYNAMIC_FUNC5(FlxTweenManager_obj,angle,return )
 ...
 ::flixel::tweens::misc::ColorTween FlxTweenManager_obj::color( ::flixel::FlxSprite Sprite,::hx::Null< Float >  __o_Duration,int FromColor,int ToColor, ::Dynamic Options){
            	...
            	HX_STACK_ARG(Options,"Options")
HXLINE( 898)
HXLINE( 899)		HX_VARI(  ::flixel::tweens::misc::ColorTween,tween) =  ::flixel::tweens::misc::ColorTween_obj::__alloc( HX_CTX ,Options,::hx::ObjectPtr<OBJ_>(this));
...
HX_DEFINE_DYNAMIC_FUNC5(FlxTweenManager_obj,color,return )
 ...
 ::flixel::tweens::motion::LinearMotion FlxTweenManager_obj::linearMotion( ::flixel::FlxObject Object,Float FromX,Float FromY,Float ToX,Float ToY,::hx::Null< Float >  __o_DurationOrSpeed,::hx::Null< bool >  __o_UseDuration, ::Dynamic Options){
            	...
            	HX_STACK_ARG(Options,"Options")
HXLINE( 924)
HXLINE( 925)		HX_VARI(  ::flixel::tweens::motion::LinearMotion,tween) =  ::flixel::tweens::motion::LinearMotion_obj::__alloc( HX_CTX ,Options,::hx::ObjectPtr<OBJ_>(this));
...
HX_DEFINE_DYNAMIC_FUNC8(FlxTweenManager_obj,linearMotion,return )
 ...
 ::flixel::tweens::motion::QuadMotion FlxTweenManager_obj::quadMotion( ::flixel::FlxObject Object,Float FromX,Float FromY,Float ControlX,Float ControlY,Float ToX,Float ToY,::hx::Null< Float >  __o_DurationOrSpeed,::hx::Null< bool >  __o_UseDuration, ::Dynamic Options){
            	...
            	HX_STACK_ARG(Options,"Options")
HXLINE( 953)
HXLINE( 954)		HX_VARI(  ::flixel::tweens::motion::QuadMotion,tween) =  ::flixel::tweens::motion::QuadMotion_obj::__alloc( HX_CTX ,Options,::hx::ObjectPtr<OBJ_>(this));
...
HX_DEFINE_DYNAMIC_FUNC10(FlxTweenManager_obj,quadMotion,return )
 ...
 ::flixel::tweens::motion::CubicMotion FlxTweenManager_obj::cubicMotion( ::flixel::FlxObject Object,Float FromX,Float FromY,Float aX,Float aY,Float bX,Float bY,Float ToX,Float ToY,::hx::Null< Float >  __o_Duration, ::Dynamic Options){
            	...
            	HX_STACK_ARG(Options,"Options")
HXLINE( 983)
HXLINE( 984)		HX_VARI(  ::flixel::tweens::motion::CubicMotion,tween) =  ::flixel::tweens::motion::CubicMotion_obj::__alloc( HX_CTX ,Options,::hx::ObjectPtr<OBJ_>(this));
...
HX_DEFINE_DYNAMIC_FUNC11(FlxTweenManager_obj,cubicMotion,return )
 ...
 ::flixel::tweens::motion::CircularMotion FlxTweenManager_obj::circularMotion( ::flixel::FlxObject Object,Float CenterX,Float CenterY,Float Radius,Float Angle,bool Clockwise,::hx::Null< Float >  __o_DurationOrSpeed,::hx::Null< bool >  __o_UseDuration, ::Dynamic Options){
            	...
            	HX_STACK_ARG(Options,"Options")
HXLINE(1012)
HXLINE(1013)		HX_VARI(  ::flixel::tweens::motion::CircularMotion,tween) =  ::flixel::tweens::motion::CircularMotion_obj::__alloc( HX_CTX ,Options,::hx::ObjectPtr<OBJ_>(this));
...
HX_DEFINE_DYNAMIC_FUNC9(FlxTweenManager_obj,circularMotion,return )
 ...
 ::flixel::tweens::motion::LinearPath FlxTweenManager_obj::linearPath( ::flixel::FlxObject Object,::Array< ::Dynamic> Points,::hx::Null< Float >  __o_DurationOrSpeed,::hx::Null< bool >  __o_UseDuration, ::Dynamic Options){
            	...
            	HX_STACK_ARG(Options,"Options")
HXLINE(1035)
HXLINE(1036)		HX_VARI(  ::flixel::tweens::motion::LinearPath,tween) =  ::flixel::tweens::motion::LinearPath_obj::__alloc( HX_CTX ,Options,::hx::ObjectPtr<OBJ_>(this));
HXLINE(1038)		if (::hx::IsNotNull( Points )) {
HXLINE(1040)			int _g = 0;
HXDLIN(1040)			while((_g < Points->length)){
HXLINE(1040)				HX_VARI(  ::flixel::math::FlxPoint,point) = Points->__get(_g).StaticCast<  ::flixel::math::FlxPoint >();
HXDLIN(1040)				_g = (_g + 1);
...
HX_DEFINE_DYNAMIC_FUNC5(FlxTweenManager_obj,linearPath,return )
 ...
 ::flixel::tweens::motion::QuadPath FlxTweenManager_obj::quadPath( ::flixel::FlxObject Object,::Array< ::Dynamic> Points,::hx::Null< Float >  __o_DurationOrSpeed,::hx::Null< bool >  __o_UseDuration, ::Dynamic Options){
            	...
            	HX_STACK_ARG(Options,"Options")
HXLINE(1067)
HXLINE(1068)		HX_VARI(  ::flixel::tweens::motion::QuadPath,tween) =  ::flixel::tweens::motion::QuadPath_obj::__alloc( HX_CTX ,Options,::hx::ObjectPtr<OBJ_>(this));
HXLINE(1070)		if (::hx::IsNotNull( Points )) {
HXLINE(1072)			int _g = 0;
HXDLIN(1072)			while((_g < Points->length)){
HXLINE(1072)				HX_VARI(  ::flixel::math::FlxPoint,point) = Points->__get(_g).StaticCast<  ::flixel::math::FlxPoint >();
HXDLIN(1072)				_g = (_g + 1);
...
HXLINE(1090)
HXLINE(1092)		HX_VARI( ::Array< ::Dynamic>,finishedTweens) = null();
HXLINE(1094)		{
...
HXLINE(1167)				HX_VARI(  ::flixel::tweens::FlxTween,tween) = _g1->__get(_g).StaticCast<  ::flixel::tweens::FlxTween >();
HXDLIN(1167)				_g = (_g + 1);
...
HXLINE(1247)			HX_VARI( int,i) = this->_tweens->length;
HXLINE(1248)			while(true){
HXLINE(1248)				i = (i - 1);
HXDLIN(1248)				if (!(((i + 1) > 0))) {
HXLINE(1248)					goto _hx_goto_35;
            				}
HXLINE(1250)				HX_VARI(  ::flixel::tweens::FlxTween,tween) = this->_tweens->__get(i).StaticCast<  ::flixel::tweens::FlxTween >();
...
HXLINE(1258)			HX_VARI( ::Array< ::Dynamic>,propertyInfos) = ::Array_obj< ::Dynamic>::__new();
HXLINE(1259)			{
HXLINE(1259)				int _g = 0;
HXDLIN(1259)				while((_g < FieldPaths->length)){
HXLINE(1259)					HX_VARI( ::String,fieldPath) = FieldPaths->__get(_g);
HXDLIN(1259)					_g = (_g + 1);
HXLINE(1261)					HX_VARI(  ::Dynamic,target) = Object;
HXLINE(1262)					HX_VARI( ::Array< ::String >,path) = fieldPath.split(HX_(".",2e,00,00,00));
HXLINE(1263)					HX_VARI( ::String,field) = ( (::String)(path->pop()) );
HXLINE(1264)					{
HXLINE(1264)						int _g1 = 0;
HXDLIN(1264)						while((_g1 < path->length)){
HXLINE(1264)							HX_VARI( ::String,component) = path->__get(_g1);
...
HXLINE(1275)			HX_VARI( int,i) = this->_tweens->length;
HXLINE(1276)			while(true){
HXLINE(1276)				i = (i - 1);
HXDLIN(1276)				if (!(((i + 1) > 0))) {
HXLINE(1276)					goto _hx_goto_38;
            				}
HXLINE(1278)				HX_VARI(  ::flixel::tweens::FlxTween,tween) = this->_tweens->__get(i).StaticCast<  ::flixel::tweens::FlxTween >();
HXLINE(1279)				{
HXLINE(1279)					int _g = 0;
HXDLIN(1279)					while((_g < propertyInfos->length)){
HXLINE(1279)						HX_VARI(  ::Dynamic,info) = propertyInfos->__get(_g);
HXDLIN(1279)						_g = (_g + 1);
...
HXDLIN(1306)			HX_VARI(  ::flixel::tweens::FlxTween,tween) = _g1->__get(_g).StaticCast<  ::flixel::tweens::FlxTween >();
HXDLIN(1306)			_g = (_g + 1);
...
HXDLIN(1319)			HX_VARI(  ::flixel::tweens::FlxTween,tween) = _g1->__get(_g).StaticCast<  ::flixel::tweens::FlxTween >();
HXDLIN(1319)			_g = (_g + 1);

...
HXLINE( 566)		HX_VARI( int,type) = (this->type & ~(16));
...
HXLINE( 695)
HXLINE( 696)		HX_VARI( Float,dly) = ::Math_obj::abs(value);
...
Float FlxTween_obj::set_loopDelay( ::Dynamic value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 705)
HXLINE( 706)		HX_VARI( Float,dly) = ::Math_obj::abs(( (Float)(value) ));

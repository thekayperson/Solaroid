...
HXLINE( 332)				HX_VARI(  ::flixel::text::FlxTextFormatMarkerPair,rule) = rules->__get(_g1).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >();
...
HXDLIN( 336)				HX_VARI( int,i) = (_g2 - 1);
HXLINE( 339)				HX_VARI( int,delIndex) = rangeStarts->__get(i);
HXLINE( 340)				HX_VARI( int,markerLength) = ::_UnicodeString::UnicodeString_Impl__obj::get_length(rulesToApply->__get(i).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >()->marker);
HXLINE( 343)				{
HXLINE( 343)					int _g = 0;
HXDLIN( 343)					int _g1 = rangeStarts->length;
HXDLIN( 343)					while((_g < _g1)){
HXLINE( 343)						_g = (_g + 1);
HXDLIN( 343)						HX_VARI( int,j) = (_g - 1);
...
HXDLIN( 359)						HX_VARI( int,j) = (_g3 - 1);
...
HXDLIN( 376)				HX_VARI( int,i) = (_g4 - 1);
...
HXLINE( 788)		HX_VARI( Float,newWidth) = this->textField->get_width();
HXLINE( 790)		HX_VARI( Float,newHeight) = (this->textField->get_textHeight() + 4);
...
void FlxText_obj::applyBorderStyle(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 921)
HXLINE( 922)		HX_VARI( int,iterations) = ::Std_obj::_hx_int((this->borderSize * this->borderQuality));
HXLINE( 923)		if ((iterations <= 0)) {
HXLINE( 925)			iterations = 1;
            		}
HXLINE( 927)		HX_VARI( Float,delta) = (this->borderSize / ( (Float)(iterations) ));
...
HXLINE( 948)				HX_VARI( Float,curDelta) = delta;
HXLINE( 949)				{
HXLINE( 949)					int _g = 0;
HXDLIN( 949)					int _g1 = iterations;
HXDLIN( 949)					while((_g < _g1)){
HXLINE( 949)						_g = (_g + 1);
HXDLIN( 949)						HX_VARI( int,i) = (_g - 1);
HXLINE( 951)						{
...
HXLINE( 970)				HX_VARI( Float,curDelta) = delta;
HXLINE( 971)				{
HXLINE( 971)					int _g = 0;
HXDLIN( 971)					int _g1 = iterations;
HXDLIN( 971)					while((_g < _g1)){
HXLINE( 971)						_g = (_g + 1);
HXDLIN( 971)						HX_VARI( int,i) = (_g - 1);
HXLINE( 973)						{
...
void FlxText_obj::copyTextWithOffset(Float x,Float y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE(1003)
HXLINE(1004)		HX_VAR(  ::openfl::display::BitmapData,graphic);
...
HXLINE(1017)				HX_VARI(  ::flixel::text::_FlxText::FlxTextFormatRange,formatRange) = _g1->__get(_g).StaticCast<  ::flixel::text::_FlxText::FlxTextFormatRange >();
HXDLIN(1017)				_g = (_g + 1);
...
HXLINE(1026)					HX_VARI(  ::openfl::text::TextFormat,textFormat) = formatRange->format->format;
...
HX_DEFINE_DYNAMIC_FUNC3(FlxText_obj,copyTextFormat,(void))
 ...
 ::openfl::text::TextFormat FlxText_obj::dtfCopy(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1053)
HXLINE(1054)		HX_VARI(  ::openfl::text::TextFormat,dtf) = this->textField->get_defaultTextFormat();

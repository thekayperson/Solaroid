...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxVector_Impl__obj,weak,return )
 ...
 ::flixel::math::FlxPoint FlxVector_Impl__obj::_new(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE( 100)
HXDLIN( 100)		HX_VARI(  ::flixel::math::FlxPoint,this1) =  ::flixel::math::FlxPoint_obj::__alloc( HX_CTX ,x,y);
...
Float FlxVector_Impl__obj::dotProduct( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE( 281)
HXLINE( 282)		HX_VARI( Float,dp) = ((this1->x * v->x) + (this1->y * v->y));
...
Float FlxVector_Impl__obj::dotProdWithNormalizing( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE( 306)
HXLINE( 307)		HX_VARI(  ::flixel::math::FlxPoint,normalized) = ::flixel::math::_FlxVector::FlxVector_Impl__obj::normalize(::flixel::math::_FlxVector::FlxVector_Impl__obj::clone(v,::flixel::math::_FlxVector::FlxVector_Impl__obj::_vector1));
...
Float FlxVector_Impl__obj::crossProductLength( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE( 330)
HXLINE( 331)		HX_VARI( Float,cp) = ((this1->x * v->y) - (this1->y * v->x));
...
bool FlxVector_Impl__obj::isParallel( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE( 355)
HXLINE( 356)		HX_VARI( bool,p) = (::Math_obj::abs(((this1->x * v->y) - (this1->y * v->x))) < ((Float)9.99999999999999841e-15));
...
HXLINE( 419)
HXLINE( 420)		HX_VARI( Float,s) = ::Math_obj::sin(rads);
HXLINE( 421)		HX_VARI( Float,c) = ::Math_obj::cos(rads);
HXLINE( 422)		HX_VARI( Float,tempX) = this1->x;
...
HXLINE( 449)
HXLINE( 450)		HX_VARI( Float,tempX) = this1->x;
...
HXLINE( 536)
HXLINE( 537)		HX_VARI( Float,dp) = ((this1->x * v->x) + (this1->y * v->y));
HXLINE( 538)		HX_VARI( Float,lenSq) = ((v->x * v->x) + (v->y * v->y));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxVector_Impl__obj,projectToNormalized,return )
 ...
 ::flixel::math::FlxPoint FlxVector_Impl__obj::projectToNormalizedWeak( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint v, ::flixel::math::FlxPoint proj){
            	...
            	HX_STACK_ARG(proj,"proj")
HXLINE( 573)
HXLINE( 574)		HX_VARI( Float,dp) = ((this1->x * v->x) + (this1->y * v->y));
...
Float FlxVector_Impl__obj::perpProduct( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE( 588)
HXLINE( 589)		HX_VARI( Float,pp) = ((this1->y * v->x) + (-(this1->x) * v->y));
...
Float FlxVector_Impl__obj::radiansBetween( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE( 724)
HXLINE( 725)		HX_VARI( Float,rads) = ::Math_obj::acos((((this1->x * v->x) + (this1->y * v->y)) / (::Math_obj::sqrt(((this1->x * this1->x) + (this1->y * this1->y))) * ::Math_obj::sqrt(((v->x * v->x) + (v->y * v->y))))));
...
int FlxVector_Impl__obj::sign( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint a, ::flixel::math::FlxPoint b){
            	...
            	HX_STACK_ARG(b,"b")
HXLINE( 748)
HXLINE( 749)		HX_VARI( Float,signFl) = (((a->x - this1->x) * (b->y - this1->y)) - ((a->y - this1->y) * (b->x - this1->x)));
...
Float FlxVector_Impl__obj::distSquared( ::flixel::math::FlxPoint this1, ::flixel::math::FlxPoint v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE( 771)
HXLINE( 772)		HX_VARI( Float,dx) = (v->x - this1->x);
HXLINE( 773)		HX_VARI( Float,dy) = (v->y - this1->y);
...
HXLINE( 786)
HXLINE( 787)		HX_VARI( Float,d) = ((1 + bounceCoeff) * ((this1->x * normal->x) + (this1->y * normal->y)));
...
HXDLIN( 804)		HX_VARI(  ::flixel::math::FlxPoint,p1) = proj->set((dp * v->x),(dp * v->y));
...
HXDLIN( 805)		HX_VARI(  ::flixel::math::FlxPoint,p2) = proj1->set((dp1 * normal->x),(dp1 * normal->y));
HXLINE( 806)		HX_VARI( Float,bounceX) = -(p2->x);
HXLINE( 807)		HX_VARI( Float,bounceY) = -(p2->y);
HXLINE( 808)		HX_VARI( Float,frictionX) = p1->x;
HXLINE( 809)		HX_VARI( Float,frictionY) = p1->y;
...
HXLINE( 889)			HX_VARI( Float,a) = ::flixel::math::_FlxVector::FlxVector_Impl__obj::get_radians(this1);
...
Float FlxVector_Impl__obj::set_radians( ::flixel::math::FlxPoint this1,Float rads){
            	...
            	HX_STACK_ARG(rads,"rads")
HXLINE( 921)
HXLINE( 922)		HX_VARI( Float,len) = ::Math_obj::sqrt(((this1->x * this1->x) + (this1->y * this1->y)));

...
Float FlxPoint_obj::distanceTo( ::flixel::math::FlxPoint point){
            	...
            	HX_STACK_ARG(point,"point")
HXLINE( 317)
HXLINE( 318)		HX_VARI( Float,dx) = (this->x - point->x);
HXLINE( 319)		HX_VARI( Float,dy) = (this->y - point->y);
...
HXLINE( 362)
HXLINE( 363)		HX_VARI( Float,radians) = (Angle * (::Math_obj::PI / ( (Float)(180) )));
...
HXLINE( 367)		HX_VARI( Float,dx) = (this->x - Pivot->x);
HXLINE( 368)		HX_VARI( Float,dy) = (this->y - Pivot->y);
...
Float FlxPoint_obj::angleBetween( ::flixel::math::FlxPoint point){
            	...
            	HX_STACK_ARG(point,"point")
HXLINE( 383)
HXLINE( 384)		HX_VARI( Float,x) = (point->x - this->x);
HXLINE( 385)		HX_VARI( Float,y) = (point->y - this->y);
HXLINE( 386)		HX_VARI( Float,angle) = ( (Float)(0) );
...
HXLINE( 390)			HX_VARI( Float,c1) = (::Math_obj::PI * ((Float)0.25));
HXLINE( 391)			HX_VARI( Float,c2) = (( (Float)(3) ) * c1);
HXLINE( 392)			HX_VAR( Float,ay);
HXDLIN( 392)			if ((y < 0)) {
HXLINE( 392)				ay = -(y);
            			}
            			else {
...
HXLINE( 452)
HXLINE( 453)		HX_VARI( Float,x1) = (((this->x * matrix->a) + (this->y * matrix->c)) + matrix->tx);
HXLINE( 454)		HX_VARI( Float,y1) = (((this->x * matrix->b) + (this->y * matrix->d)) + matrix->ty);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxPoint_obj,set_y,return )
 ...
 ::flixel::math::FlxPoint FlxPoint_obj::get(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y){
            	...
            	HX_STACK_ARG(Y,"Y")
HXLINE(  28)
HXLINE(  29)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
...
HXDLIN(  44)		HX_VARI(  ::flixel::math::FlxPoint,point1) = point;

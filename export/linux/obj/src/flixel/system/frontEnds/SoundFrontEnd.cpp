...
HXLINE( 135)		HX_VARI(  ::flixel::_hx_system::FlxSound,sound) = this->list->recycle(::hx::ClassOf< ::flixel::_hx_system::FlxSound >(),null(),null(),null()).StaticCast<  ::flixel::_hx_system::FlxSound >();
...
HXLINE( 147)			HX_VARI(  ::Dynamic,loadCallback) = OnLoad;
...
HXDLIN( 202)			HX_VARI( ::String,id) = _g1->__get(_g);
HXDLIN( 202)			_g = (_g + 1);
...
HXLINE( 227)		HX_VARI(  ::flixel::_hx_system::FlxSound,sound) = this->list->recycle(::hx::ClassOf< ::flixel::_hx_system::FlxSound >(),null(),null(),null()).StaticCast<  ::flixel::_hx_system::FlxSound >()->loadEmbedded(EmbeddedSound,Looped,AutoDestroy,OnComplete);
...
HXLINE( 261)				HX_VARI(  ::flixel::_hx_system::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::FlxSound >();
HXDLIN( 261)				_g = (_g + 1);
...
HXLINE( 280)				HX_VARI(  ::flixel::_hx_system::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::FlxSound >();
HXDLIN( 280)				_g = (_g + 1);
...
HXLINE( 302)				HX_VARI(  ::flixel::_hx_system::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::FlxSound >();
HXDLIN( 302)				_g = (_g + 1);
...
HXLINE( 391)				HX_VARI(  ::flixel::_hx_system::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::FlxSound >();
HXDLIN( 391)				_g = (_g + 1);
...
HXLINE( 408)				HX_VARI(  ::flixel::_hx_system::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::FlxSound >();
HXDLIN( 408)				_g = (_g + 1);

...
HXLINE(  32)				HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN(  32)				_g = (_g + 1);
...
HXLINE(  53)				HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN(  53)				_g = (_g + 1);
...
HX_DEFINE_DYNAMIC_FUNC1(PluginFrontEnd_obj,get,return )
 ...
 ::Dynamic PluginFrontEnd_obj::remove( ::Dynamic Plugin){
            	...
            	HX_STACK_ARG(Plugin,"Plugin")
HXLINE(  71)
HXLINE(  73)		HX_VARI( int,i) = (this->list->length - 1);
HXLINE(  75)		while((i >= 0)){
...
bool PluginFrontEnd_obj::removeType(::hx::Class ClassType){
            	...
            	HX_STACK_ARG(ClassType,"ClassType")
HXLINE(  95)
HXLINE(  97)		HX_VARI( bool,results) = false;
HXLINE(  98)		HX_VARI( int,i) = (this->list->length - 1);
...
HXDLIN( 126)			HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN( 126)			_g = (_g + 1);
...
HXDLIN( 141)			HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN( 141)			_g = (_g + 1);

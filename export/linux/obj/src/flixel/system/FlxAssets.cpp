...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxAssets_obj,resolveKey,return )
 ...
 ::openfl::media::Sound FlxAssets_obj::getSound(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 221)
HXLINE( 222)		HX_VARI( ::String,extension) = HX_("",00,00,00,00);
...
HXLINE( 232)
HXLINE( 233)		HX_VARI(  ::flixel::_hx_system::GraphicVirtualInput,bitmapData) =  ::flixel::_hx_system::GraphicVirtualInput_obj::__alloc( HX_CTX ,0,0,null(),null());
HXLINE( 238)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::graphics::FlxGraphic_obj::fromBitmapData(bitmapData,null(),null(),null());

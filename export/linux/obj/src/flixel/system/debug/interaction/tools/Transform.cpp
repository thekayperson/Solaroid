...
HXLINE( 256)		HX_VARI( Float,originX) = (this->_markers->__get(0).StaticCast<  ::flixel::math::FlxPoint >()->x + (outlineWidth / ( (Float)(2) )));
HXLINE( 257)		HX_VARI( Float,originY) = (this->_markers->__get(0).StaticCast<  ::flixel::math::FlxPoint >()->y + (outlineHeight / ( (Float)(2) )));
...
HXLINE( 261)				HX_VARI(  ::flixel::math::FlxPoint,marker) = _g1->__get(_g).StaticCast<  ::flixel::math::FlxPoint >();
HXDLIN( 261)				_g = (_g + 1);
...
HXLINE( 338)				HX_VARI(  ::flixel::FlxObject,member1) = member->next().StaticCast<  ::flixel::FlxObject >();

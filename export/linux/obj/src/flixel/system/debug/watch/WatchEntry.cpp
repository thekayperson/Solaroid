...
HXLINE(  75)
HXLINE(  76)		HX_VARI( Float,textWidth) = ((windowWidth - this->removeButton->get_width()) - ( (Float)(4) ));
...
HXDLIN(  92)			switch((int)(_g->_hx_getIndex())){
            				case (int)0: {
HXLINE(  94)					HX_VARI(  ::Dynamic,object) = _g->_hx_getObject(0);
HXDLIN(  94)					HX_VARI( ::String,field) = _g->_hx_getString(1);
...
HXDLIN(  96)					{
HXLINE(  96)						HX_VARI( ::String,expression) = _g->_hx_getString(0);
...
HXLINE( 105)		HX_VARI( Float,currentWidth) = (this->nameText->get_textWidth() + 4);
...
HXDLIN( 111)		switch((int)(_g->_hx_getIndex())){
            			case (int)0: {
HXLINE( 113)				HX_VARI(  ::Dynamic,object) = _g->_hx_getObject(0);
HXDLIN( 113)				HX_VARI( ::String,field) = _g->_hx_getString(1);
HXLINE( 114)				return ::Reflect_obj::getProperty(object,field);
            			}
            			break;
            			case (int)1: {
HXLINE( 121)				HX_VARI( ::String,value) = _g->_hx_getString(0);
HXLINE( 122)				return value;
            			}
            			break;
            			case (int)2: {
HXLINE( 115)				::String _g1 = _g->_hx_getString(0);
HXDLIN( 115)				HX_VARI(  ::hscript::Expr,parsedExpr) = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXLINE( 138)			HX_VARI(  ::Dynamic,object) = _g->_hx_getObject(0);
HXDLIN( 138)			HX_VARI( ::String,field) = _g->_hx_getString(1);

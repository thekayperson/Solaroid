...
HXLINE( 108)				_g = (_g + 1);
HXDLIN( 108)				HX_VARI( int,i) = (_g - 1);
HXLINE( 110)				HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = this->entries->__get(i).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
...
HXDLIN( 120)			HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
HXDLIN( 120)			_g = (_g + 1);
...
HXLINE( 135)			HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = this->entries->__get(i).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
...
HXLINE( 152)
HXLINE( 153)		HX_VARI( Float,max) = ((Float)0.0);
HXLINE( 154)		{
HXLINE( 154)			int _g = 0;
HXDLIN( 154)			::Array< ::Dynamic> _g1 = this->entries;
HXDLIN( 154)			while((_g < _g1->length)){
HXLINE( 154)				HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
HXDLIN( 154)				_g = (_g + 1);
HXLINE( 156)				HX_VARI( Float,value) = ( (Float)(getValue(entry)) );

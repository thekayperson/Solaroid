...
HXDLIN( 155)			HX_VARI(  ::flixel::math::FlxPoint,delta) = point;
...
HXDLIN( 175)		HX_VARI( int,newWidth1) = ::Std_obj::_hx_int((( (Float)(newWidth) ) - this->_canvasBitmap->get_x()));
HXLINE( 176)		int newHeight = this->_height;
HXDLIN( 176)		Float newHeight1 = (( (Float)(newHeight) ) - this->_canvasBitmap->get_y());
HXDLIN( 176)		HX_VARI( int,newHeight2) = ::Std_obj::_hx_int((newHeight1 - this->_footer->get_height()));

...
HXLINE( 295)			HX_VARI(  ::flixel::math::FlxPoint,targetPosition) = this->_target->getPosition(null());
...
HXLINE( 707)			HX_VARI(  ::flixel::_hx_system::FlxSoundGroup,oldGroup) = this->group;

...
HXDLIN( 406)		HX_VARI(  ::flixel::math::FlxPoint,resultBorder) = point1->addPoint(this->border)->addPoint(border);
...
HXLINE(  80)				HX_VARI( ::String,frameName) = _g1->__get(_g);
HXDLIN(  80)				_g = (_g + 1);
...
HXDLIN( 100)		HX_VARI(  ::flixel::math::FlxPoint,sourceSize) = point;
...
HXDLIN( 101)		HX_VARI(  ::flixel::math::FlxPoint,offset) = point1;
...
HXDLIN( 176)				HX_VARI(  ::flixel::math::FlxRect,rect1) = rect;
...
HXDLIN( 181)				HX_VARI(  ::flixel::math::FlxPoint,sourceSize) = point;
...
HXDLIN( 196)				HX_VARI(  ::flixel::math::FlxPoint,offset) = point1;
...
HXDLIN( 246)		HX_VARI(  ::Xml,data) = this1;
HXLINE( 248)		{
HXLINE( 248)			int _g = 0;
...
HXDLIN( 256)				HX_VARI(  ::flixel::math::FlxRect,rect1) = rect;
...
HXDLIN( 271)				HX_VARI(  ::flixel::math::FlxPoint,offset) = point;
...
HXDLIN( 272)				HX_VARI(  ::flixel::math::FlxPoint,sourceSize) = point1;
...
HXLINE( 313)				HX_VARI(  ::Xml,sprite1) = ( ( ::Xml)(sprite->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXDLIN( 319)				HX_VARI(  ::flixel::math::FlxPoint,offset) = point;
...
HXDLIN( 320)				HX_VARI(  ::flixel::math::FlxRect,rect1) = rect;
...
HXDLIN( 321)				HX_VARI(  ::flixel::math::FlxPoint,sourceSize) = point1;
...
HXDLIN( 372)				HX_VARI(  ::flixel::math::FlxRect,rect1) = rect;
...
HXDLIN( 374)				HX_VARI(  ::flixel::math::FlxPoint,sourceSize) = point;
...
HXDLIN( 375)				HX_VARI(  ::flixel::math::FlxPoint,offset) = point1;

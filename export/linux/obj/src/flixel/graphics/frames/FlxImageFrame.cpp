...
HXDLIN( 237)		HX_VARI(  ::flixel::math::FlxPoint,resultBorder) = point1->addPoint(this->border)->addPoint(border);
HXLINE( 239)		 ::flixel::graphics::FlxGraphic imageFrame = this->parent;
HXDLIN( 239)		HX_VARI(  ::flixel::graphics::frames::FlxImageFrame,imageFrame1) = ::flixel::graphics::frames::FlxImageFrame_obj::findFrame(imageFrame,this->get_frame()->frame,resultBorder);

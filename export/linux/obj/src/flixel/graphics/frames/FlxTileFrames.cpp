...
HXDLIN( 517)		HX_VARI(  ::flixel::math::FlxPoint,resultBorder) = point->addPoint(this->border)->addPoint(border);
...
HXDLIN( 518)		HX_VARI(  ::flixel::math::FlxPoint,resultSize) = _this1;
...
HXDLIN(  94)		HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,tileFrames) = ::flixel::graphics::frames::FlxTileFrames_obj::fromGraphic(result,_this,null(),tileSpacing);
...
HXDLIN( 160)						HX_VARI( int,i) = (_g1 - 1);
...
HXLINE( 206)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = Frames->__get(_g1).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXDLIN( 240)			HX_VARI( ::String,postFix1) = name.substring(postFix,name.length);
...
HXDLIN( 303)						HX_VARI( int,i) = (_g1 - 1);
...
HXLINE( 437)				HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,collection) = tileframes->__get(_g1).StaticCast<  ::flixel::graphics::frames::FlxTileFrames >();
HXDLIN( 437)				_g1 = (_g1 + 1);
HXLINE( 439)				{
HXLINE( 439)					int _g = 0;
HXDLIN( 439)					::Array< ::Dynamic> _g2 = collection->frames;
HXDLIN( 439)					while((_g < _g2->length)){
HXLINE( 439)						HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _g2->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 439)						_g = (_g + 1);

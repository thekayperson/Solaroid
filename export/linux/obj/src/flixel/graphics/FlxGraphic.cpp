...
void FlxGraphic_obj::undump(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 426)
HXLINE( 427)		HX_VARI(  ::openfl::display::BitmapData,newBitmap) = this->getBitmapFromSystem();
...
HXLINE( 456)		HX_VARI( bool,dumped) = this->isDumped;
...
HXLINE( 484)		HX_VAR( ::Array< ::Dynamic>,collections);
HXLINE( 485)		{
HXLINE( 485)			int _g = 0;
HXDLIN( 485)			::Array< ::Dynamic> _g1 = this->frameCollectionTypes;
HXDLIN( 485)			while((_g < _g1->length)){
HXLINE( 485)				HX_VARI(  ::flixel::graphics::frames::FlxFrameCollectionType,collectionType) = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrameCollectionType >();
HXDLIN( 485)				_g = (_g + 1);
...
HXDLIN( 504)			HX_VARI( ::cpp::VirtualArray,collections1) = collections;
...
HXLINE( 516)
HXLINE( 517)		HX_VARI( ::cpp::VirtualArray,collections) = ( (::cpp::VirtualArray)(this->frameCollections->get(type)) );
...
HXLINE( 534)
HXLINE( 535)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) =  ::flixel::graphics::frames::FlxFrame_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),null(),null(),null());
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,getEmptyFrame,return )
 ...
 ::openfl::display::BitmapData FlxGraphic_obj::getBitmapFromSystem(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 570)
HXLINE( 571)		HX_VARI(  ::openfl::display::BitmapData,newBitmap) = null();

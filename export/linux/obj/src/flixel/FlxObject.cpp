...
HXDLIN( 750)		HX_VARI( Float,velocityDelta1) = (((Float)0.5) * (velocityDelta - this->angularVelocity));
...
HXLINE( 757)		HX_VARI( Float,delta) = (this->velocity->x * elapsed);
...
HXLINE( 794)
HXLINE( 795)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
...
HXLINE( 805)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(ObjectOrGroup) );
HXLINE( 806)			return tilemap->overlaps(::hx::ObjectPtr<OBJ_>(this),InScreenSpace,Camera);
            		}
HXLINE( 809)		HX_VARI(  ::flixel::FlxObject,object) = ( ( ::flixel::FlxObject)(ObjectOrGroup) );
...
bool FlxObject_obj::overlapsAt(Float X,Float Y, ::flixel::FlxBasic ObjectOrGroup,::hx::Null< bool >  __o_InScreenSpace, ::flixel::FlxCamera Camera){
            	...
            	HX_STACK_ARG(Camera,"Camera")
HXLINE( 853)
HXLINE( 854)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
...
HXLINE( 866)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(ObjectOrGroup) );
HXLINE( 867)			return tilemap->overlapsAt((tilemap->x - (X - this->x)),(tilemap->y - (Y - this->y)),::hx::ObjectPtr<OBJ_>(this),InScreenSpace,Camera);
            		}
HXLINE( 870)		HX_VARI(  ::flixel::FlxObject,object) = ( ( ::flixel::FlxObject)(ObjectOrGroup) );
...
HXLINE( 880)		HX_VARI(  ::flixel::math::FlxPoint,objectScreenPos) = object->getScreenPosition(null(),Camera);
...
HXLINE( 914)		HX_VARI( Float,xPos) = (point->x - Camera->scroll->x);
HXLINE( 915)		HX_VARI( Float,yPos) = (point->y - Camera->scroll->y);
...
HXLINE(1112)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(1112)				_g = (_g + 1);
...
HXLINE(1132)		HX_VARI(  ::flixel::math::FlxRect,rect) = this->getBoundingBox(camera);
HXLINE(1133)		HX_VAR(  ::openfl::display::Graphics,gfx);
...
HXLINE(1139)
HXLINE(1141)		HX_VARI(  ::Dynamic,color) = this->debugBoundingBoxColor;
...
HXLINE( 103)
HXLINE( 104)		HX_VARI( bool,separatedX) = ::flixel::FlxObject_obj::separateX(Object1,Object2);
HXLINE( 105)		HX_VARI( bool,separatedY) = ::flixel::FlxObject_obj::separateY(Object1,Object2);
...
bool FlxObject_obj::updateTouchingFlags( ::flixel::FlxObject Object1, ::flixel::FlxObject Object2){
            	...
            	HX_STACK_ARG(Object2,"Object2")
HXLINE( 118)
HXLINE( 119)		HX_VARI( bool,touchingX) = ::flixel::FlxObject_obj::updateTouchingFlagsX(Object1,Object2);
HXLINE( 120)		HX_VARI( bool,touchingY) = ::flixel::FlxObject_obj::updateTouchingFlagsY(Object1,Object2);
...
HXLINE( 131)
HXLINE( 132)		HX_VARI( Float,overlap) = ( (Float)(0) );
HXLINE( 134)		HX_VARI( Float,obj1delta) = (Object1->x - Object1->last->x);
HXLINE( 135)		HX_VARI( Float,obj2delta) = (Object2->x - Object2->last->x);
HXLINE( 137)		if ((obj1delta != obj2delta)) {
HXLINE( 140)			HX_VAR( Float,obj1deltaAbs);
...
HXLINE( 141)			HX_VAR( Float,obj2deltaAbs);
...
HXDLIN( 143)			HX_VARI(  ::flixel::math::FlxRect,obj1rect) = _this;
...
HXDLIN( 145)			HX_VARI(  ::flixel::math::FlxRect,obj2rect) = _this1;
...
HXLINE( 153)				HX_VAR( Float,maxOverlap);
...
bool FlxObject_obj::separateX( ::flixel::FlxObject Object1, ::flixel::FlxObject Object2){
            	...
            	HX_STACK_ARG(Object2,"Object2")
HXLINE( 199)
HXLINE( 201)		HX_VARI( bool,obj1immovable) = Object1->immovable;
HXLINE( 202)		HX_VARI( bool,obj2immovable) = Object2->immovable;
...
HXLINE( 211)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object1) );
...
HXLINE( 216)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
HXLINE( 217)			return tilemap->overlapsWithCallback(Object1,::flixel::FlxObject_obj::separateX_dyn(),true,null());
            		}
HXLINE( 220)		HX_VARI( Float,overlap) = ::flixel::FlxObject_obj::computeOverlapX(Object1,Object2,null());
HXLINE( 222)		if ((overlap != 0)) {
HXLINE( 224)			HX_VARI( Float,obj1v) = Object1->velocity->x;
HXLINE( 225)			HX_VARI( Float,obj2v) = Object2->velocity->x;
...
HXDLIN( 233)				HX_VARI( Float,obj1velocity1) = (::Math_obj::sqrt((((obj2v * obj2v) * Object2->mass) / Object1->mass)) * ( (Float)(obj1velocity) ));
...
HXDLIN( 234)				HX_VARI( Float,obj2velocity1) = (::Math_obj::sqrt((((obj1v * obj1v) * Object1->mass) / Object2->mass)) * ( (Float)(obj2velocity) ));
HXLINE( 235)				HX_VARI( Float,average) = ((obj1velocity1 + obj2velocity1) * ((Float)0.5));
...
HXLINE( 269)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object1) );
...
HXLINE( 274)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
...
Float FlxObject_obj::computeOverlapY( ::flixel::FlxObject Object1, ::flixel::FlxObject Object2,::hx::Null< bool >  __o_checkMaxOverlap){
            	...
            	HX_STACK_ARG(checkMaxOverlap,"checkMaxOverlap")
HXLINE( 288)
HXLINE( 289)		HX_VARI( Float,overlap) = ( (Float)(0) );
HXLINE( 291)		HX_VARI( Float,obj1delta) = (Object1->y - Object1->last->y);
HXLINE( 292)		HX_VARI( Float,obj2delta) = (Object2->y - Object2->last->y);
HXLINE( 294)		if ((obj1delta != obj2delta)) {
HXLINE( 297)			HX_VAR( Float,obj1deltaAbs);
...
HXLINE( 298)			HX_VAR( Float,obj2deltaAbs);
...
HXDLIN( 300)			HX_VARI(  ::flixel::math::FlxRect,obj1rect) = _this;
...
HXDLIN( 302)			HX_VARI(  ::flixel::math::FlxRect,obj2rect) = _this1;
...
HXLINE( 310)				HX_VAR( Float,maxOverlap);
...
bool FlxObject_obj::separateY( ::flixel::FlxObject Object1, ::flixel::FlxObject Object2){
            	...
            	HX_STACK_ARG(Object2,"Object2")
HXLINE( 356)
HXLINE( 358)		HX_VARI( bool,obj1immovable) = Object1->immovable;
HXLINE( 359)		HX_VARI( bool,obj2immovable) = Object2->immovable;
...
HXLINE( 368)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object1) );
...
HXLINE( 373)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
HXLINE( 374)			return tilemap->overlapsWithCallback(Object1,::flixel::FlxObject_obj::separateY_dyn(),true,null());
            		}
HXLINE( 377)		HX_VARI( Float,overlap) = ::flixel::FlxObject_obj::computeOverlapY(Object1,Object2,null());
HXLINE( 379)		if ((overlap != 0)) {
HXLINE( 381)			HX_VARI( Float,obj1delta) = (Object1->y - Object1->last->y);
HXLINE( 382)			HX_VARI( Float,obj2delta) = (Object2->y - Object2->last->y);
HXLINE( 383)			HX_VARI( Float,obj1v) = Object1->velocity->y;
HXLINE( 384)			HX_VARI( Float,obj2v) = Object2->velocity->y;
...
HXDLIN( 392)				HX_VARI( Float,obj1velocity1) = (::Math_obj::sqrt((((obj2v * obj2v) * Object2->mass) / Object1->mass)) * ( (Float)(obj1velocity) ));
...
HXDLIN( 393)				HX_VARI( Float,obj2velocity1) = (::Math_obj::sqrt((((obj1v * obj1v) * Object1->mass) / Object2->mass)) * ( (Float)(obj2velocity) ));
HXLINE( 394)				HX_VARI( Float,average) = ((obj1velocity1 + obj2velocity1) * ((Float)0.5));
...
HXLINE( 438)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object1) );
...
HXLINE( 443)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );

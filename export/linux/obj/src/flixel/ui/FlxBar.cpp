...
HXDLIN( 356)			HX_VARI( ::String,emptyKey5) = (emptyKey + (emptyKey4 + ::StringTools_obj::hex((empty & 255),2)));
...
HXDLIN( 409)			HX_VARI( ::String,filledKey5) = (filledKey + (filledKey4 + ::StringTools_obj::hex((fill & 255),2)));
...
HXDLIN( 753)		HX_VARI( Float,fraction1) = ((fraction - this->min) / this->range);

...
HXLINE( 385)
HXLINE( 386)		HX_VARI(  ::flixel::graphics::FlxGraphic,graph) = ::flixel::FlxG_obj::bitmap->add(Graphic,Unique,Key);
...
HX_DEFINE_DYNAMIC_FUNC6(FlxSprite_obj,loadGraphic,return )
 ...
 ::flixel::FlxSprite FlxSprite_obj::loadRotatedGraphic( ::Dynamic Graphic,::hx::Null< int >  __o_Rotations,::hx::Null< int >  __o_Frame,::hx::Null< bool >  __o_AntiAliasing,::hx::Null< bool >  __o_AutoBuffer,::String Key){
            	...
            	HX_STACK_ARG(Key,"Key")
HXLINE( 428)
HXLINE( 429)		HX_VARI(  ::flixel::graphics::FlxGraphic,brushGraphic) = ::flixel::FlxG_obj::bitmap->add(Graphic,false,Key);
HXLINE( 430)		if (::hx::IsNull( brushGraphic )) {
HXLINE( 431)			return ::hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE( 433)		HX_VARI(  ::openfl::display::BitmapData,brush) = brushGraphic->bitmap;
HXLINE( 434)		HX_VARI( ::String,key) = brushGraphic->key;
HXLINE( 436)		if ((Frame >= 0)) {
HXLINE( 439)			HX_VARI( int,brushSize) = brush->height;
HXLINE( 440)			HX_VARI( int,framesNum) = ::Std_obj::_hx_int((( (Float)(brush->width) ) / ( (Float)(brushSize) )));
HXLINE( 441)			if ((framesNum <= Frame)) {
HXLINE( 441)				Frame = ::hx::Mod(Frame,framesNum);
            			}
HXLINE( 442)			key = (key + (HX_(":",3a,00,00,00) + Frame));
HXLINE( 444)			HX_VARI(  ::openfl::display::BitmapData,full) = brush;
...
HXLINE( 453)		HX_VARI(  ::flixel::graphics::FlxGraphic,tempGraph) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
HXLINE( 454)		if (::hx::IsNull( tempGraph )) {
HXLINE( 456)			HX_VARI(  ::openfl::display::BitmapData,bitmap) = ::flixel::util::FlxBitmapDataUtil_obj::generateRotations(brush,Rotations,AntiAliasing,AutoBuffer);
HXLINE( 457)			tempGraph = ::flixel::graphics::FlxGraphic_obj::fromBitmapData(bitmap,false,key,null());
            		}
HXLINE( 460)		HX_VAR( int,max);
...
HX_DEFINE_DYNAMIC_FUNC6(FlxSprite_obj,loadRotatedGraphic,return )
 ...
 ::flixel::FlxSprite FlxSprite_obj::loadRotatedFrame( ::flixel::graphics::frames::FlxFrame Frame,::hx::Null< int >  __o_Rotations,::hx::Null< bool >  __o_AntiAliasing,::hx::Null< bool >  __o_AutoBuffer){
            	...
            	HX_STACK_ARG(AutoBuffer,"AutoBuffer")
HXLINE( 489)
HXLINE( 490)		HX_VARI( ::String,key) = Frame->parent->key;
...
HXLINE( 496)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
...
HX_DEFINE_DYNAMIC_FUNC4(FlxSprite_obj,loadRotatedFrame,return )
 ...
 ::flixel::FlxSprite FlxSprite_obj::makeGraphic(int Width,int Height,::hx::Null< int >  __o_Color,::hx::Null< bool >  __o_Unique,::String Key){
            	...
            	HX_STACK_ARG(Key,"Key")
HXLINE( 524)
HXLINE( 525)		HX_VARI(  ::flixel::graphics::FlxGraphic,graph) = ::flixel::FlxG_obj::bitmap->create(Width,Height,Color,Unique,Key);
...
HXLINE( 592)		HX_VARI( Float,newScaleX) = (( (Float)(Width) ) / ( (Float)(this->frameWidth) ));
HXLINE( 593)		HX_VARI( Float,newScaleY) = (( (Float)(Height) ) / ( (Float)(this->frameHeight) ));
...
HXLINE( 674)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 674)				_g = (_g + 1);
...
HXLINE( 749)		HX_VARI(  ::openfl::display::BitmapData,bitmapData) = Brush->framePixels;
...
HXLINE( 771)			HX_VARI(  ::Dynamic,brushBlend) = Brush->blend;
...
HXLINE( 840)
HXLINE( 841)		HX_VARI( ::Array< ::Dynamic>,positions) = ::flixel::util::FlxBitmapDataUtil_obj::replaceColor(this->graphic->bitmap,Color,NewColor,FetchPositions,null());
...
HXLINE( 915)			HX_VARI(  ::openfl::display::BitmapData,frameData) = this->updateFramePixels();
HXLINE( 916)			int pixelColor = ::Std_obj::_hx_int(this->_flashPoint->x);
HXDLIN( 916)			HX_VARI( int,pixelColor1) = frameData->getPixel32(pixelColor,::Std_obj::_hx_int(this->_flashPoint->y));
...
HXDLIN( 953)		HX_VAR( bool,doFlipX1);
...
HXDLIN( 954)		HX_VAR( bool,doFlipY1);
...
bool FlxSprite_obj::isSimpleRenderBlit( ::flixel::FlxCamera camera){
            	...
            	HX_STACK_ARG(camera,"camera")
HXLINE(1032)
HXLINE(1033)		HX_VAR( bool,result);
...
HXDLIN(1075)		HX_VARI(  ::flixel::math::FlxPoint,scaledOrigin) = point1;
...
HXLINE(1111)			HX_VARI(  ::haxe::ds::StringMap,animations) = this->animation->_animations;
HXLINE(1112)			HX_VARI( bool,reverse) = false;
HXLINE(1113)			HX_VARI( int,index) = 0;
HXLINE(1114)			HX_VARI( int,frameIndex) = this->animation->frameIndex;
HXLINE(1115)			HX_VARI( ::String,currName) = null();
...
HXLINE(1150)
HXLINE(1151)		HX_VARI( ::String,key) = ::flixel::FlxG_obj::bitmap->findKeyForBitmap(Pixels);
...
int FlxSprite_obj::set_facing(int Direction){
            	...
            	HX_STACK_ARG(Direction,"Direction")
HXLINE(1205)
HXLINE(1206)		HX_VARI(  ::Dynamic,flip) = this->_facingFlip->get(Direction);
...
Float FlxSprite_obj::set_angle(Float Value){
            	...
            	HX_STACK_ARG(Value,"Value")
HXLINE(1242)
HXLINE(1243)		HX_VARI( bool,newAngle) = (this->angle != Value);
HXLINE(1244)		HX_VARI( Float,ret) = this->super::set_angle(Value);
...
HXLINE(1258)			HX_VARI( Float,radians) = (this->angle * (::Math_obj::PI / ( (Float)(180) )));
...
HX_DEFINE_DYNAMIC_FUNC1(FlxSprite_obj,set_blend,return )
 ...
 ::flixel::graphics::FlxGraphic FlxSprite_obj::set_graphic( ::flixel::graphics::FlxGraphic Value){
            	...
            	HX_STACK_ARG(Value,"Value")
HXLINE(1277)
HXLINE(1278)		HX_VARI(  ::flixel::graphics::FlxGraphic,oldGraphic) = this->graphic;
...
bool FlxSprite_obj::checkFlipX(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1398)
HXLINE(1399)		HX_VARI( bool,doFlipX) = (this->flipX != this->_frame->flipX);
...
bool FlxSprite_obj::checkFlipY(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1409)
HXLINE(1410)		HX_VARI( bool,doFlipY) = (this->flipY != this->_frame->flipY);

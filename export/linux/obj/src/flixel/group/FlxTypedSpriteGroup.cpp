...
HXLINE( 820)		HX_VARI( Float,minX) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 821)		HX_VARI( Float,maxX) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 823)		{
HXLINE( 823)			int _g = 0;
HXDLIN( 823)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 823)			while((_g < _g1->length)){
HXLINE( 823)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 823)				_g = (_g + 1);
HXLINE( 825)				if (::hx::IsNull( member )) {
HXLINE( 826)					continue;
            				}
HXLINE( 827)				HX_VARI( Float,minMemberX) = member->x;
HXLINE( 828)				HX_VARI( Float,maxMemberX) = (minMemberX + member->get_width());
...
HXLINE( 853)		HX_VARI( Float,minY) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 854)		HX_VARI( Float,maxY) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 856)		{
HXLINE( 856)			int _g = 0;
HXDLIN( 856)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 856)			while((_g < _g1->length)){
HXLINE( 856)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 856)				_g = (_g + 1);
HXLINE( 858)				if (::hx::IsNull( member )) {
HXLINE( 859)					continue;
            				}
HXLINE( 860)				HX_VARI( Float,minMemberY) = member->y;
HXLINE( 861)				HX_VARI( Float,maxMemberY) = (minMemberY + member->get_height());
...
HXDLIN(1026)		return null();
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::makeGraphic(int Width,int Height,::hx::Null< int >  __o__tmp_Color,::hx::Null< bool >  __o_Unique,::String Key){
            	...
            	HX_STACK_ARG(Key,"Key")
HXLINE(1038)
HXDLIN(1038)		HX_VARI( int,Color) = _tmp_Color;

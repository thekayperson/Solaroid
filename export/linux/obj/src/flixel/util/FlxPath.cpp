...
HXLINE( 311)		HX_VARI(  ::flixel::math::FlxPoint,node) = this->_nodes->__get(this->nodeIndex).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 312)		HX_VARI( Float,deltaX) = (node->x - ::flixel::util::FlxPath_obj::_point->x);
HXLINE( 313)		HX_VARI( Float,deltaY) = (node->y - ::flixel::util::FlxPath_obj::_point->y);
HXLINE( 315)		HX_VARI( bool,horizontalOnly) = ((this->_mode & 65536) > 0);
HXLINE( 316)		HX_VARI( bool,verticalOnly) = ((this->_mode & 1048576) > 0);
...
HXLINE( 416)
HXLINE( 417)		if (Snap) {
HXLINE( 419)			HX_VARI(  ::flixel::math::FlxPoint,oldNode) = this->_nodes->__get(this->nodeIndex).StaticCast<  ::flixel::math::FlxPoint >();
...
HXLINE( 437)		HX_VARI( bool,callComplete) = false;
...
HX_DEFINE_DYNAMIC_FUNC3(FlxPath_obj,addPointAt,return )
 ...
 ::flixel::math::FlxPoint FlxPath_obj::remove( ::flixel::math::FlxPoint Node){
            	...
            	HX_STACK_ARG(Node,"Node")
HXLINE( 644)
HXLINE( 645)		HX_VARI( int,index) = this->_nodes->indexOf(Node,null());
...
HXLINE( 721)		HX_VARI(  ::openfl::display::Graphics,gfx) = null();
...
HXLINE( 735)		HX_VAR(  ::flixel::math::FlxPoint,node);
HXLINE( 736)		HX_VAR(  ::flixel::math::FlxPoint,nextNode);
HXLINE( 737)		HX_VARI( int,i) = 0;
HXLINE( 738)		HX_VARI( int,l) = this->_nodes->length;
...
HXLINE( 751)			HX_VARI( int,nodeSize) = 2;
...
HXLINE( 756)			HX_VARI( int,nodeColor) = this->debugColor;
HXLINE( 757)			if ((l > 1)) {
HXLINE( 759)				if ((i == 0)) {
...
HXLINE( 776)			HX_VARI( Float,lineAlpha) = ((Float)0.3);
HXLINE( 777)			if ((i < (l - 1))) {

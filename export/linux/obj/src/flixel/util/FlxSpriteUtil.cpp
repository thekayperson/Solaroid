...
HXLINE( 173)		HX_VARI(  ::flixel::math::FlxRect,viewBounds) = camera->getViewRect(null());
...
HXDLIN( 174)		HX_VARI(  ::flixel::math::FlxPoint,offset) = point;
...
HXLINE( 210)		HX_VARI(  ::flixel::math::FlxRect,spriteBounds) = sprite->getScreenBounds(null(),camera);
HXLINE( 211)		HX_VARI(  ::flixel::math::FlxRect,viewBounds) = camera->getViewRect(null());
...
HXDLIN( 212)		HX_VARI(  ::flixel::math::FlxPoint,offset) = point;
...
HXLINE( 247)
HXLINE( 248)		HX_VARI( Float,prevWidth) = ( (Float)(0) );
HXLINE( 249)		HX_VARI( Float,runningX) = ( (Float)(0) );
...
HXLINE( 264)		HX_VARI( Float,prevHeight) = ( (Float)(0) );
HXLINE( 265)		HX_VARI( Float,runningY) = ( (Float)(0) );
...
HXLINE( 290)		HX_VARI( Float,curX) = ( (Float)(0) );
HXLINE( 291)		HX_VARI( Float,curY) = ( (Float)(0) );
HXLINE( 293)		{
HXLINE( 293)			int _g = 1;
HXDLIN( 293)			int _g1 = objects->length;
HXDLIN( 293)			while((_g < _g1)){
HXLINE( 293)				_g = (_g + 1);
HXDLIN( 293)				HX_VARI( int,i) = (_g - 1);
HXLINE( 295)				HX_VARI(  ::flixel::FlxObject,object) = objects->__get(i).StaticCast<  ::flixel::FlxObject >();
...
HXLINE( 477)			HX_VARI(  ::flixel::math::FlxPoint,midPoint) = sprite->getGraphicMidpoint(null());
HXLINE( 479)			if ((X == -1)) {
...
HXLINE( 489)			HX_VARI( Float,minVal) = ::Math_obj::min(( (Float)(sprite->frameWidth) ),( (Float)(sprite->frameHeight) ));
...
HXLINE( 559)		HX_VARI(  ::flixel::math::FlxPoint,p) = Vertices->shift().StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 560)		::flixel::util::FlxSpriteUtil_obj::flashGfx->moveTo(p->x,p->y);
HXLINE( 561)		{
HXLINE( 561)			int _g = 0;
HXDLIN( 561)			while((_g < Vertices->length)){
HXLINE( 561)				HX_VARI(  ::flixel::math::FlxPoint,p) = Vertices->__get(_g).StaticCast<  ::flixel::math::FlxPoint >();
HXDLIN( 561)				_g = (_g + 1);
...
HXLINE( 637)			HX_VAR(  ::Dynamic,color);

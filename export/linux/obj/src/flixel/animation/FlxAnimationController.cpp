...
HXLINE(  99)				HX_VARI(  ::flixel::animation::FlxAnimation,anim1) = ( ( ::flixel::animation::FlxAnimation)(anim->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 155)					HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 183)		HX_VARI( int,numFrames) = (framesToAdd->length - 1);
HXLINE( 184)		HX_VARI( int,i) = numFrames;
...
HXLINE( 203)			HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,framesToAdd,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::remove(::String Name){
            	...
            	HX_STACK_ARG(Name,"Name")
HXLINE( 214)
HXLINE( 215)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
void FlxAnimationController_obj::append(::String Name,::Array< int > Frames){
            	...
            	HX_STACK_ARG(Frames,"Frames")
HXLINE( 232)
HXLINE( 233)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
HXLINE( 242)		HX_VARI( int,numFrames) = (Frames->length - 1);
...
void FlxAnimationController_obj::appendByNames(::String Name,::Array< ::String > FrameNames){
            	...
            	HX_STACK_ARG(FrameNames,"FrameNames")
HXLINE( 289)
HXLINE( 290)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
HXLINE( 321)			HX_VARI( ::Array< int >,frameIndices) = ::Array_obj< int >::__new();
HXLINE( 323)			this->byStringIndicesHelper(frameIndices,Prefix,Indices,Postfix);
HXLINE( 325)			if ((frameIndices->length > 0)) {
HXLINE( 327)				HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByStringIndices(::String Name,::String Prefix,::Array< ::String > Indices,::String Postfix){
            	...
            	HX_STACK_ARG(Postfix,"Postfix")
HXLINE( 345)
HXLINE( 346)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
HXLINE( 377)			HX_VARI( ::Array< int >,frameIndices) = ::Array_obj< int >::__new();
HXLINE( 379)			this->byIndicesHelper(frameIndices,Prefix,Indices,Postfix);
HXLINE( 381)			if ((frameIndices->length > 0)) {
HXLINE( 383)				HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByIndices(::String Name,::String Prefix,::Array< int > Indices,::String Postfix){
            	...
            	HX_STACK_ARG(Postfix,"Postfix")
HXLINE( 402)
HXLINE( 403)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
int FlxAnimationController_obj::findSpriteFrame(::String Prefix,int Index,::String Postfix){
            	...
            	HX_STACK_ARG(Postfix,"Postfix")
HXLINE( 424)
HXLINE( 425)		HX_VARI( int,numFrames) = this->_sprite->numFrames;
HXLINE( 426)		HX_VARI( ::Array< ::Dynamic>,flxFrames) = this->_sprite->frames->frames;
HXLINE( 427)		{
HXLINE( 427)			int _g = 0;
...
HXLINE( 429)				HX_VARI( ::String,name) = flxFrames->__get(i).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name;
...
HXLINE( 432)					HX_VARI(  ::Dynamic,index) = ::Std_obj::parseInt(name.substring(Prefix.length,(name.length - Postfix.length)));
...
HXLINE( 457)			HX_VARI( ::Array< ::Dynamic>,animFrames) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 458)			this->findByPrefix(animFrames,Prefix);
HXLINE( 460)			if ((animFrames->length > 0)) {
HXLINE( 462)				HX_VARI( ::Array< int >,frameIndices) = ::Array_obj< int >::__new();
HXLINE( 463)				this->byPrefixHelper(frameIndices,animFrames,Prefix);
HXLINE( 465)				if ((frameIndices->length > 0)) {
HXLINE( 467)					HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByPrefix(::String Name,::String Prefix){
            	...
            	HX_STACK_ARG(Prefix,"Prefix")
HXLINE( 485)
HXLINE( 486)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
HXLINE( 495)			HX_VARI( ::Array< ::Dynamic>,animFrames) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 533)		HX_VARI( bool,oldFlipX) = false;
HXLINE( 534)		HX_VARI( bool,oldFlipY) = false;
...
HXDLIN( 660)			HX_VARI( ::String,frameName) = FrameNames->__get(_g);
HXDLIN( 660)			_g = (_g + 1);
HXLINE( 662)			if (this->_sprite->frames->framesHash->exists(frameName)) {
HXLINE( 664)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frameToAdd) = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesHash->get(frameName)) );
...
HXDLIN( 672)			HX_VARI( ::String,index) = Indices->__get(_g);
HXDLIN( 672)			_g = (_g + 1);
HXLINE( 674)			HX_VARI( ::String,name) = ((Prefix + index) + Postfix);
HXLINE( 675)			if (this->_sprite->frames->framesHash->exists(name)) {
HXLINE( 677)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frameToAdd) = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesHash->get(name)) );
...
HXDLIN( 685)			HX_VARI( int,index) = Indices->__get(_g);
HXDLIN( 685)			_g = (_g + 1);
...
void FlxAnimationController_obj::byPrefixHelper(::Array< int > AddTo,::Array< ::Dynamic> AnimFrames,::String Prefix){
            	...
            	HX_STACK_ARG(Prefix,"Prefix")
HXLINE( 696)
HXLINE( 697)		HX_VARI( ::String,name) = AnimFrames->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name;
HXLINE( 698)		HX_VARI( int,postIndex) = name.indexOf(HX_(".",2e,00,00,00),Prefix.length);
...
HXDLIN( 699)		HX_VARI( ::String,postFix1) = name.substring(postFix,name.length);
...
HXLINE( 702)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,animFrame) = AnimFrames->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 702)				_g = (_g + 1);
...
HXDLIN( 710)			HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 710)			_g = (_g + 1);
...
HXLINE( 747)			HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesHash->get(Value)) );
...
::String FlxAnimationController_obj::get_name(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 758)
HXLINE( 759)		HX_VARI( ::String,animName) = null();
...
::Array< ::Dynamic> FlxAnimationController_obj::getAnimationList(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 780)
HXLINE( 781)		HX_VARI( ::Array< ::Dynamic>,animList) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 783)		{
HXLINE( 783)			HX_VARI(  ::Dynamic,anims) = this->_animations->iterator();
HXDLIN( 783)			while(( (bool)(anims->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 783)				HX_VARI(  ::flixel::animation::FlxAnimation,anims1) = ( ( ::flixel::animation::FlxAnimation)(anims->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
::Array< ::String > FlxAnimationController_obj::getNameList(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 798)
HXLINE( 799)		HX_VARI( ::Array< ::String >,namesList) = ::Array_obj< ::String >::__new(0);
HXLINE( 800)		{
HXLINE( 800)			HX_VARI(  ::Dynamic,names) = this->_animations->keys();
HXDLIN( 800)			while(( (bool)(names->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 800)				HX_VARI( ::String,names1) = ( (::String)(names->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 825)
HXLINE( 826)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(oldName)) );
...
bool FlxAnimationController_obj::get_paused(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 860)
HXLINE( 861)		HX_VARI( bool,paused) = false;
...
bool FlxAnimationController_obj::get_finished(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 886)
HXLINE( 887)		HX_VARI( bool,finished) = true;

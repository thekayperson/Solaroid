...
HXLINE( 418)		HX_VARI(  ::flixel::_hx_system::FlxQuadTree,quadTree) = ::flixel::_hx_system::FlxQuadTree_obj::recycle(::flixel::FlxG_obj::worldBounds->x,::flixel::FlxG_obj::worldBounds->y,::flixel::FlxG_obj::worldBounds->width,::flixel::FlxG_obj::worldBounds->height,null());
HXLINE( 419)		quadTree->load(ObjectOrGroup1,ObjectOrGroup2,NotifyCallback,ProcessCallback);
HXLINE( 420)		HX_VARI( bool,result) = quadTree->execute();
...
HXLINE( 476)
HXLINE( 477)		HX_VARI( int,index) = ::flixel::FlxG_obj::game->getChildIndex(::flixel::FlxG_obj::game->_inputContainer);
HXLINE( 478)		HX_VARI( int,max) = ::flixel::FlxG_obj::game->get_numChildren();
...
HXLINE( 562)
HXLINE( 563)		HX_VARI( ::String,prefix) = HX_("",00,00,00,00);
...
HXLINE( 703)		HX_VARI(  ::flixel::input::mouse::FlxMouse,oldMouse) = ::flixel::FlxG_obj::mouse;
HXLINE( 704)		HX_VARI(  ::flixel::input::mouse::FlxMouse,result) = ::flixel::FlxG_obj::inputs->replace_flixel_input_mouse_FlxMouse(oldMouse,NewMouse);

...
HXLINE( 209)		HX_VAR( ::Array< ::String >,columns);
HXLINE( 211)		HX_VARI(  ::EReg,regex) =  ::EReg_obj::__alloc( HX_CTX ,HX_("[ \t]*((\r\n)|\r|\n)[ \t]*",22,2c,8d,6d),HX_("g",67,00,00,00));
HXLINE( 212)		HX_VARI( ::Array< ::String >,lines) = regex->split(MapData);
...
HXDLIN( 213)		HX_VARI( ::Array< ::String >,rows) = _g;
HXLINE( 215)		this->heightInTiles = rows->length;
HXLINE( 216)		this->widthInTiles = 0;
HXLINE( 218)		HX_VARI( int,row) = 0;
HXLINE( 219)		while((row < this->heightInTiles)){
HXLINE( 221)			HX_VARI( ::String,rowString) = rows->__get(row);
...
HXLINE( 236)			HX_VARI( int,column) = 0;
HXLINE( 237)			while((column < this->widthInTiles)){
HXLINE( 240)				HX_VARI( ::String,columnString) = columns->__get(column);
HXLINE( 241)				HX_VARI(  ::Dynamic,curTile) = ::Std_obj::parseInt(columnString);
...
HX_DEFINE_DYNAMIC_FUNC8(FlxBaseTilemap_obj,loadMapFrom2DArray,return )
 ...
 ::flixel::tile::FlxBaseTilemap FlxBaseTilemap_obj::loadMapFromGraphic( ::Dynamic MapGraphic,::hx::Null< bool >  __o_Invert,::hx::Null< int >  __o_Scale,::Array< int > ColorMap, ::Dynamic TileGraphic,::hx::Null< int >  __o_TileWidth,::hx::Null< int >  __o_TileHeight, ::flixel::tile::FlxTilemapAutoTiling AutoTile,::hx::Null< int >  __o_StartingIndex,::hx::Null< int >  __o_DrawIndex,::hx::Null< int >  __o_CollideIndex){
            	...
            	HX_STACK_ARG(CollideIndex,"CollideIndex")
HXLINE( 342)
HXLINE( 343)		HX_VARI(  ::openfl::display::BitmapData,mapBitmap) = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(MapGraphic);
HXLINE( 344)		HX_VARI( ::String,mapData) = ::flixel::util::FlxStringUtil_obj::bitmapToCSV(mapBitmap,Invert,Scale,ColorMap);
...
void FlxBaseTilemap_obj::applyCustomRemap(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 400)
HXLINE( 401)		HX_VARI( int,i) = 0;
HXLINE( 403)		if (::hx::IsNotNull( this->customTileRemap )) {
HXLINE( 405)			while((i < this->totalTiles)){
HXLINE( 407)				HX_VARI( int,oldIndex) = this->_data->__get(i);
HXLINE( 408)				HX_VARI( int,newIndex) = oldIndex;
...
void FlxBaseTilemap_obj::randomizeIndices(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 420)
HXLINE( 421)		HX_VARI( int,i) = 0;
HXLINE( 423)		if (::hx::IsNotNull( this->_randomIndices )) {
HXLINE( 425)			HX_VAR(  ::Dynamic,randLambda);
...
HXLINE( 432)				HX_VARI( int,oldIndex) = this->_data->__get(i);
HXLINE( 433)				HX_VARI( int,j) = 0;
HXLINE( 434)				HX_VARI( int,newIndex) = oldIndex;
HXLINE( 435)				{
HXLINE( 435)					int _g = 0;
HXDLIN( 435)					::Array< int > _g1 = this->_randomIndices;
HXDLIN( 435)					while((_g < _g1->length)){
HXLINE( 435)						HX_VARI( int,rand) = _g1->__get(_g);
HXDLIN( 435)						_g = (_g + 1);
HXLINE( 437)						if ((oldIndex == rand)) {
HXLINE( 439)							Float k = ( (Float)(randLambda()) );
HXDLIN( 439)							HX_VARI( int,k1) = ::Std_obj::_hx_int((k * ( (Float)(this->_randomChoices->__get(j).StaticCast< ::Array< int > >()->length) )));
...
HXLINE( 530)		HX_VARI( bool,wallUp) = ((Index - this->widthInTiles) < 0);
HXLINE( 531)		HX_VARI( bool,wallRight) = (::hx::Mod(Index,this->widthInTiles) >= (this->widthInTiles - 1));
HXLINE( 532)		int wallDown = ::Std_obj::_hx_int(( (Float)((Index + this->widthInTiles)) ));
HXDLIN( 532)		HX_VARI( bool,wallDown1) = (wallDown >= this->totalTiles);
HXLINE( 533)		HX_VARI( bool,wallLeft) = (::hx::Mod(Index,this->widthInTiles) <= 0);
HXLINE( 535)		HX_VAR( bool,up);
...
HXLINE( 536)		HX_VAR( bool,upRight);
...
HXLINE( 538)		HX_VAR( bool,rightDown);
...
HXLINE( 540)		HX_VAR( bool,downLeft);
...
::Array< int > FlxBaseTilemap_obj::getTileInstances(int Index){
            	...
            	HX_STACK_ARG(Index,"Index")
HXLINE( 628)
HXLINE( 629)		HX_VARI( ::Array< int >,array) = null();
HXLINE( 630)		HX_VARI( int,i) = 0;
HXLINE( 631)		HX_VARI( int,l) = (this->widthInTiles * this->heightInTiles);
...
HXLINE( 683)		HX_VARI( bool,ok) = true;
...
HXLINE( 700)		HX_VAR( int,i);
HXLINE( 701)		HX_VARI( int,row) = (::Std_obj::_hx_int((( (Float)(Index) ) / ( (Float)(this->widthInTiles) ))) - 1);
HXLINE( 702)		HX_VARI( int,rowLength) = (row + 3);
HXLINE( 703)		HX_VARI( int,column) = (::hx::Mod(Index,this->widthInTiles) - 1);
HXLINE( 704)		HX_VARI( int,columnHeight) = (column + 3);
...
HXLINE( 744)		HX_VAR(  ::Dynamic,tile);
HXLINE( 745)		HX_VARI( int,i) = Tile;
HXLINE( 746)		HX_VARI( int,l) = (Tile + Range);
HXLINE( 748)		HX_VARI( int,maxIndex) = this->_tileObjects->get_length();
...
HXLINE( 777)		HX_VARI( int,i) = 0;
HXLINE( 778)		HX_VARI( int,l) = this->_data->length;
HXLINE( 779)		HX_VARI( ::Array< int >,data) = ::Array_obj< int >::__new();
...
HXLINE( 804)
HXLINE( 806)		HX_VARI( int,startIndex) = this->getTileIndexByCoords(Start);
HXLINE( 807)		HX_VARI( int,endIndex) = this->getTileIndexByCoords(End);
...
HXLINE( 820)		HX_VARI( ::Array< int >,distances) = this->computePathDistance(startIndex,endIndex,DiagonalPolicy,null());
HXLINE( 822)		if (::hx::IsNull( distances )) {
HXLINE( 824)			return null();
            		}
HXLINE( 828)		HX_VARI( ::Array< ::Dynamic>,points) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 829)		this->walkPath(distances,endIndex,points);
HXLINE( 832)		HX_VARI(  ::flixel::math::FlxPoint,node) = points->__get((points->length - 1)).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 834)		{
...
HXLINE( 849)		HX_VARI( ::Array< ::Dynamic>,path) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 850)		HX_VARI( int,i) = (points->length - 1);
...
HXLINE( 876)
HXLINE( 879)		HX_VARI( int,mapSize) = (this->widthInTiles * this->heightInTiles);
HXLINE( 880)		HX_VARI( ::Array< int >,distances) = ::Array_obj< int >::__new();
HXLINE( 881)		::flixel::util::FlxArrayUtil_obj::setLength_Int(distances,mapSize);
HXLINE( 882)		HX_VARI( int,i) = 0;
...
HXLINE( 898)		HX_VARI( int,distance) = 1;
HXLINE( 899)		HX_VARI( ::Array< int >,neighbors) = ::Array_obj< int >::__new(1)->init(0,StartIndex);
HXLINE( 900)		HX_VAR( ::Array< int >,current);
HXLINE( 901)		HX_VAR( int,currentIndex);
HXLINE( 902)		HX_VAR( bool,left);
HXLINE( 903)		HX_VAR( bool,right);
HXLINE( 904)		HX_VAR( bool,up);
HXLINE( 905)		HX_VAR( bool,down);
HXLINE( 906)		HX_VAR( int,currentLength);
HXLINE( 907)		HX_VARI( bool,foundEnd) = false;
...
HXLINE( 981)					HX_VARI( bool,wideDiagonal) = (DiagonalPolicy == 2);
...
HXLINE(1084)		HX_VARI( bool,left) = (::hx::Mod(Start,this->widthInTiles) > 0);
HXLINE(1085)		HX_VARI( bool,right) = (::hx::Mod(Start,this->widthInTiles) < (this->widthInTiles - 1));
HXLINE(1086)		HX_VARI( bool,up) = ((( (Float)(Start) ) / ( (Float)(this->widthInTiles) )) > 0);
HXLINE(1087)		HX_VARI( bool,down) = ((( (Float)(Start) ) / ( (Float)(this->widthInTiles) )) < (this->heightInTiles - 1));
HXLINE(1089)		HX_VARI( int,current) = Data->__get(Start);
HXLINE(1090)		HX_VAR( int,i);
HXLINE(1092)		if (up) {
...
void FlxBaseTilemap_obj::simplifyPath(::Array< ::Dynamic> Points){
            	...
            	HX_STACK_ARG(Points,"Points")
HXLINE(1174)
HXLINE(1175)		HX_VAR( Float,deltaPrevious);
HXLINE(1176)		HX_VAR( Float,deltaNext);
HXLINE(1177)		HX_VARI(  ::flixel::math::FlxPoint,last) = Points->__get(0).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE(1178)		HX_VAR(  ::flixel::math::FlxPoint,node);
HXLINE(1179)		HX_VARI( int,i) = 1;
HXLINE(1180)		HX_VARI( int,l) = (Points->length - 1);
...
void FlxBaseTilemap_obj::raySimplifyPath(::Array< ::Dynamic> Points){
            	...
            	HX_STACK_ARG(Points,"Points")
HXLINE(1207)
HXLINE(1208)		HX_VARI(  ::flixel::math::FlxPoint,source) = Points->__get(0).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE(1209)		HX_VARI( int,lastIndex) = -1;
HXLINE(1210)		HX_VAR(  ::flixel::math::FlxPoint,node);
HXLINE(1211)		HX_VARI( int,i) = 1;
HXLINE(1212)		HX_VARI( int,l) = Points->length;
...
HXLINE(1251)
HXLINE(1252)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
...
bool FlxBaseTilemap_obj::overlapsAt(Float X,Float Y, ::flixel::FlxBasic ObjectOrGroup,::hx::Null< bool >  __o_InScreenSpace, ::flixel::FlxCamera Camera){
            	...
            	HX_STACK_ARG(Camera,"Camera")
HXLINE(1290)
HXLINE(1291)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
...
HXLINE(1339)
HXLINE(1340)		HX_VARI( int,tileIndex) = this->getTileIndexByCoords(point);

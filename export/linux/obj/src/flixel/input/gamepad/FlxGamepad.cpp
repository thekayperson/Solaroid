...
HXLINE( 255)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = _g3->__get(_g2).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
...
HXLINE( 461)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 461)				_g = (_g + 1);
...
HXLINE( 486)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 486)				_g = (_g + 1);
...
HXLINE( 511)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 511)				_g = (_g + 1);
...
HXLINE( 557)
HXLINE( 558)		HX_VARI( Float,axisValue) = this->getAxisValue(RawAxisID);
...
HXLINE( 567)
HXLINE( 568)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,leftStick) = this->mapping->leftStick;
HXLINE( 569)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,rightStick) = this->mapping->rightStick;
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGamepad_obj,isAxisForAnalogStick,return )
 ...
 ::flixel::input::gamepad::FlxGamepadAnalogStick FlxGamepad_obj::getAnalogStickByAxis(int AxisIndex){
            	...
            	HX_STACK_ARG(AxisIndex,"AxisIndex")
HXLINE( 585)
HXLINE( 586)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,leftStick) = this->mapping->leftStick;
HXLINE( 587)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,rightStick) = this->mapping->rightStick;
...
HXLINE( 647)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 647)				_g = (_g + 1);
...
HXLINE( 665)		HX_VARI( int,numAxis) = this->axis->length;
HXLINE( 667)		{
HXLINE( 667)			int _g = 0;
HXDLIN( 667)			int _g1 = numAxis;
HXDLIN( 667)			while((_g < _g1)){
HXLINE( 667)				_g = (_g + 1);
HXDLIN( 667)				HX_VARI( int,i) = (_g - 1);
...
Float FlxGamepad_obj::getAxisValue(int AxisID){
            	...
            	HX_STACK_ARG(AxisID,"AxisID")
HXLINE( 691)
HXLINE( 692)		HX_VARI( Float,axisValue) = ( (Float)(0) );
...
HXLINE( 744)		HX_VARI( Float,xAxis) = this->getAxisValue(stick->x);
HXLINE( 745)		HX_VARI( Float,yAxis) = this->getAxisValue(stick->y);
HXLINE( 747)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(xAxis,yAxis);
HXDLIN( 747)		point->_inPool = false;
HXDLIN( 747)		HX_VARI(  ::flixel::math::FlxPoint,vector) = point;
HXLINE( 748)		HX_VARI( Float,length) = ::Math_obj::sqrt(((vector->x * vector->x) + (vector->y * vector->y)));
...
Float FlxGamepad_obj::getAnalogAxisValueIndependent(int axisID){
            	...
            	HX_STACK_ARG(axisID,"axisID")
HXLINE( 759)
HXLINE( 760)		HX_VARI( Float,axisValue) = this->getAxisValue(axisID);
...
HXDLIN( 772)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,stick3) = stick;
...
HXLINE( 786)
HXLINE( 787)		HX_VARI( int,digitalButton) = -1;
...
HXLINE( 798)		HX_VARI( Float,threshold) = stick->digitalThreshold;
HXLINE( 799)		HX_VARI( Float,valueSign) = (value * sign);
HXLINE( 800)		HX_VARI( Float,oldValueSign) = (oldValue * sign);
...
HXLINE( 804)			HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,btn) = this->getButton(digitalButton);
...
HXLINE( 810)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,btn) = this->getButton(digitalButton);

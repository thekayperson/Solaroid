...
HXLINE(  70)						HX_VARI( ::String,attribute1) = ( (::String)(attribute->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  71)						{
...
HXDLIN(  64)					HX_VARI(  ::Xml,child) = _g_array->__get((_g_current - 1)).StaticCast<  ::Xml >();

...
HXLINE( 337)						p = (p + 1);
HXLINE( 338)						HX_VARI( ::String,str1) = str.substr((start + 1),((p - start) - 2));
HXLINE( 339)						{
...
HXLINE( 173)						HX_VARI(  ::Xml,child) = ::Xml_obj::createCData(str.substr(start,(p - start)));
HXLINE( 174)						{

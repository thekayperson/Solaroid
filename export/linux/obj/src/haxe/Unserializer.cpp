...
HXLINE( 450)				return cl;
            			...
            			break;
            			case (int)66: {
HXLINE( 452)				HX_VARI( ::String,name) = ( (::String)(this->unserialize()) );
HXLINE( 453)				HX_VARI( ::hx::Class,e) = this->resolver->__Field(HX_("resolveEnum",0d,90,51,de),::hx::paccDynamic)(name);
...
HXLINE( 456)				return e;
            			...
            			break;
            			case (int)67: {
HXLINE( 435)				HX_VARI( ::String,name) = ( (::String)(this->unserialize()) );
HXLINE( 436)				HX_VARI( ::hx::Class,cl) = this->resolver->__Field(HX_("resolveClass",ac,bd,dd,80),::hx::paccDynamic)(name);
HXLINE( 437)				if (::hx::IsNull( cl )) {
HXLINE( 438)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Class not found ",13,56,74,ed) + name)));
            				}
HXLINE( 439)				HX_VARI(  ::Dynamic,o) = ::Type_obj::createEmptyInstance(cl);
...
HXLINE( 305)				return this->scache->__get(n);
            			...
            			break;
            			case (int)97: {
HXLINE( 267)				HX_VARI( ::String,buf) = this->buf;
...
HXLINE( 279)					if ((c == 117)) {
HXLINE( 280)						this->pos++;
HXLINE( 281)						HX_VARI( int,n) = this->readDigits();
...
HXLINE( 287)				return (this->cache->set(cachePos,_hx_reslove_virtual_array(a)));
            			...
            			break;
            			case (int)98: {
HXLINE( 347)				HX_VARI(  ::haxe::ds::StringMap,h) =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 348)				this->cache->push(h);
HXLINE( 349)				HX_VARI( ::String,buf) = this->buf;
HXLINE( 350)				while((this->buf.cca(this->pos) != 104)){
HXLINE( 351)					HX_VARI( ::String,s) = ( (::String)(this->unserialize()) );
...
HXLINE( 355)				return h;
            			...
            			break;
            			case (int)99: {
HXLINE( 309)				HX_VARI( ::String,name) = ( (::String)(this->unserialize()) );
HXLINE( 310)				HX_VARI( ::hx::Class,cl) = this->resolver->__Field(HX_("resolveClass",ac,bd,dd,80),::hx::paccDynamic)(name);
HXLINE( 311)				if (::hx::IsNull( cl )) {
HXLINE( 312)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Class not found ",13,56,74,ed) + name)));
            				}
HXLINE( 313)				HX_VARI(  ::Dynamic,o) = ::Type_obj::createEmptyInstance(cl);
...
HXLINE( 248)				return this->readDigits();
            			...
            			break;
            			case (int)106: {
HXLINE( 326)				HX_VARI( ::String,name) = ( (::String)(this->unserialize()) );
HXLINE( 327)				HX_VARI( ::hx::Class,edecl) = this->resolver->__Field(HX_("resolveEnum",0d,90,51,de),::hx::paccDynamic)(name);
...
HXLINE( 335)				HX_VARI(  ::Dynamic,e) = this->unserializeEnum(edecl,tag);
...
HXLINE( 341)				HX_VARI( ::String,buf) = this->buf;
...
HXLINE( 240)				return null();
            			...
            			break;
            			case (int)111: {
HXLINE( 292)				HX_VARI(  ::Dynamic,o) =  ::Dynamic(::hx::Anon_obj::Create(0));
...
HXLINE( 265)				return ::Math_obj::POSITIVE_INFINITY;
            			...
            			break;
            			case (int)113: {
HXLINE( 357)				HX_VARI(  ::haxe::ds::IntMap,h) =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 358)				this->cache->push(h);
HXLINE( 359)				HX_VARI( ::String,buf) = this->buf;
HXLINE( 360)				HX_VARI( int,c) = this->buf.cca(this->pos++);
...
HXLINE( 368)				return h;
            			...
            			break;
            			case (int)114: {
HXLINE( 297)				HX_VARI( int,n) = this->readDigits();
...
HXLINE( 392)				HX_VARI( ::String,buf) = this->buf;
...
HXLINE( 406)				HX_VARI( int,i) = this->pos;
...
HXDLIN( 408)				HX_VARI( int,size1) = (((len >> 2) * 3) + size);
HXLINE( 409)				HX_VARI( int,max) = (i + (len - rest));
HXLINE( 410)				HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc(size1);
HXLINE( 411)				HX_VARI( int,bpos) = 0;
HXLINE( 412)				while((i < max)){
HXLINE( 413)					i = (i + 1);
HXDLIN( 413)					HX_VARI( int,c1) = codes->__get(buf.cca((i - 1)));
HXLINE( 414)					i = (i + 1);
HXDLIN( 414)					HX_VARI( int,c2) = codes->__get(buf.cca((i - 1)));
HXLINE( 415)					{
HXLINE( 415)						bpos = (bpos + 1);
HXDLIN( 415)						bytes->b[(bpos - 1)] = ( (unsigned char)(((c1 << 2) | (c2 >> 4))) );
            					}
HXLINE( 416)					i = (i + 1);
HXDLIN( 416)					HX_VARI( int,c3) = codes->__get(buf.cca((i - 1)));
HXLINE( 417)					{
HXLINE( 417)						bpos = (bpos + 1);
HXDLIN( 417)						bytes->b[(bpos - 1)] = ( (unsigned char)(((c2 << 4) | (c3 >> 2))) );
            					}
HXLINE( 418)					i = (i + 1);
HXDLIN( 418)					HX_VARI( int,c4) = codes->__get(buf.cca((i - 1)));
HXLINE( 419)					{
...
HXLINE( 422)					i = (i + 1);
HXDLIN( 422)					HX_VARI( int,c1) = codes->__get(buf.cca((i - 1)));
HXLINE( 423)					i = (i + 1);
HXDLIN( 423)					HX_VARI( int,c2) = codes->__get(buf.cca((i - 1)));
HXLINE( 424)					{
...
HXLINE( 426)						i = (i + 1);
HXDLIN( 426)						HX_VARI( int,c3) = codes->__get(buf.cca((i - 1)));
HXLINE( 427)						{
...
HXLINE( 389)				return d;
            			...
            			break;
            			case (int)119: {
HXLINE( 318)				HX_VARI( ::String,name) = ( (::String)(this->unserialize()) );
HXLINE( 319)				HX_VARI( ::hx::Class,edecl) = this->resolver->__Field(HX_("resolveEnum",0d,90,51,de),::hx::paccDynamic)(name);
HXLINE( 320)				if (::hx::IsNull( edecl )) {
HXLINE( 321)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Enum not found ",aa,e1,55,fd) + name)));
            				}
HXLINE( 322)				HX_VARI(  ::Dynamic,e) = this->unserializeEnum(edecl,( (::String)(this->unserialize()) ));
...
HXLINE( 307)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(this->unserialize()));
            			...
            			break;
            			case (int)121: {
HXLINE( 252)				HX_VARI( int,len) = this->readDigits();
...
HXLINE( 255)				HX_VARI( ::String,s) = this->buf.substr(this->pos,len);

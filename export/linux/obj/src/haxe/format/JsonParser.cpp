...
HXLINE( 105)						HX_VARI( int,c) = this->str.cca(this->pos++);
...
HXLINE( 134)					return false;
            				...
            				break;
            				case (int)110: {
HXLINE( 136)					HX_VARI( int,save) = this->pos;
...
HXLINE( 141)					return null();
            				...
            				break;
            				case (int)116: {
HXLINE( 122)					HX_VARI( int,save) = this->pos;
...
HXDLIN(  77)					HX_VARI(  ::Dynamic,comma) = null();
HXLINE(  78)					while(true){
HXLINE(  79)						HX_VARI( int,c) = this->str.cca(this->pos++);

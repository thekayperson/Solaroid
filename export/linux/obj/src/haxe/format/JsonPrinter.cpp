...
HXLINE(  99)							HX_VARI( ::cpp::VirtualArray,v1) = ( (::cpp::VirtualArray)(v) );
HXLINE( 100)							{
...
HXLINE( 102)							HX_VARI( int,len) = v1->get_length();
...
HXLINE( 120)								HX_VARI(  ::haxe::ds::StringMap,v1) = ( ( ::haxe::ds::StringMap)(v) );
HXLINE( 121)								HX_VARI(  ::Dynamic,o) =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE( 122)								{
HXLINE( 122)									HX_VARI(  ::Dynamic,k) = v1->keys();
HXDLIN( 122)									while(( (bool)(k->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 122)										HX_VARI( ::String,k1) = ( (::String)(k->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 126)									HX_VARI(  ::Date,v1) = ( ( ::Date)(v) );
...
HXDLIN( 130)					{
HXLINE( 131)						HX_VARI(  ::Dynamic,i) = _hx_getEnumValueIndex(v);
HXLINE( 132)						{

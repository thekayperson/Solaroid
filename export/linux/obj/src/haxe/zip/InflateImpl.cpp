...
HXDLIN( 231)				return this->applyHuffman(_hx_tmp);
            			...
            			break;
            			case (int)2: {
HXLINE( 232)				HX_VARI( int,n) = h->_hx_getInt(0);
...
HXDLIN( 322)								HX_VARI( int,i) = (_g2 - 1);
...
HXDLIN( 326)								HX_VARI( int,i) = (_g4 - 1);

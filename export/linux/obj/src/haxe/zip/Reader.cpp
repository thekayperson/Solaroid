...
bool Reader_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Date Reader_obj::readZipDate(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  38)
HXLINE(  39)		HX_VARI( int,t) = this->i->readUInt16();
HXLINE(  40)		HX_VARI( int,hour) = ((t >> 11) & 31);
HXLINE(  41)		HX_VARI( int,min) = ((t >> 5) & 63);
HXLINE(  42)		HX_VARI( int,sec) = (t & 31);
HXLINE(  43)		HX_VARI( int,d) = this->i->readUInt16();
HXLINE(  44)		HX_VARI( int,year) = (d >> 9);
HXLINE(  45)		HX_VARI( int,month) = ((d >> 5) & 15);
HXLINE(  46)		HX_VARI( int,day) = (d & 31);
...
HXLINE(  51)
HXLINE(  52)		HX_VARI(  ::haxe::ds::List,fields) =  ::haxe::ds::List_obj::__alloc( HX_CTX );
...
HXLINE(  56)			HX_VARI( int,tag) = this->i->readUInt16();
HXLINE(  57)			HX_VARI( int,len) = this->i->readUInt16();
...
HXLINE(  62)				HX_VARI( int,version) = this->i->readByte();
HXLINE(  63)				if ((version != 1)) {
HXLINE(  65)					HX_VARI(  ::haxe::io::BytesBuffer,data) =  ::haxe::io::BytesBuffer_obj::__alloc( HX_CTX );
...
HXLINE(  72)					HX_VARI( int,crc) = this->i->readInt32();
HXLINE(  73)					HX_VARI( ::String,name) = this->i->read((len - 5))->toString();
...
HX_DEFINE_DYNAMIC_FUNC1(Reader_obj,readExtraFields,return )
 ...
 ::Dynamic Reader_obj::readEntryHeader(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  85)
HXLINE(  86)		HX_VARI(  ::haxe::io::Input,i) = this->i;
HXLINE(  87)		HX_VARI( int,h) = i->readInt32();
...
HXLINE(  90)		HX_VARI( int,version) = i->readUInt16();
HXLINE(  91)		HX_VARI( int,flags) = i->readUInt16();
HXLINE(  92)		HX_VARI( bool,utf8) = ((flags & 2048) != 0);
HXLINE(  95)		HX_VARI( int,compression) = i->readUInt16();
HXLINE(  96)		HX_VARI( bool,compressed) = (compression != 0);
...
HXLINE(  98)		HX_VARI(  ::Date,mtime) = this->readZipDate();
HXLINE(  99)		HX_VARI( int,crc32) = i->readInt32();
HXLINE( 100)		HX_VARI( int,csize) = i->readInt32();
HXLINE( 101)		HX_VARI( int,usize) = i->readInt32();
HXLINE( 102)		HX_VARI( int,fnamelen) = i->readInt16();
HXLINE( 103)		HX_VARI( int,elen) = i->readInt16();
HXLINE( 104)		HX_VARI( ::String,fname) = i->readString(fnamelen,null());
HXLINE( 105)		HX_VARI(  ::haxe::ds::List,fields) = this->readExtraFields(elen);
HXLINE( 106)		if (utf8) {
HXLINE( 106)			fields->push(::haxe::zip::ExtraField_obj::FUtf8_dyn());
            		}
HXLINE( 107)		HX_VARI(  ::haxe::io::Bytes,data) = null();
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,readEntryHeader,return )
 ...
 ::haxe::ds::List Reader_obj::read(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 122)
HXLINE( 123)		HX_VARI(  ::haxe::ds::List,l) =  ::haxe::ds::List_obj::__alloc( HX_CTX );
HXLINE( 124)		HX_VARI(  ::Dynamic,buf) = null();
HXLINE( 125)		HX_VARI(  ::haxe::io::Bytes,tmp) = null();
HXLINE( 126)		while(true){
HXLINE( 128)			HX_VARI(  ::Dynamic,e) = this->readEntryHeader();
...
HXLINE( 165)				HX_VARI( int,bufSize) = 65536;
...
HXLINE( 171)					HX_VARI( int,n) = z->readBytes(tmp,0,bufSize);
HXLINE( 172)					{
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,read,return )
 ...
 ::haxe::ds::List Reader_obj::readZip( ::haxe::io::Input i){
            	...
            	HX_STACK_ARG(i,"i")
HXLINE( 193)
HXLINE( 194)		HX_VARI(  ::haxe::zip::Reader,r) =  ::haxe::zip::Reader_obj::__alloc( HX_CTX ,i);

...
HXDLIN(  33)		HX_VARI( int,d1) = (d - _hx_getEnumValueIndex(k2));
HXLINE(  34)		if ((d1 != 0)) {
HXLINE(  35)			return d1;
            		}
...
int EnumValueMap_obj::compareArgs(::cpp::VirtualArray a1,::cpp::VirtualArray a2){
            	...
            	HX_STACK_ARG(a2,"a2")
HXLINE(  43)
HXLINE(  44)		HX_VARI( int,ld) = (a1->get_length() - a2->get_length());
HXLINE(  45)		if ((ld != 0)) {
HXLINE(  46)			return ld;
            		}
HXLINE(  47)		{
...
HXLINE(  48)				HX_VARI( int,d) = this->compareArg(a1->__get(i),a2->__get(i));
HXLINE(  49)				if ((d != 0)) {
HXLINE(  50)					return d;
            				}
            			}

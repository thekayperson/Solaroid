...
HX_LOCAL_STACK_FRAME(_hx_pos_254a12b9e3136e41_94_set_bigEndian,"haxe.io.Input","set_bigEndian",0x96732a9a,"haxe.io.Input.set_bigEndian","/usr/share/haxe/std/haxe/io/Input.hx",94,0x1cc3d0af)
...
bool Input_obj::set_bigEndian(bool b){
            	HX_STACKFRAME(&_hx_pos_254a12b9e3136e41_94_set_bigEndian)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(b,"b")
HXLINE(  94)
...
HXLINE( 186)					HX_VARI(  ::haxe::io::Eof,e) = ( ( ::haxe::io::Eof)(_g1) );
HXDLIN( 186)					{

...
HXDLIN( 256)		HX_VARI(  ::Dynamic,init) = ::hx::ClassOf< ::lime::app::Application >();
            	}
...
HXLINE(  17)
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Solaroid",89,a3,41,e7),::ApplicationMain_obj::create_dyn());
...
HXLINE(  30)
HXLINE(  31)		HX_VARI(  ::openfl::display::Application,app) =  ::openfl::display::Application_obj::__alloc( HX_CTX );
...
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Solaroid",89,a3,41,e7));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Solaroid",89,a3,41,e7));
...
HXLINE(  46)		HX_VARI(  ::Dynamic,attributes) =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Solaroid",89,a3,41,e7))
...
HXLINE(  81)					HX_VARI( ::String,field) = _g1->__get(_g);
HXDLIN(  81)					_g = (_g + 1);
...
HXLINE( 106)		HX_VARI(  ::openfl::display::Preloader,preloader) =  ::openfl::display::Preloader_obj::__alloc( HX_CTX , ::flixel::_hx_system::FlxPreloader_obj::__alloc( HX_CTX ,null(),null()));
...
HXLINE( 118)				HX_VARI(  ::lime::utils::AssetLibrary,library) = _g1->__get(_g).StaticCast<  ::lime::utils::AssetLibrary >();
HXDLIN( 118)				_g = (_g + 1);
...
HXLINE( 187)			{
HXLINE( 188)				HX_VARI(  ::openfl::display::DisplayObject,current) = stage->getChildAt(0);
...
HXDLIN( 152)				HX_VARI(  ::Dynamic,e) = ::haxe::Exception_obj::caught(_g)->unwrap();

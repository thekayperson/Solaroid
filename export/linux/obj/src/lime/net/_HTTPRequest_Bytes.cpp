...
HXLINE( 103)		HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__alloc( HX_CTX );
HXLINE( 104)		HX_VARI(  ::lime::app::Future,future) = this->_hx___backend->loadData(this->uri,null());

...
::Array< ::String > AssetLibrary_obj::list(::String type){
            	...
            	HX_STACK_ARG(type,"type")
HXLINE( 356)
HXLINE( 357)		HX_VAR( ::String,requestedType);
...
HXLINE( 358)		HX_VARI( ::Array< ::String >,items) = ::Array_obj< ::String >::__new(0);
HXLINE( 360)		{
HXLINE( 360)			HX_VARI(  ::Dynamic,id) = this->types->keys();
HXDLIN( 360)			while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 360)				HX_VARI( ::String,id1) = ( (::String)(id->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 401)			{
HXLINE( 401)				HX_VARI(  ::Dynamic,id) = this->preload->keys();
HXDLIN( 401)				while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 401)					HX_VARI( ::String,id1) = ( (::String)(id->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 412)								HX_VARI(  ::lime::app::Future,future) = this->loadBytes(id1);
...
HXLINE( 420)								HX_VARI(  ::lime::app::Future,future) = this->loadFont(id1);
...
HXLINE( 428)								HX_VARI(  ::lime::app::Future,future) = this->loadImage(id1);
...
HXLINE( 436)								HX_VARI(  ::lime::app::Future,future) = this->loadAudioBuffer(id1);
...
HXLINE( 444)								HX_VARI(  ::lime::app::Future,future) = this->loadText(id1);
...
HXLINE( 510)				HX_VARI(  ::lime::text::Font,font) = ( ( ::lime::text::Font)(::Type_obj::createInstance(this->classTypes->get(id),::cpp::VirtualArray_obj::__new(0))) );
...
HXLINE( 591)				HX_VARI(  ::haxe::io::Bytes,bytes) = this->getBytes(id);
HXLINE( 593)				if (::hx::IsNull( bytes )) {
HXLINE( 595)					return ::lime::app::Future_obj::withValue(null());
            				}
            				else {
HXLINE( 599)					HX_VARI( ::String,text) = bytes->getString(0,bytes->length,null());
HXLINE( 600)					this->cachedText->set(id,text);
HXLINE( 601)					return ::lime::app::Future_obj::withValue(text);
            				}
            			}
            			else {
HXLINE( 606)				HX_VARI(  ::lime::net::_HTTPRequest_String,request) =  ::lime::net::_HTTPRequest_String_obj::__alloc( HX_CTX ,null());
...
HXLINE( 624)			HX_VAR(  ::Dynamic,size);
...
HXLINE( 632)				HX_VARI(  ::Dynamic,cache) = this->bytesLoadedCache->get(id);
...
HXLINE( 664)			HX_VAR( ::String,id);
HXDLIN( 664)			HX_VAR(  ::haxe::io::Bytes,data);
HXDLIN( 664)			HX_VAR( ::String,type);
HXLINE( 665)			{
HXLINE( 665)				int _g = 0;
HXDLIN( 665)				::cpp::VirtualArray _g1 = manifest->assets;
HXDLIN( 665)				while((_g < _g1->get_length())){
HXLINE( 665)					HX_VARI(  ::Dynamic,asset) = _g1->__get(_g);
HXDLIN( 665)					_g = (_g + 1);
...
HXLINE( 699)				HX_VARI( ::String,path) = _g1->__get(_g);
HXDLIN( 699)				_g = (_g + 1);
HXLINE( 701)				{
...
void AssetLibrary_obj::_hx___fromManifest( ::lime::utils::AssetManifest manifest){
            	...
            	HX_STACK_ARG(manifest,"manifest")
HXLINE( 708)
HXLINE( 709)		HX_VARI( bool,hasSize) = (manifest->version >= 2);
HXLINE( 710)		HX_VAR( int,size);
HXDLIN( 710)		HX_VAR( ::String,id);
HXDLIN( 710)		HX_VAR( ::Array< ::String >,pathGroup);
HXDLIN( 710)		HX_VAR( ::hx::Class,classRef);
HXLINE( 712)		HX_VARI( ::String,basePath) = manifest->rootPath;
...
HXLINE( 716)				HX_VARI(  ::Dynamic,asset) = _g1->__get(_g);
HXDLIN( 716)				_g = (_g + 1);
...
HXLINE( 763)				HX_VARI(  ::Dynamic,asset) = _g3->__get(_g2);
...
HXLINE( 778)		HX_VARI( int,colonIdx) = path.indexOf(HX_(":",3a,00,00,00),null());
...
HXLINE( 781)			HX_VARI( int,lastSlashIdx) = (colonIdx + 3);
HXLINE( 782)			HX_VARI( ::String,httpSection) = path.substr(0,lastSlashIdx);
...
HXLINE( 799)			HX_VARI( ::Array< ::String >,split) = path.split(HX_("/",2f,00,00,00));
HXLINE( 800)			HX_VARI( ::Array< ::String >,newPath) = ::Array_obj< ::String >::__new(0);
HXLINE( 802)			{
HXLINE( 802)				int _g = 0;
HXDLIN( 802)				int _g1 = split->length;
HXDLIN( 802)				while((_g < _g1)){
HXLINE( 802)					_g = (_g + 1);
HXDLIN( 802)					HX_VARI( int,i) = (_g - 1);
...
HXLINE( 840)			HX_VARI( ::Array< ::String >,pathGroup) = ( (::Array< ::String >)(this->pathGroups->get(id)) );
HXLINE( 842)			{
HXLINE( 842)				HX_VARI(  ::Dynamic,otherID) = this->pathGroups->keys();
HXDLIN( 842)				while(( (bool)(otherID->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 842)					HX_VARI( ::String,otherID1) = ( (::String)(otherID->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 846)							HX_VARI( ::String,path) = pathGroup->__get(_g);
HXDLIN( 846)							_g = (_g + 1);
...
HXLINE( 918)			HX_VARI(  ::Dynamic,size) = this->sizes->get(id);
HXLINE( 919)			HX_VAR( Float,percent);
...
HXLINE( 936)				HX_VARI(  ::Dynamic,cache) = this->bytesLoadedCache->get(id);
...
HXLINE( 133)			HX_VARI(  ::lime::utils::AssetLibrary,library) =  ::lime::utils::AssetLibrary_obj::__alloc( HX_CTX );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(AssetLibrary_obj,loadFromFile,return )
 ...
 ::lime::app::Future AssetLibrary_obj::loadFromManifest( ::lime::utils::AssetManifest manifest){
            	...
            	HX_STACK_ARG(manifest,"manifest")
HXLINE( 545)
HXLINE( 546)		HX_VARI(  ::lime::utils::AssetLibrary,library) = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);

...
HXLINE(  91)					HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  93)					if (::StringTools_obj::startsWith(key1,prefix)) {
HXLINE(  95)						this->audio->remove(key1);
            					}
            				}
            			}
HXLINE(  99)			HX_VARI(  ::Dynamic,keys1) = this->font->keys();
HXLINE( 101)			{
HXLINE( 101)				HX_VARI(  ::Dynamic,key1) = keys1;
HXDLIN( 101)				while(( (bool)(key1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 101)					HX_VARI( ::String,key) = ( (::String)(key1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 103)					if (::StringTools_obj::startsWith(key,prefix)) {
HXLINE( 105)						this->font->remove(key);
            					}
            				}
            			}
HXLINE( 109)			HX_VARI(  ::Dynamic,keys2) = this->image->keys();
HXLINE( 111)			{
HXLINE( 111)				HX_VARI(  ::Dynamic,key2) = keys2;
HXDLIN( 111)				while(( (bool)(key2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 111)					HX_VARI( ::String,key) = ( (::String)(key2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );

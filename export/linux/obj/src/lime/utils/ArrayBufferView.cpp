...
HXLINE( 301)					HX_VARI( int,pos) = ((offset + i) * this->bytesPerElement);
...
HXLINE( 314)					HX_VARI( int,pos) = ((offset + i) * this->bytesPerElement);
HXLINE( 320)					{
...
HXLINE( 327)					HX_VARI( int,pos) = ((offset + i) * this->bytesPerElement);
HXLINE( 333)					{
...
HXLINE( 366)					HX_VARI( int,pos) = ((offset + i) * this->bytesPerElement);
HXLINE( 372)					{
...
HXLINE( 340)					HX_VARI( int,pos) = ((offset + i) * this->bytesPerElement);
HXLINE( 346)					{
...
HXLINE( 353)					HX_VARI( int,pos) = ((offset + i) * this->bytesPerElement);
HXLINE( 359)					{
...
HXLINE( 379)					HX_VARI( int,pos) = ((offset + i) * this->bytesPerElement);
...
HXLINE( 386)					HX_VARI( int,pos) = ((offset + i) * this->bytesPerElement);

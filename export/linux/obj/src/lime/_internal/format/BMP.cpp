...
HXDLIN( 174)								HX_VARI( int,x) = (_g1 - 1);
...
HXDLIN( 186)								HX_VARI( int,i) = (_g3 - 1);
HXLINE( 188)								{
...
HXDLIN( 121)								HX_VARI( int,x) = (_g1 - 1);
...
HXDLIN( 143)									HX_VARI( int,x) = (_g1 - 1);

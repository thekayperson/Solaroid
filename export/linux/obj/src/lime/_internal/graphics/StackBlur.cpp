...
HXDLIN( 128)						HX_VARI( int,x) = (_g2 - 1);
HXLINE( 130)						{
HXLINE( 130)							yi = (yi + 1);
...
HXDLIN( 155)							HX_VARI( int,i) = (_g1 - 1);
HXLINE( 157)							sy->r = pr;
HXLINE( 158)							sy->g = pg;
HXLINE( 159)							sy->b = pb;
HXLINE( 160)							sy->a = pa;
...
HXDLIN( 164)							HX_VARI( int,i) = (_g3 - 1);

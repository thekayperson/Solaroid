...
HXDLIN( 189)							HX_VARI( int,x) = (_g1 - 1);
...
HXDLIN( 252)							HX_VARI( int,x) = (_g1 - 1);
HXLINE( 254)							{
...
HXDLIN( 353)									HX_VARI( int,x) = (_g1 - 1);
HXLINE( 355)									{
...
HXDLIN( 412)										HX_VARI( int,x) = (_g1 - 1);
HXLINE( 414)										{
...
HXLINE( 429)					HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,alphaView2) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,alphaImage, ::lime::math::Rectangle_obj::__alloc( HX_CTX ,(sourceView->x + alphaView),(sourceView->y + alphaView1),sourceView->width,sourceView->height));
...
HXDLIN( 443)									HX_VARI( int,x) = (_g1 - 1);
HXLINE( 445)									{
...
HXDLIN( 485)									HX_VARI( int,x) = (_g1 - 1);
HXLINE( 487)									{
...
HXLINE( 535)			HX_VARI( int,format) = image->buffer->format;
...
HXDLIN( 546)							HX_VARI( int,x) = (_g1 - 1);
HXLINE( 548)							{
...
HXLINE( 570)			HX_VARI( int,format) = image->buffer->format;
...
HXDLIN( 703)						HX_VARI( int,y) = (_g1 - 1);
...
HXDLIN( 723)				HX_VARI( int,x) = (_g2 - 1);
...
HXDLIN( 746)				HX_VARI( int,y) = (_g4 - 1);
...
HXDLIN( 770)				HX_VARI( int,y) = (_g6 - 1);
...
HXDLIN( 875)							HX_VARI( int,x) = (_g1 - 1);
HXLINE( 877)							{
...
HXDLIN( 933)							HX_VARI( int,x) = (_g1 - 1);
HXLINE( 935)							{
...
HXDLIN(1012)							HX_VARI( int,x) = (_g1 - 1);
...
HXDLIN(1079)						HX_VARI( int,x) = (_g1 - 1);
...
HXDLIN(1200)		HX_VARI( int,source) = this1;
HXLINE(1201)		{
...
HXDLIN(1257)							HX_VARI( int,x) = (_g1 - 1);
...
HXDLIN(1361)							HX_VARI( int,x) = (_g1 - 1);
HXLINE(1363)							{
...
HXLINE(1437)		HX_VARI( int,bx1) = ::Std_obj::_hx_int(bx);
HXLINE(1438)		HX_VARI( int,by1) = ::Std_obj::_hx_int(by);
HXLINE(1440)		{
...
HXDLIN(1466)						HX_VARI( int,j) = (_g1 - 1);
...
HXDLIN(1471)						HX_VARI( int,j) = (_g3 - 1);
...
HXDLIN(1479)						HX_VARI( int,j) = (_g5 - 1);
...
HXDLIN(1488)						HX_VARI( int,j) = (_g7 - 1);
...
HXDLIN(1514)						HX_VARI( int,j) = (_g1 - 1);
...
HXDLIN(1519)						HX_VARI( int,j) = (_g3 - 1);
...
HXDLIN(1527)						HX_VARI( int,j) = (_g5 - 1);
...
HXDLIN(1536)						HX_VARI( int,j) = (_g7 - 1);
...
HXDLIN(1652)			HX_VARI( int,a1) = ::Std_obj::_hx_int((a * strength));
HXLINE(1653)			{

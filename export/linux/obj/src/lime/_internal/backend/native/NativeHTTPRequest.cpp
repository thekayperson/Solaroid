...
HXLINE( 107)		HX_VARI(  ::haxe::io::Bytes,data) = ( ( ::haxe::io::Bytes)(this->parent->__Field(HX_("data",2a,56,63,42),::hx::paccDynamic)) );
HXLINE( 108)		HX_VARI( ::String,query) = HX_("",00,00,00,00);
HXLINE( 110)		if (::hx::IsNull( data )) {
HXLINE( 112)			{
HXLINE( 112)				HX_VARI(  ::Dynamic,key) = ( ( ::haxe::ds::StringMap)( ::Dynamic(this->parent->__Field(HX_("formData",8e,d5,80,56),::hx::paccDynamic))) )->keys();
HXDLIN( 112)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 112)					HX_VARI( ::String,key1) = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 188)		HX_VARI( ::Array< ::String >,headers) = ::Array_obj< ::String >::__new(0);
HXLINE( 189)		headers->push(HX_("Expect: ",df,c4,e1,19));
HXLINE( 191)		HX_VARI( ::String,contentType) = null();
HXLINE( 193)		{
HXLINE( 193)			int _g = 0;
...
HXLINE( 193)				HX_VARI(  ::Dynamic,header) = _g1->__get(_g);
HXDLIN( 193)				_g = (_g + 1);
...
HXLINE( 266)		HX_VARI(  ::lime::app::Promise_haxe_io_Bytes,promise) =  ::lime::app::Promise_haxe_io_Bytes_obj::__alloc( HX_CTX );
...
HXDLIN( 349)				promise1->complete(bytes->getString(0,bytes->length,null()));
            	...
            	HX_STACK_ARG(uri,"uri")
HXLINE( 334)
HXLINE( 335)		HX_VARI(  ::lime::app::Promise_String,promise) =  ::lime::app::Promise_String_obj::__alloc( HX_CTX );
HXLINE( 336)		HX_VARI(  ::lime::app::Future,future) = this->loadData(uri,false);
...
HXLINE( 360)			HX_VARI(  ::haxe::io::Bytes,cacheBytes) = this->bytes;
...
HXLINE( 368)
HXLINE( 369)		HX_VARI( ::Array< ::String >,parts) = header.split(HX_(": ",a6,32,00,00));
...
HXLINE( 402)
HXLINE( 403)		HX_VARI(  ::lime::_internal::backend::native::NativeHTTPRequest,instance) = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(state->__Field(HX_("instance",95,1f,e1,59),::hx::paccDynamic)) );
HXLINE( 404)		HX_VARI( ::String,path) = ( (::String)(state->__Field(HX_("uri",6c,2b,59,00),::hx::paccDynamic)) );
HXLINE( 406)		HX_VARI( int,index) = path.indexOf(HX_("?",3f,00,00,00),null());
...
void NativeHTTPRequest_obj::localThreadPool_onComplete( ::Dynamic state){
            	...
            	HX_STACK_ARG(state,"state")
HXLINE( 447)
HXLINE( 448)		HX_VARI(  ::lime::app::Promise_haxe_io_Bytes,promise) = ( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),::hx::paccDynamic)) );
...
HXLINE( 452)		HX_VARI(  ::lime::_internal::backend::native::NativeHTTPRequest,instance) = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(state->__Field(HX_("instance",95,1f,e1,59),::hx::paccDynamic)) );
...
void NativeHTTPRequest_obj::localThreadPool_onError( ::Dynamic state){
            	...
            	HX_STACK_ARG(state,"state")
HXLINE( 465)
HXLINE( 466)		HX_VARI(  ::lime::app::Promise_haxe_io_Bytes,promise) = ( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),::hx::paccDynamic)) );
HXLINE( 467)		promise->error( ::Dynamic(state->__Field(HX_("error",c8,cb,29,73),::hx::paccDynamic)));
HXLINE( 469)		HX_VARI(  ::lime::_internal::backend::native::NativeHTTPRequest,instance) = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(state->__Field(HX_("instance",95,1f,e1,59),::hx::paccDynamic)) );
...
void NativeHTTPRequest_obj::localThreadPool_onProgress( ::Dynamic state){
            	...
            	HX_STACK_ARG(state,"state")
HXLINE( 488)
HXLINE( 489)		HX_VARI(  ::lime::app::Promise_haxe_io_Bytes,promise) = ( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),::hx::paccDynamic)) );
...
HXLINE( 499)			HX_VARI(  ::lime::net::curl::CURL,curl) = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiAddHandle->pop(false).StaticCast<  ::lime::net::curl::CURL >();
HXLINE( 500)			if (::hx::IsNotNull( curl )) {
HXLINE( 500)				::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->addHandle(curl);
            			}
HXLINE( 503)			HX_VARI( int,code) = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->wait(1000);
HXLINE( 505)			if ((code == 0)) {
HXLINE( 507)				::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->perform();
HXLINE( 508)				HX_VARI(  ::lime::net::curl::CURLMultiMessage,message) = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->infoRead();
...
HXLINE( 518)					HX_VARI(  ::lime::net::curl::CURL,curl) = message->curl;
HXLINE( 519)					HX_VARI(  ::Dynamic,status) = curl->getInfo(2097154);
...
void NativeHTTPRequest_obj::multiThreadPool_onComplete( ::Dynamic _){
            	...
            	HX_STACK_ARG(_,"_")
HXLINE( 532)
HXLINE( 534)		HX_VARI(  ::lime::net::curl::CURL,curl) = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiAddHandle->pop(false).StaticCast<  ::lime::net::curl::CURL >();
...
HXLINE( 558)			HX_VARI(  ::lime::_internal::backend::native::NativeHTTPRequest,instance) = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->get( ::Dynamic(state->__Field(HX_("curl",ec,4a,c9,41),::hx::paccDynamic)))) );
...
HXDLIN( 602)			HX_VARI(  ::lime::_internal::backend::native::NativeHTTPRequest,instance) = _g1->__get(_g).StaticCast<  ::lime::_internal::backend::native::NativeHTTPRequest >();
HXDLIN( 602)			_g = (_g + 1);

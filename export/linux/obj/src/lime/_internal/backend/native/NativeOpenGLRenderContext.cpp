...
HXDLIN(1457)		HX_VARI(  ::hx::Object *,result1) = result(this->_hx___getObjectID(program),uniformBlockIndex);
...
HXDLIN(1497)		HX_VARI(  ::hx::Object *,result1) = result(this->_hx___getObjectID(program));
...
HXDLIN(1809)				HX_VARI(  ::lime::utils::ArrayBufferView,params) = this1;
...
HXDLIN(1840)				HX_VARI(  ::lime::utils::ArrayBufferView,params) = this1;
...
HXDLIN(1814)				HX_VARI(  ::lime::utils::ArrayBufferView,params) = this1;
...
HXLINE(1816)				return params;
            			...
            			break;
            			case (int)3107: {
HXLINE(1797)				HX_VARI(  ::haxe::io::Bytes,params) = ::haxe::io::Bytes_obj::alloc(4);
...
HXDLIN(1835)				HX_VARI(  ::lime::utils::ArrayBufferView,params) = this1;
...
HXLINE(1864)				HX_VARI(  ::lime::graphics::opengl::GLObject,data) = ::lime::graphics::opengl::_GLTexture::GLTexture_Impl__obj::fromInt(this->getInteger(pname));
...
HXDLIN(1830)				HX_VARI(  ::lime::utils::ArrayBufferView,params) = this1;
...
HXLINE(1848)				HX_VARI(  ::lime::graphics::opengl::GLObject,data) = ::lime::graphics::opengl::_GLBuffer::GLBuffer_Impl__obj::fromInt(this->getInteger(pname));
HXLINE(1849)				return data;
            			}
            			break;
            			case (int)35725: {
HXLINE(1852)				HX_VARI(  ::lime::graphics::opengl::GLObject,data) = ::lime::graphics::opengl::_GLProgram::GLProgram_Impl__obj::fromInt(this->getInteger(pname));
HXLINE(1853)				return data;
            			}
            			break;
            			case (int)36006: {
HXLINE(1856)				HX_VARI(  ::lime::graphics::opengl::GLObject,data) = ::lime::graphics::opengl::_GLFramebuffer::GLFramebuffer_Impl__obj::fromInt(this->getInteger(pname));
HXLINE(1857)				return data;
            			}
            			break;
            			case (int)36007: {
HXLINE(1860)				HX_VARI(  ::lime::graphics::opengl::GLObject,data) = ::lime::graphics::opengl::_GLRenderbuffer::GLRenderbuffer_Impl__obj::fromInt(this->getInteger(pname));
...
HXDLIN(1903)		HX_VARI(  ::hx::Object *,result1) = result(this->_hx___getObjectID(program));
...
HXDLIN(2041)		HX_VARI(  ::hx::Object *,result1) = result(this->_hx___getObjectID(shader));
...
HXDLIN(2068)		HX_VARI(  ::hx::Object *,result1) = result(this->_hx___getObjectID(shader));
...
HXDLIN(2218)		HX_VARI(  ::Dynamic,result1) = ( ( ::Dynamic)(result(this->_hx___getObjectID(program),index)) );
...
HXDLIN(2312)							HX_VARI(  ::lime::utils::ArrayBufferView,params) = this1;
...
HXDLIN(2318)								HX_VARI(  ::lime::utils::ArrayBufferView,params) = this1;

...
HXDLIN(  95)			HX_VARI( int,offset1) = (offset - this->pauseTimer);
HXLINE(  96)			{
HXLINE(  96)				int _g = 0;
...
HXLINE( 200)					gamepad->onAxisMove->dispatch(this->gamepadEventInfo->axis,this->gamepadEventInfo->axisValue);
            			...
            			break;
            			case (int)1: {
HXLINE( 203)				HX_VARI(  ::lime::ui::Gamepad,gamepad) = ( ( ::lime::ui::Gamepad)(::lime::ui::Gamepad_obj::devices->get(this->gamepadEventInfo->id)) );
...
HXLINE( 204)					gamepad->onButtonDown->dispatch(this->gamepadEventInfo->button);
            			...
            			break;
            			case (int)2: {
HXLINE( 207)				HX_VARI(  ::lime::ui::Gamepad,gamepad) = ( ( ::lime::ui::Gamepad)(::lime::ui::Gamepad_obj::devices->get(this->gamepadEventInfo->id)) );
...
HXLINE( 224)					joystick->onAxisMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->x);
            			...
            			break;
            			case (int)1: {
HXLINE( 227)				HX_VARI(  ::lime::ui::Joystick,joystick) = ( ( ::lime::ui::Joystick)(::lime::ui::Joystick_obj::devices->get(this->joystickEventInfo->id)) );
...
HXLINE( 228)					joystick->onHatMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->eventValue);
            			...
            			break;
            			case (int)2: {
HXLINE( 231)				HX_VARI(  ::lime::ui::Joystick,joystick) = ( ( ::lime::ui::Joystick)(::lime::ui::Joystick_obj::devices->get(this->joystickEventInfo->id)) );
...
HXLINE( 232)					joystick->onTrackballMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->x,this->joystickEventInfo->y);
            			...
            			break;
            			case (int)3: {
HXLINE( 235)				HX_VARI(  ::lime::ui::Joystick,joystick) = ( ( ::lime::ui::Joystick)(::lime::ui::Joystick_obj::devices->get(this->joystickEventInfo->id)) );
...
HXLINE( 236)					joystick->onButtonDown->dispatch(this->joystickEventInfo->index);
            			...
            			break;
            			case (int)4: {
HXLINE( 239)				HX_VARI(  ::lime::ui::Joystick,joystick) = ( ( ::lime::ui::Joystick)(::lime::ui::Joystick_obj::devices->get(this->joystickEventInfo->id)) );
...
HXLINE( 257)			HX_VARI( int,keyCode) = this->keyEventInfo->keyCode;
HXLINE( 258)			HX_VARI( int,modifier) = this->keyEventInfo->modifier;
...
void NativeApplication_obj::handleMouseEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 329)
HXLINE( 330)		HX_VARI(  ::lime::ui::Window,window) = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->mouseEventInfo->windowID)) );
...
HXDLIN( 358)			HX_VARI(  ::lime::ui::Window,window) = _g1->__get(_g).StaticCast<  ::lime::ui::Window >();
HXDLIN( 358)			_g = (_g + 1);
...
HXLINE( 385)							HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = window->context->gl;
...
void NativeApplication_obj::handleSensorEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 410)
HXLINE( 411)		HX_VARI(  ::lime::_hx_system::Sensor,sensor) = ( ( ::lime::_hx_system::Sensor)(::lime::_hx_system::Sensor_obj::sensorByID->get(this->sensorEventInfo->id)) );
...
void NativeApplication_obj::handleTextEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 420)
HXLINE( 421)		HX_VARI(  ::lime::ui::Window,window) = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->textEventInfo->windowID)) );
...
HXDLIN( 441)		switch((int)(this->touchEventInfo->type)){
            			case (int)0: {
HXLINE( 444)				HX_VARI(  ::lime::ui::Touch,touch) = this->unusedTouchesPool->pop().StaticCast<  ::lime::ui::Touch >();
...
HXLINE( 464)				::lime::ui::Touch_obj::onStart->dispatch(touch);
            			...
            			break;
            			case (int)1: {
HXLINE( 467)				HX_VARI(  ::lime::ui::Touch,touch) = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
...
HXLINE( 480)					this->unusedTouchesPool->add(touch);
            			...
            			break;
            			case (int)2: {
HXLINE( 484)				HX_VARI(  ::lime::ui::Touch,touch) = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
...
void NativeApplication_obj::handleWindowEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 502)
HXLINE( 503)		HX_VARI(  ::lime::ui::Window,window) = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->windowEventInfo->windowID)) );
...
HXLINE( 572)			HX_VARI( int,currentTime) = ::lime::_hx_system::System_obj::getTimer();
HXLINE( 573)			HX_VARI( bool,foundNull) = false;
HXLINE( 574)			HX_VAR(  ::haxe::Timer,timer);
HXLINE( 576)			{
HXLINE( 576)				int _g = 0;
HXDLIN( 576)				int _g1 = ::haxe::Timer_obj::sRunningTimers->length;
HXDLIN( 576)				while((_g < _g1)){
HXLINE( 576)					_g = (_g + 1);
HXDLIN( 576)					HX_VARI( int,i) = (_g - 1);

...
HXDLIN( 300)			HX_VARI(  ::lime::graphics::Image,image1) =  ::lime::graphics::Image_obj::__alloc( HX_CTX ,image,this->offsetX,this->offsetY,this->width,this->height,null(),this->type);
...
HXDLIN( 793)					HX_VARI( int,rgba1) = rgba;
...
HXDLIN( 790)						HX_VARI( int,bgra1) = bgra;
...
HXDLIN( 835)					HX_VARI( int,rgba1) = rgba;
...
HXDLIN( 832)						HX_VARI( int,bgra1) = bgra;

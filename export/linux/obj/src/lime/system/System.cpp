...
HXLINE( 213)			HX_VARI(  ::Dynamic,mode) = displayInfo->__Field(HX_("currentMode",3c,ac,f2,80),::hx::paccDynamic);
HXLINE( 214)			HX_VARI(  ::lime::_hx_system::DisplayMode,currentMode) =  ::lime::_hx_system::DisplayMode_obj::__alloc( HX_CTX ,( (int)(mode->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic)) ),( (int)(mode->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic)) ),( (int)(mode->__Field(HX_("refreshRate",5b,e2,3f,40),::hx::paccDynamic)) ),( (int)(mode->__Field(HX_("pixelFormat",5d,72,1b,6f),::hx::paccDynamic)) ));
HXLINE( 216)			{
HXLINE( 216)				int _g1 = 0;
HXDLIN( 216)				::Array< ::Dynamic> _g2 = display->supportedModes;
HXDLIN( 216)				while((_g1 < _g2->length)){
HXLINE( 216)					HX_VARI(  ::lime::_hx_system::DisplayMode,mode) = _g2->__get(_g1).StaticCast<  ::lime::_hx_system::DisplayMode >();
...
HXLINE( 460)					HX_VARI( ::String,parameter1) = ( (::String)(parameter->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXDLIN( 683)			HX_VARI(  ::haxe::io::Bytes,arrayBuffer) = this1;
...
HXDLIN( 684)			HX_VARI(  ::lime::utils::ArrayBufferView,uint8Array) = this2;
...
HXDLIN( 685)			HX_VARI(  ::lime::utils::ArrayBufferView,uint16array) = this3;

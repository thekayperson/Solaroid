...
HXLINE( 519)				HX_VARI(  ::lime::ui::Gamepad,gamepad1) = ( ( ::lime::ui::Gamepad)(gamepad->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 526)				HX_VARI(  ::lime::ui::Joystick,joystick1) = ( ( ::lime::ui::Joystick)(joystick->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );

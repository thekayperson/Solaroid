...
HXLINE( 249)
HXLINE( 263)		HX_VARI( int,elen) = end.length;
HXLINE( 264)		HX_VARI( int,slen) = s.length;
...
HXLINE( 278)
HXLINE( 283)		HX_VARI(  ::Dynamic,c) = s.charCodeAt(pos);
...
::String StringTools_obj::ltrim(::String s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE( 296)
HXLINE( 300)		HX_VARI( int,l) = s.length;
HXLINE( 301)		HX_VARI( int,r) = 0;
...
::String StringTools_obj::rtrim(::String s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE( 321)
HXLINE( 325)		HX_VARI( int,l) = s.length;
HXLINE( 326)		HX_VARI( int,r) = 0;
...
HXLINE( 369)		HX_VARI(  ::StringBuf,buf) =  ::StringBuf_obj::__alloc( HX_CTX );
...
HXLINE( 434)
HXLINE( 440)		HX_VARI( ::String,s) = HX_("",00,00,00,00);
HXLINE( 441)		HX_VARI( ::String,hexChars) = HX_("0123456789ABCDEF",68,2a,58,a2);
